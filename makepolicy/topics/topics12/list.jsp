    ...
    <body>
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                         ...
                         <%
                            RssList list = new RssList(pageContext, "policy_topics");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("category=12").get_page_desc("shijian");
                        ...
                        <tr ondblclick="ck_dbAbFlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            if ( list.get("classify").equals("1") ) {
                                out.print("习近平法治思想引领法治中国建设");
                            }
                            else if ( list.get("classify").equals("2") ) {
                                out.print("科学谋划“十四五”发展");
                            }
                            else if ( list.get("classify").equals("3") ) {
                                out.print("助力构建“双循环”新发展格局");
                            }
        ...
        <script>
            ...
            $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                     popuplayer.display("/makepolicy/topics/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 1248, height: 740});
                })
            });
            ...
            $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                     popuplayer.display("/makepolicy/topics/topics12/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width:1248, height: 740});
                })
            });
            $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/makepolicy/topics/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
                })
            });
