    ...
    <body>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                         ...
                         <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("category=5 and classify=1").get_page_desc("shijian");
                        ...
                        <tr ondblclick="ck_dbAbFlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td><%
                                ...
                                String topics = req.get("topics");
                                if ( topics.equals("13") ) {
                                    
                                }
                                else if ( topics.equals("12") ) { //2022
                                    if ( list.get("classify").equals("1") ) {
                                        out.print(list.get("习近平法治思想引领法治中国建设"));
                                    }
                                    else if ( list.get("classify").equals("1") ) {
                                        out.print(list.get("科学谋划“十四五”发展"));
                                    }
                                    else if ( list.get("classify").equals("2") ) {
                                        out.print(list.get("助力构建“双循环”新发展格局"));
                                    }
        ...
        <script>
            ...
            $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                     popuplayer.display("/makepolicy/sociaty/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 1248, height: 740});
                })
            });
            ...
            $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                     popuplayer.display("/makepolicy/sociaty/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width:1248, height: 740});
                })
            });
            $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/makepolicy/sociaty/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
                })
            });
