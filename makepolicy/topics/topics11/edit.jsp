...
<%
    ...
    RssList entity2 = new RssList(pageContext, "policy_topics");
    entity2.request();
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        <td class="dce w100 ">标题<%out.print(req.get("topics"));%></td>
                    ...
                    <tr>      
                       ...
                       <td colspan="2"><select  class="w630" name="classify" dict-select="importanttopics_11" def="<% entity2.write("classify"); %>"></select></td>                                    
...
<!--                       
                    <tr>       
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">类别</td>    
                        <td colspan="5"><select  name="classify" dict-select="activityreference" def="<% entity2.write("classify"); %>"></select></td>                       
                    </tr>       -->
