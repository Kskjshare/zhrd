    ...
    <body>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                         ...
                         <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("category=3 and classify=1").get_page_desc("shijian");
        ...
        <script>
            ...
            $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                     popuplayer.display("/makepolicy/international/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 1248, height: 740});
                })
            });
            ...
            $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                     popuplayer.display("/makepolicy/international/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width:1248, height: 740});
                })
            });
            $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/makepolicy/international/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
                })
            });
