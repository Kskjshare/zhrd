...
<!--                    <tr>
                    ...
                    <tr>
                        <td class="dce w100 ">专家姓名</td>
                        <td colspan="3"><input type="text" maxlength="80" class="w630" name="zjname" value="<% entity.write("zjname"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">附件</td>
                        <td><span id="fjfile">
                                <% out.print(entity.get("enclosure").isEmpty() ? "点击选择文件" : entity.get("enclosure")); %></span>
                                <input type="hidden" name="enclosure" value="<% entity.write("enclosure"); %>" >
                                <input type="hidden" name="enclosure" value="<% entity.write("enclosurename"); %>" >
