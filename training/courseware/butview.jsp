    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w120 dce">下载附件</td><td colspan="3"><a href="/upfile/<% entity.write("enclosure");%>" download="附件"><% entity.write("enclosurename");%></a></td></tr>
        ...
        <script>
            ...
            $("span[video]").click(function () {
                ...
                popuplayer.display("/training/courseware/video.jsp?id=" + video, '视频播放', {width: 1000, height: 600});
            })
        </script>
    </body>
</html>
