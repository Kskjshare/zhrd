...
<%
    ...
    map.put("key", "8");
    RssListView entity = new RssListView(pageContext, "courseware");
    RssListView entity3 = new RssListView(pageContext, "courseware");
    RssList entity2 = new RssList(pageContext, "courseware");
    RssList read = new RssList(pageContext, "coursewareobj");
    entity.request();
    entity2.request();
//    entity.request();
...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        <td><select class="b95" name="type" dict-select="kejian" def="<% entity.write("type"); %>"></select></td>
                    </tr>
