    ...
    <body>
        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssListView list = new RssListView(pageContext, "statute");
        ...
        <script>
         ...
         $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/training/statute/xianfa/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 960, height: 600 });
                })
            });
         ...
         $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/training/statute/xianfa/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 400, height: 120});
                })
            });
         $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/training/statute/xianfa/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 960, height: 600 });
                })
            });
