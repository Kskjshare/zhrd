    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w120 dce">名称</td><td colspan="3"><% out.print(entity.get("title"));%></td></tr>
                    <tr><td class="w120 dce">附件</td><td colspan="3"><a href="/upfile/<% entity.write("enclosure");%>" download="附件"><% entity.write("enclosurename");%></a></td></tr>
                    <tr><td class="w120 dce">视频</td><td colspan="3"><span <% out.print(entity.get("videosrc").isEmpty() ? "" : "video='" + entity.get("id") + "'"); %>><% out.print(entity.get("videosrc").isEmpty() ? "暂无视频" : "点击播放"); %></span></td></tr>
        ...
        <script>
            ...
            $("span[video]").click(function () {
                ...
                popuplayer.display("/training/xianfa/video.jsp?id=" + video, '视频播放', {width: 1000, height: 600});
            })
        </script>
    </body>
</html>
