    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="dce">分类：</td><td><select name="classify" dict-select="dynamicclass"><option></option></select></td></tr>
                    <tr><td class="dce">是否发布：</td><td><select name="state" dict-select="noticestate"></select></td></tr>
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str ="/delegatexweb/workdynamics/list.jsp?title="+formfun("title")+"&classify="+formfun("classify")+"&state="+formfun("state")+"&realname="+formfun("realname")
