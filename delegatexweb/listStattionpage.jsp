...
<html>
    ...
    <body>
        ...
        <div>
            <div id="header"></div>
            <div id="webbody">
                <h1><span><% String show = "", view = "contactstation", where = "";
                    
                    if (req.get("gd").equals("3")) {
                        show = "规范化联络站";
                        view = "contactstation";
                        where = "demonstration=3";
                    }
                    ...
                    entity.select().where( "demonstration=4" ).get_page_desc("id");
                    out.print( req.get("gd") );%></span></h1>
                <ul id="newlist">
                    <li>
                        <%
