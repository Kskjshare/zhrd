...
<html>
    <head>
        ...
        <style>
            ...
            #webbody table{border: #ccc solid thin;width: 945px;margin: 39px auto;height: 429px;overflow: auto;}
                    ...
                    <div id="gao">
                        <table cellspacing="0" class="cellbor">
                            <thead>
                                ...
                                <tr><th class="w86">提出者姓名</th><th class="w110">标题</th><th class="w86">创建时间</th><th class="w50">状态</th><th class="w86">代表</th></tr>
                            </thead>
                            <tbody>
                                <%
                                    list.pagesize = 30;
                                ...
                                %>
                                <tr ondblclick="ck_liudbcilclick();" idd="<% out.print(list.get("id")); %>" >
