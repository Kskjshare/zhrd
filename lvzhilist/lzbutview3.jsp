...
//                                    + "%' and realname like '%" + URLDecoder.decode(list.get("realname"), "utf-8") + "%'" + " and classify=3" + " and userid="+req.get("id") + " and classify=3").get_page_desc("id");
                            list.select().where("classify=3" + " and auditState=2 and userid="+ req.get("id")).get_page_desc("id");
