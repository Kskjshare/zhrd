            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        ...
                        rank.request();
                        rank.pagesize=30;
                        rank.select().where("realname like '%" + URLDecoder.decode( req.get("realname"), "utf-8") + "%' and state=1").get_page_desc("myid");
                        ...
                        <td><% out.print(rank.get("delegationname").isEmpty() ? "无" : rank.get("delegationname")); %></td>
                            ...
                            %>
                            <td style="color:red;font-weight: bold;font-size: 18px;"><% out.print( rank.get("othermeeting") ); %></td>
                            <%  
                            }
                            %> 
                             <% 
