...
<!--         <div class="bodywrap">
              ...
              <div class="bodywrap" style="margin-top:30px;">
                <table class="wp100 tc cellbor" id="section" style="margin-top:-30px;">
                    <thead>
                    ...
                    <tbody>
                        ...
                        rank.request();
                        rank.pagesize=30;
                        rank.select().where("state=1").get_page_desc("reslovedispute");
                        ...
                        <td><% out.print(rank.get("delegationname").isEmpty() ? "无" : rank.get("delegationname")); %></td>
                            ...
                            %>
                            <td style="color:red;font-weight: bold;font-size: 18px;"><% out.print( rank.get("reslovedispute") ); %></td>
                             <%  
                            }
                            %> 
                            <% 
