            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><span  id="icofile"><% out.print(entity.get("enclosure").isEmpty() ? "点击选择图片" : entity.get("ico")); %></span><input type="hidden" name="ico" value="<% entity.write("ico"); %>" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" class="w630" name="links" value="<% entity.write("links"); %>" /></td>
                    </tr>
                    <tr>
