              ...
              <div class="bodywrap" style="margin-top:30px;">
                <table class="wp100 tc cellbor" id="section" style="margin-top:0px;">
                    ...
                    <tbody>
                        ...
                        rank.request();
                        rank.pagesize=500;
                        rank.select().where("state=1").get_page_desc("investigation");
                        ...
                        <td><% out.print(rank.get("delegationname").isEmpty() ? "无" : rank.get("delegationname")); %></td>
                            ...
                            %> 
                            <% 
                            if ( rank.get("investigation").equals("0")  ){   
                            %>    
                            <td><% out.print( rank.get("investigation") ); %></td>
                            <% 
                            }else {        
                            %>
                            <td style="color:red ;font-weight: bold; font-size: 18px;"><% out.print( rank.get("investigation") ); %></td>
                             <%  
                            }
                            %> 
                            <% 
