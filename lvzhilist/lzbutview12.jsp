...
//                                    + "%' and realname like '%" + URLDecoder.decode(list.get("realname"), "utf-8") + "%'" + " and classify=12" + " and userid="+req.get("id")).get_page_desc("id");

                            list.select().where("classify=12" + " and auditState=2 and userid="+ req.get("id")).get_page_desc("id");
