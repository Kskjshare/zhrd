...
//                                    + "%' and realname like '%" + URLDecoder.decode(list.get("realname"), "utf-8") + "%'" + " and classify=8" + " and userid="+req.get("id")).get_page_desc("id");

                            list.select().where("classify=8" + " and auditState=2 and userid="+ req.get("id")).get_page_desc("id");
