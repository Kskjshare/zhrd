...
<!--        <div class="bodywrap">
              ...
              <div class="bodywrap" style="margin-top:30px;">
                <table class="wp100 tc cellbor" id="section" style="margin-top:0px;">
                    ...
                    <tbody>
                        ...
                        rank.request();
                        rank.pagesize=30;
                        rank.select().where("state=1").get_page_desc("totalMixActivities");
                        ...
                        <td><% out.print(rank.get("delegationname").isEmpty() ? "无" : rank.get("delegationname")); %></td>
                            ...
                            %>
                            <td style="color:red;font-weight: bold;font-size: 18px;"><% out.print(rank.get("totalMixActivities")); %></td>
                             <%  
                            }
                            %> 
                            <% 
        ...
        //    var $tt = $("#select").val();
          ...
          if ($("#select").val() == 7) { //参加视察、调研及执法检查 
           ...
           else if ($("#select").val() == 8 ){ //参加视察、调研及执法检查
               v_type = 'ranklist8';
           }
