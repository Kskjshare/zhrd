...
/*             .cellbor thead,.w30{background:#f0f0f0 }
    ...
    <body>
        <form method="post" id="mainwrap">
            <div class="toolbar">
                <button type="button" transadapter="return" class="butview">恢复</button>
                <button type="button" transadapter="delete" class="butdelect">彻底删除</button>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            list.request();
                            int a = 1;
                            list.select().where("state like '%3%' and sendid="+UserList.MyID(request)).get_page_desc("id");
