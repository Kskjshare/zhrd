        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssListView list = new RssListView(pageContext, "fri_user_del");
                            list.request();
                            int a = 1;
                            list.select().where("realname like '%"+URLDecoder.decode(list.get("realname"), "utf-8")+"%' and myid="+UserList.MyID(request)).get_page_desc("id");
                        ...
                        <tr>
                            ...
                            <td txlclassify="<% out.print(list.get("classify")); %>"></td>
                        </tr>
                        <%
                            a++;
                            }
