    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td><select class="w206" id="sjzz" name="organization">
                                <option value="0" seltype="0"></option>
                                <%
                        ...
                        <td><input type="text" maxlength="80" class="w200" id="realname" value="<% entity.write("realname"); %>" /></td>
                    </tr>
                    <tr>
            ...
            <div class="footer">
                ...
                <button type="submit" id="addsub"><% out.print(entity.get("id").isEmpty() ? "增加" : "修改");%></button>
            </div>
        </form>
        ...
        <script>
            ...
            $("#realname").click(function () {
                ...
                var href = "parentid=" + p + "&seltype=" + m
                RssWin.onwinreceivemsg = function (dict) {
                    console.log(dict);
                    $("#realname").val(dict.myname)
                    $('[name="sendid"]').val(dict.myid);
                }
                RssWin.open("/selectwin/selectsjruser.jsp?" + href, 600, 500);
            })
