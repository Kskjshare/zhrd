...
{
    popuplayer.display("/committee/edit.jsp?TB_iframe=true", '新增专委会', {width: 830, height: 380});
}
﻿transadapter["edit"] = function (t)
{
    ...
    popuplayer.display("/committee/edit.jsp?relationid=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 830, height: 380});
}
transadapter["delete"] = function (t)
{
    ...
    popuplayer.display("/committee/delete.jsp?relationid=" + rid + "&account=" + account2 + "&TB_iframe=true", '删除', {width: 300, height: 80});
}
transadapter["quicksearch"] = function (t)
{
    popuplayer.display("/committee/quicksearch.jsp", '快速查询', {width: 450, height: 350});
}
