    ...
    <body>
        ...
        <script>
            ...
            $(".footer>[query]").click(function () {
                var str = "/handle/confirm/list.jsp?type=<% out.print(req.get("type"));%>&handlestate=<% out.print(req.get("handlestate"));%>&realid="+formfun("realid")+"&lwstate="+formfun("lwstate")+"&title="+formfun("title")+"&registertype="+formfun("registertype")+"&handle="+formfun("handle")+ "&allname=" + formfun("allname") + "&realcompanyname=" + formfun("realcompanyname") + "&telphone=" + formfun("telphone") + "&sessionid=" + formfun("sessionid") + "&realname=" + formfun("realname") + "&year=" + formfun("year")+ "&meetingnum=" + formfun("meetingnum");
