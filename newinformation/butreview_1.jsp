<%-- 
    Document   : butreview_1
    Created on : 2021-3-27, 10:07:13
...
<%
    ...
    entity.request();
     if(!entity.get("action").isEmpty()){
          if(entity.get("zhuangtai").equals("1")){
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        <td colspan="2" align="center" >
                          <input id="tongyi" name="zhuangtai" checked="checked" type="radio" value="1">
                        满意
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="zhuangtai" type="radio" value="2">
                        基本满意
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input name="zhuangtai" type="radio" value="3">
                        不满意
                        </td>
                    </tr>
                    </table>
