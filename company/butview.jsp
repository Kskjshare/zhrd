        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w120 dce">单位编号</td><td class="w261"><% entity.write("danweiCode"); %></td><td class="w120 dce">单位类别</td><td class="w261" companytypeclassify="<% entity.write("comtype"); %>"></td></tr>            
                    <tr><td class="w120 dce">单位名称</td><td colspan="3"><% entity.write("company"); %></td></tr>
                    <tr><td class="w120 dce">单位地址</td><td colspan="3"><% entity.write("workaddress"); %></td></tr>
                    <tr><td class="w120 dce">负责人</td><td class="w261"><% entity.write("person"); %></td><td class="w120 dce">单位管理员</td><td class="w261"><% entity.write("dwadmin"); %></td></tr>
                    <tr><td class="w120 dce">联系人</td><td class="w261"><% entity.write("linkman"); %></td><td class="w120 dce">单位电话</td><td class="w261"><% entity.write("worktel"); %></td></tr>
                    <tr><td class="w120 dce">登录名</td><td class="w261" colspan="3"><% entity.write("loginNameDw"); %></td></tr>
                    <tr><td class="w120 dce">电子邮箱</td><td colspan="3"><% entity.write("email"); %></td></tr>
                </table>
                <div id="middletitle" powerid="191">单位联系人</div>
                    ...
                    <tr><th>编号</th><th>姓名</th><th>性别</th><th>职务</th><th>电话</th><th>出生年月</th></tr>
                            <%
                                if (!entity.get("relationid").isEmpty()) {
                                    RssListView entity2 = new RssListView(pageContext, "userrole");
                                    entity2.select().where("parentid=" + entity.get("relationid")).get_page_desc("lianxirenCode");
                                    while (entity2.for_in_rows()) {
                            %>
                    <tr><td><% out.print(entity2.get("lianxirenCode"));%></td><td><% out.print(entity2.get("realname"));%></td><td sex="<% out.print(entity2.get("sex"));%>"></td><td><% out.print(entity2.get("job"));%></td><td><% out.print(entity2.get("telphone"));%></td><td rssdate="<% out.print(entity2.get("birthday")); %>,yyyy-MM"></td></tr>
