    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td class="dce">编号：</td><td><input class="w200" name="lianxirenCode"></td></tr>
                    ...
                    <tr><td class="dce">手机号码：</td><td><input class="w200" name="telphone"></tr>
                </table>
            </div>
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/company/companyuser/list.jsp?lianxirenCode="+formfun("lianxirenCode")+"&account="+formfun("account")+"&realname="+formfun("realname")+"&sex="+formfun("sex")+"&telphone="+formfun("telphone")
