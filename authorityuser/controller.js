...
//    }
    popuplayer.display("/authorityuser/edit.jsp?TB_iframe=true", '新增机关用户', {width: 830, height: 550});
}
transadapter["edit"] = function (t)
{
    ...
    popuplayer.display("/authorityuser/edit.jsp?relationid=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 830, height: 500});
}
transadapter["delete"] = function (t)
{
    ...
    popuplayer.display("/delegate/delete.jsp?relationid=" + rid + "&account=" +account2 + "&rolelist=" +rolelist2 + "&TB_iframe=true", '删除', {width: 300, height: 80});
}
function ck_ondblclick() {

    $('tbody tr').dblclick(function () {
        popuplayer.display("/delegate/butview.jsp?relationid=" + $(this).attr('idd') + "&TB_ifram.e=true", '查看', {width: 830, height: 560});
    })

}
transadapter["quicksearch"] = function (t)
{
    popuplayer.display("/delegate/quicksearch.jsp", '查询', {width: 400, height: 250});
}
...
{
    popuplayer.display("/delegate/apd.jsp", '导入', {width: 860, height: 300});
}
