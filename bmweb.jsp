...
/*               #webbody>a:nth-child(3){height:20px;width:48px;position:absolute;top:198px;left:128px;}
           ...
           #newlist2{padding: 0;}
            #newlist2 li{list-style-type: none; width: 535px; display: inline-block; line-height: 30px; border: #cacaca solid 2px; padding: 4px; padding-bottom: 9px;margin-bottom: 10px;vertical-align: top;}
            #newlist2 li h1{ margin: 0;font-size: 20px;color: #0071d2; text-indent: 10px;background: #f5f5f5;margin-bottom: 9px;font-weight: 500;font-weight:bold; }
            #newlist li>div{ height: 120px;margin: 0 10px 5px 0;}
            #newlist2 li>div>div{float: left; width: 160px;height: 110px;overflow: hidden;margin-right: 10px; }
            #newlist2 li>div>div>img{width: 160px;cursor: pointer;}

            #newlist {display: flex;}
            #newlist li {flex: 0 1 535px;}
            ...
            #newlist2 {display: flex;}
            #newlist2 li {flex: 0 1 535px;}
            #newlist2 li>div>p{text-indent: 2em;line-height: 18px;font-size: 16px;height: 110px;overflow: hidden; font-weight: 500; cursor: pointer; color:gray;}
            /*#newlist li>div>p:hover{color: blue}*/
             /*#newlist li>p img{width: 10px;cursor: pointer;}*/
             
            #newlist2 li>p{background: url(img/greystar.png) no-repeat 4px 11px; font-size: 16px;margin:0 10px;text-indent: 20px;border-bottom: #cacaca dashed 1px;cursor: pointer;overflow: hidden;text-overflow:ellipsis;white-space: nowrap;}
            #newlist2 li>p:hover{color: blue}
            
            #newlist2 .top2>p{img:url(img/blueright.png); background: url(img/greystar.png) no-repeat 4px 10px;}
            .popuplayer,.calendarwrap{display: none;}
            #newlist2 li:last-of-type{list-style-type: none; width:1089px; display: inline-block; line-height: 30px; border: #cacaca solid 2px; padding: 4px; padding-bottom: 9px;margin-bottom: 10px;vertical-align: top}
...
<!--            <div>
        ...
        <ul id="newlist">
                ...
                <%
                    ...
                    while (list1.for_in_rows()) {
                        if (a == 1) {
                            if (list1.get("ico") != "") {
                %>
                <div ind="<% out.print( list1.get("id"));%>" cla="2"><div><img src="/upfile/<% out.print(list1.get("ico"));%>" alt=""/></div><p><% out.print( list1.get("matter") );%></p></div>
                 <%
                 } else {
                 %>
            ...
            <li class="top2">              
                ...
                <%
                    RssListView list2 = new RssListView(pageContext, "workdynamics");
                    list2.pagesize = 5;
                     int a1 = 1;
                    list2.select().where("classify=3 and state=1").get_page_desc("id");
         ...
         <li class="top2" >
                ...
                <%
                    ...
                    list12.select().where("classify=2 and state=1").get_page_desc("id");
            ...
            <li class="top2">              
                ...
                <%
                    ...
                    int a4 = 1;
                    //list12.select().where("classify=1 and state=2").get_page_desc("id");
                    list4.select().where("classify=4 and state=1").get_page_desc("id");
