...
//                                    out.print(user.get("realname").isEmpty() ? "无" : user.get("realname"));
                            ...
                            <td ><% out.print("1".equals( list.get("questiontype")) ? "<div style='margin:0 auto; width:44px;height:20px; border-radius:15px; background-color : #32CD32;color:white;'>单选</div>" : ("2".equals( list.get("questiontype")) ? "<div style='margin:0 auto; width:44px;height:20px; border-radius:15px;background-color : #1E90FF;color:white;'>多选</div>" : "<div style='margin:0 auto; width:44px;height:20px; border-radius:15px;background-color:#EEB422;color:white;'>判断</div>") ); %></td>
                        </tr>
                        <%
                                a++;
                            }
