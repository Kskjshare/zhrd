        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor" style="text-align:center;">
                   ...
                   <tr>
                        <th>年度：</th>
                        <td><select class="w260" name="year" dict-select="questionType" def="<%// entity.write("year"); %>"></select></td>
                    </tr>
                    <tr>
                        <th>考试：</th>
...
<!--                    <tr>
        ...
        <script>
            ...
            $(".footer>[query]").click(function () {
                var str = "/electionAppointmentAndRemovalSystem/candidtateStatics/list.jsp?title=" + formfun("title") + "&createrid=" + formfun("createrid") + "&creatername=" + formfun("creatername");
