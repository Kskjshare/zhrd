...
<!--                    <tr>
        ...
        <script>
            ...
            $(".footer>[query]").click(function () {
                var str = "/electionAppointmentAndRemovalSystem/testPaperManagement/list.jsp?title=" + formfun("title") + "&createrid=" + formfun("createrid") + "&creatername=" + formfun("creatername");
