            ...
            <div>
                <table class="wp100 formor">
                    ...
                    <tr>
                        ...
                        <td><select class="w260" name="degree" dict-select="degree" def="<% entity.write("degree"); %>"></select></td>
                    </tr>                  
                    ...
                    <tr>
                        ...
                        <td><input type="text" maxlength="80" class="w254" name="post" value="<% entity.write("post"); %>" /></td>
                    </tr>
