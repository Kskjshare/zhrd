    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "appointment");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td><% out.print( list.get("post") ); %></td>
                            <td rssdate="<% out.print(list.get("birthday")); %>,yyyy-MM-dd" ></td>
                            
                            <td rssdate="<% out.print(list.get("appointshijian")); %>,yyyy-MM-dd" ></td>
                            <td><% out.print(list.get("appointNo")); %></td>

                            <td><% out.print( list.get("session") ); %></td>
                            <td><% out.print( list.get("meetingnum") ); %></td>
        ...
        <script>
              ...
              $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/electionAppointmentAndRemovalSystem/appointmentManage/butview.jsp?id=" + id + "&TB_iframe=true", '查看', {width: 760, height: 640});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/electionAppointmentAndRemovalSystem/appointmentManage/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 380, height: 180});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/electionAppointmentAndRemovalSystem/appointmentManage/edit.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 860, height: 580});
                })
            });
