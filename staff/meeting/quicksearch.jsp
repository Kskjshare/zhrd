    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 formor">
                    <tr><td>会议编号：</td><td><input class="w200" name="id"></td></tr>
                    <tr><td>届次名称：</td><td><input class="w200" name="sessionname"</td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/staff/meeting/list.jsp?id="+formfun("id")+"&sessionname="+formfun("sessionname")
