...
<html>
    <head>
        ...
        <style>
            ...
            .popupwrap>div:first-child{height: 68%;padding: 10px 0;background: #fff;border: #6caddc solid thin;}
        </style>
    </head>
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td class="dce">登录名：</td><td><input name="account"></td></tr>
                    <tr><td class="dce">用户名：</td><td><input name="realname"></td></tr>
                    <tr><td class="dce">用户组别：</td><td><select name="departmentid" dict-select="department"><option></option></select></td></tr>
                    <tr><td class="dce">角色组别：</td><td><select name="rolelist" dict-select="powergroup"><option></option></select></td>
                    </tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/staff/list.jsp?account=" + formfun("account") + "&realname=" + formfun("realname") + "&departmentid=" + formfun("departmentid") + "&rolelist=" + formfun("rolelist")
