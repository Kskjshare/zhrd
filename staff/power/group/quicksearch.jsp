    ...
    <head>
        ...
        <link href="/css/layout.css" rel="stylesheet" type="text/css" />
         <style>
            ...
            .popupwrap>div:first-child{height: 38%;padding: 10px 0;background: #fff;border: #6caddc solid thin;}
        </style>
    </head>
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td class="dce">角色名：</td><td><input name="name"></td></tr>
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/staff/power/group/list.jsp?realname="+formfun("name")
