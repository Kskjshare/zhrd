transadapter["append"] = function (t)
{
    ...
    popuplayer.display("/judicsuper/judsupadm/edit.jsp?&TB_iframe=true", '添加', {width: 830, height: 550});
};
﻿transadapter["edit"] = function (t)
{
    ...
    rid = tid.join(",");
    popuplayer.display("/judicsuper/judsupadm/edit.jsp?id=" + rid + "&TB_iframe=true", '编辑', {width: 800, height: 550});
};
...
transadapter["delete"] = function (t)
{
    ...
    rid = tid.join(",");
    popuplayer.display("/judicsuper/judsupadm/delete.jsp?relationid=" + rid + "&TB_iframe=true", '删除', {width: 300, height: 80});
}

transadapter["quicksearch"] = function (t)
{
    
    popuplayer.display("/judicsuper/judsupadm/quicksearch.jsp", '查询', {width: 450, height:250});
