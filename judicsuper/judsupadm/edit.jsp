        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        <td class="dce w120 ">标题：<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="title" value="<% entity.write("title"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w120 ">检查组人员：<em class="red">*</em></td>
                        <td colspan="5"><input type="text" maxlength="80" class="b95" name="instmem" value="<% entity.write("instmem"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w120 ">相关文件：</td>
                        <td colspan="3">
...
<!--           //          <tr style="display:none;">
                    ...
                    <tr>
                        <td class="dce w120 ">专委会：<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="specom" value="<% entity.write("specom"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w120 ">承办部门：<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="undertaker" value="<% entity.write("undertaker"); %>" /></td>
                    </tr>
