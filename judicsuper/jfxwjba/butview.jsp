                            ...
                            <% 
                                ...
                                if ( !company.isEmpty() ) {
                                    ...
                                    for ( int i = 0 ; i < companies.length; i ++  ) {
                                        userlist.select().where("myid=" + companies [ i ] ).get_first_rows();
                                        name =  name + userlist.get("realname") ;
                    ...
                    <tr>
                        ...
                        <td class="w261"colspan="3">
                            ...
                            if (entity.get("zhuangtai").equals("2")) {
                                out.print("<em class='handle no'style='color:orange;font-weight:bold;' >修改</em>");
                            }else if(entity.get("zhuangtai").equals("1")){
                                out.print("<em class='handle no' style='color:#FFD700;font-weight:bold;'>通过</em>");
                            }else if(entity.get("zhuangtai").equals("3")){
                                out.print("<em class='handle no'style='color:green;font-weight:bold;' >撤销</em>");
                            }else if(entity.get("zhuangtai").equals("4")){
                                out.print("<em class='handle no'style='color:red;font-weight:bold;' >驳回</em>");
                            }else{
                                out.print("<em class='handle no' style='color:#33ff33;font-weight:bold;'>未审查</em>");
                            };
                            %>
                        </td>
...
<!--                    <tr>
                   ...
                   if(entity.get("zhuangtai").equals("2")) {  
                    %>
                    <tr> 
                        <td colspan="2" class="w120 dce">修改原因</td>
                        <td colspan="8">
                            
                            <%
                                out.print(entity.get("xiugaiyuanyin"));
                            %>
                        </td>
                    </tr>
                     <%
                    ...
                    %>   
                     <%
                   if(entity.get("zhuangtai").equals("3")) {  
                    %>
                    <tr > 
                        <td colspan="2" class="w120 dce">撤销原因</td>
                        <td colspan="8">
                    ...
                    %>   
                    <%
                   if(entity.get("zhuangtai").equals("4")) {  
                    %>
                    <tr class="cxyy" > 
