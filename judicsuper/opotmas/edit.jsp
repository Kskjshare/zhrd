            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr style="display:none;">
                        ...
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="meetclass" value="4" /></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">群众意见</td>
