...
　}
//设置文件类型
FileProgress.prototype.setXuhao = function(id,saveData){
	//alert(serverData+"\n"+saveData);
	//下载
	var _now = this;
	var obj=_now.fileProgressElement.childNodes[1].getElementsByTagName("input")[0];
	obj.onblur = function () {
		
		var val=obj.value;
		$.ajax({
			type : 'post',
			url : "../../meeting/subMeetingAction!uploadFileXhao.action?id="+id+"&xuhao="+val,
			//data : 'id='+serverData,
