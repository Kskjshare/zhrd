            ...
            <div>
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><select type="text" maxlength="80" class="w260" name="level" dict-select="circles" def="<% entity.write("level"); %>" ></select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><b class="selectuser">添加建议附议人</b></td>
                    </tr>
