...
//        int a = sort.totalrows + 1;
        ...
        notify_messages.keyvalue("lwstate", 5 );
...
//            entity3.keyvalue("matter", StringExtend.substr(StringExtend.delHtmlTag(entity.get("matter")), 360));
     ...
     out.print("<script>alert('您没有提交权限！');</script>");
}
...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap"> 
            ...
            <div>
<!--                <div id="suggesttype" style="font-size:18px;font-family: 微软雅黑">类&nbsp;&nbsp;别：<select style="font-size:16px;font-family: 微软雅黑" name="lwstate">
...
-->
                ...
                <h1 style="font-size:22px;font-family: 微软雅黑">人民代表大会代表质询</h1>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="2"><select style="font-size:16px;font-family: 微软雅黑" type="text" maxlength="80" class="w99" name="meetingnum" dict-select="companytypeeeclassify" def="<% entity.write("meetingnum"); %>" ></select></td>
                    ...
                    <tr>
                        ...
                        %>
                        <td class="dce" style="font-size:16px;font-family: 微软雅黑">代表团</td> <%-- 虎鹏明修改字体大小 --%>
...
<!--                        <td colspan="2" <% out.print(entity.get("id").isEmpty() ? "id='adminsel'" : "");%> >
                        ...
                        <td colspan="2"><input style="font-size:16px;font-family: 微软雅黑" readonly="true" name="realid" class="yincang" type="text" value="<% user.write("realid"); %>" ></td>
                    </tr>-->
</tr>
<!--                    <tr>
...
<!--zyx注销，暂时不需要这些功能-->
                        ...
                        <td colspan="5"><ul style="font-size:16px;font-family: 微软雅黑" id="blfyr">
                                <li>
                                    ...
                                    <em  style='display: inline;width: 63.7%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;border-left: 0px;font-size:16px;font-family: 微软雅黑'>附议代表姓名</em>
                                    <em style='display: inline;width: 35.5%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;font-size:16px;font-family: 微软雅黑'>&nbsp;操作</em>                               
                                   </li>
                                   <!--zyx修改新增页面现实问题-->
                    ...
                    <tr class="">
                        <td colspan="6" class="marginauto uetd">
                            <ul><li class="sel" style="font-size:16px;font-family: 微软雅黑">内容摘要</li></ul>
...
<!--                            <div style="display: none;"><span id="fjfile2" rid="2" style="color:blue;font-size:16px;font-family: 微软雅黑;font-weight: bold;">点击选择文件</span>
                    ...
                    <tr>
                        <td class="dce" style="font-size:16px;font-family: 微软雅黑">审查分类<em class="red">*</em></td>
                    ...
                    <tr  class="fsry">
                        ...
                        <td class="w120 dce shencha" style="font-size:16px;font-family: 微软雅黑">审查单位</td>
...
<!------- added by ding for ruzhou's project ----->
		...
		%>
  		...
  		<%                                //        if (!(entity.get("level").equals("0"))) {//选择人代委（powergroupid=8）
                                if ((userLevel.equals("0"))) {//选择乡镇政府办（powergroupid=25）
                                %>
                ...
                RssWin.onwinreceivemsg = function (dict) {
                    $.each(dict, function (k, v) {
                        if ($("em[myid='" + v.myid + "']").length == "0") {
                            t.append("<li myid='" + v.myid + "'>" + v.linkman + "<em class='red' style='font-weight:bold;'>删除</em></li>")
                        }
                    })
...
//                    zyx修改，添加联名人页面显示问题，只显示姓名和删除按钮
            ...
            $('.selectcompany').click(function () {
                ...
                RssWin.onwinreceivemsg = function (dict) {
                    $.each(dict, function (k, v) {
                        if ($("em[myid='" + v.myid + "']").length == "0") {
                            t.append("<li myid='" + v.myid + "'>" + v.realname + "<em class='red' style='font-weight:bold;'>删除</em></li>")
                        }
                    })
                    t.find("em").off("click").click(function () {
                        $(this).parent().remove();
...
//                })
            ...
            $('.selectscr22').click(function () {
                ...
                RssWin.onwinreceivemsg = function (dict) {
                    $.each(dict, function (k, v) {
                        if ($("em[myid='" + v.myid + "']").length == "0") {
                            t.append("<li myid='" + v.myid + "'>" + v.realname + "<em class='red' style='font-weight:bold;'>删除</em><input type='hidden' name='fsrID' value='" + v.myid + "' /></li>")
                        }
                    })
                    t.find("em").off("click").click(function () {
                        $(this).parent().remove();
            ...
            $('.selectscra22').click(function () {
                ...
                RssWin.onwinreceivemsg = function (dict) {
                    $.each(dict, function (k, v) {
                        if ($("em[myid='" + v.myid + "']").length == "0") {
                            t.append("<li myid='" + v.myid + "'>" + v.realname + "<em class='red' style='font-weight:bold;'>删除</em><input type='hidden' name='xzscID' value='" + v.myid + "' /></li>")
                        }
                    })
                    t.find("em").off("click").click(function () {
                        $(this).parent().remove();
