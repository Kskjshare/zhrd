...
<%
    ...
    RssList classify = new RssList(pageContext, "companytypee_classify");
    //ding end
...
//            entity.keyvalue("isysw", "21");//闭会市镇，经过选工委或代表联络科
           ...
           //汝州項目，議案特殊流程。因爲所有的經過人大主席團。所以强制吧examination=2
           if ( cookie.Get("powergroupid").equals("38") ) {
               entity.keyvalue("examination", "2");
               entity.keyvalue("workflow", "2");
           }
            //end
...
//        int a = sort.totalrows + 1;
        ...
        notify_messages.keyvalue("lwstate", 2 );
...
-->
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="2" id="parentname"><input style="font-size:16px;font-family: 微软雅黑" class="yincang" type="text" value="<% user.write("delegationname"); %>" ></td>
                    </tr>
                    <tr>
...
%>
                        ...
                        <td class="dce"><b class="selectuser" style="color:blue;font-size: 16px;font-family: 微软雅黑">添加附议人<em class="red">*</em></b></td>
                        <td colspan="5"><ul style="font-size:16px;font-family: 微软雅黑" id="blfyr">
                                <li>
                                    ...
                                    %>
                                <li style="font-size:16px;font-family: 微软雅黑"  myid='<% out.print(secondlist.get("userid"));%>'>
...
<!--                            <div style="display: none;"><span id="fjfile2" rid="2" style="color:blue;font-size:16px;font-family: 微软雅黑;font-weight: bold;">点击选择文件</span>
                    ...
                    <tr>
                        ...
                        <td colspan="5" selradio>
                            <select style="width:200px;font-size:16px" value="<% classify.write("name"); %>" name="reviewclass"  
...
//            var $powergroupid1 = <% out.print(cookie.Get("powergroupid"));%>
