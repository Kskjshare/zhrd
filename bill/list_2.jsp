                ...
                <table class="wp100 tc cellbor" id="section">
                    <thead>
                        <tr>
                            ...
                            <th style="width:200px;" class="w120">主办单位</th>
...
if (meetingTime.equals("0")){
            list.select().where("lwstate=2 and draft=2 and ismeet=0 and mission=" + cookie.Get("myid")).get_page_desc("id");
    }
    else {
             list.select().where("lwstate=2 and draft=2 and ismeet=1 and mission=" + cookie.Get("myid")).get_page_desc("id");
    }
                            ...
                            <!--<td class="handle no">-->
                                <%
                                    ...
                                    if (list.get("examination").equals("1")) {
                                       // handle = "未审查";
                                         handle = "<td class='handle no' style='color:red;font-weight:bold;v'>待复审</td>";
                                    }
        ...
        <script>
             ...
             $(function(){
                ...
                popuplayer.display("/billlist/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 1024, height: 640});
                })
            });
             $(function(){
                ﻿$(".edit").click(function(){
                ...
                popuplayer.display("/billlist/editupdate.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 1024, height: 640});
                })
            });
             $(function(){
