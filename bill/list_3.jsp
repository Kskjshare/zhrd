...
if (meetingTime.equals("0")){
            list.select().where("lwstate=3 and draft=2 and ismeet=0 and mission=" + cookie.Get("myid")).get_page_desc("id");
    }
    else {
             list.select().where("lwstate=3 and draft=2 and ismeet=1 and mission=" + cookie.Get("myid")).get_page_desc("id");
    }
