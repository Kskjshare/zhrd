    ...
    <body>
        ...
        <script>
            ...
            $(".footer>[query]").click(function () {
                var str = "/bill/list.jsp?draft=<% out.print(req.get("draft"));%>&lwstate=<% out.print(req.get("lwstate"));%>&id=" + formfun("id") + "&allname=" + formfun("allname") + "&title=" + formfun("title") + "&realcompanyname=" + formfun("realcompanyname") + "&telphone=" + formfun("telphone") + "&sessionid=" + formfun("sessionid") + "&realname=" + formfun("realname") + "&year=" + formfun("year");
