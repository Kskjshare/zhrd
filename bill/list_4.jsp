...
if (meetingTime.equals("0")){
            list.select().where("lwstate=4 and draft=2 and ismeet=0 and mission=" + cookie.Get("myid")).get_page_desc("id");
    }
    else {
             list.select().where("lwstate=4 and draft=2 and ismeet=1 and mission=" + cookie.Get("myid")).get_page_desc("id");
    }
...
//                            }
        ...
        <script>
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/billlist/editupdate_2.jsp?id=" + id , '编辑', {width: 830, height: 560});
                })
            });
             $(function(){
