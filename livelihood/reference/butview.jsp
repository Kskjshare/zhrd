...
<%
    ...
    RssList entity = new RssList(pageContext, "reference");
    entity.request();
...
<html>
    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <div id="headxq"><em>参考详情</em><span>×</span></div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w120 dce">添加时间</td><td colspan="3"  rssdate="<% out.print(entity.get("shijian")); %>,yyyy-MM-dd hh:mm:ss"></td></tr>
                    <tr><td class="w120 dce">外部链接</td><td colspan="3"><% out.print(entity.get("links"));%></td></tr>
                    <tr>
                        <td colspan="4" class="marginauto uetd">
                            <ul><li class="sel">详细内容</li></ul>
