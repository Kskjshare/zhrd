...
<%
    ...
    RssList entity = new RssList(pageContext, "lecture");
    entity.request();
...
<html>
    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <div id="headxq"><em>讲座详情</em><span>×</span></div>
                <table class="wp100 cellbor">
                    <tr><td colspan="4" id="tabheader">查看详情</td></tr>
                    <tr><td class="w120 dce">讲座主题</td><td colspan="3"><% out.print(entity.get("title"));%></td></tr>
                    <tr><td class="w120 dce">下载附件</td><td colspan="3"><a href="/upfile/<% entity.write("enclosure");%>" alt=""/><% entity.write("enclosure");%></a></td></tr>
                    ...
                    <tr><td class="w120 dce">讲座形式</td><td lectureclassify="<% entity.write("classify");%>"></td><td class="w120 dce">讲座时间</td><td  rssdate="<% out.print(entity.get("shijian")); %>,yyyy-MM-dd hh:mm:ss"></td></tr>
                    <tr><td class="w120 dce">讲座分类</td><td colspan="3" lecturetype="<% entity.write("type");%>"></td></tr>
                    <tr><td class="w120 dce">外部链接</td><td colspan="3"><% out.print(entity.get("links"));%></td></tr>
                    <tr>
                        <td colspan="4" class="marginauto uetd">
                            <ul><li class="sel">讲座内容</li></ul>
        ...
        <script>
            ...
            $("span[video]").click(function () {
                ...
                popuplayer.display("/makepolicy/lecture/video.jsp?id=" + video, '视频播放', {width: 1000, height: 600});
            })
        </script>
    </body>
</html>
