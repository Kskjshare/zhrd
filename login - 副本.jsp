...
<!--                <img id="loginimg" src=""  style="margin-top:20px;"/>-->
                ...
                <img src="LoginPage/images/yhm-30-lanse.png"  style="margin-top: 10px;" />
                <input type="text" placeholder="账&nbsp;号"  id="account" name="account" value="<% out.print(req.get("account")); %>"  style="width:250px;
                       height: 26px; line-height: 20px; font-size: 16px; border: 0px; background: rgba(0, 0, 0, 0); background-color:rgba(0, 0, 0, 0) !important;
                       outline: none; position: relative; top: -38px;left:22px; "/>


                <img src="LoginPage/images/mm-30-lanse.png"  style="margin-top: -18px;" />
                <input type="password" placeholder="密&nbsp;码"  id="pwd" name="pwd" value="<% out.print(req.get("pwd"));%>" style="width:250px;
                ...
                <div style="height:40px; position: absolute;left: 80px;margin-top:-46px;">
                    <input name="numbercodepre" type="text" placeholder="验&nbsp;证&nbsp;码" 
                           style="width:130px;left:15px; height:38px; position: relative; top: -16px; border: none;background: rgba(0, 0, 0, 0);font-size:16px;" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
