...
{
    popuplayer.display("/delegation/edit.jsp?TB_iframe=true", '新增代表团信息', {width: 830, height: 270});
}
﻿transadapter["edit"] = function (t)
{
    ...
    popuplayer.display("/delegation/edit.jsp?id=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 830, height: 270});
}
...
//    account2=account1.join("','");
    popuplayer.display("/meetfeedback/delete.jsp?id=" +rid + "&TB_iframe=true", '删除', {width: 300, height: 80});
}
...
﻿transadapter["butview"] = function (t)
{
    ...
    popuplayer.display("/meetfeedback/butview.jsp?id=" + transadapter.id + "&TB_iframe=true", '查看', {width: 830, height:220});
}
