...
<%
    ...
    RssList entity2 = new RssList(pageContext, "personsystem");
    RssListView entity = new RssListView(pageContext, "personsystem");
    entity.request();
    entity2.request();
            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td><select class="w250" name="classify" dict-select="systemclass" def="<% entity.write ("classify"); %>"></select></td>
