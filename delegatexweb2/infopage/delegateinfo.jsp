...
<!--                        <td>籍贯：<span>浙江绍兴</span></td>
        ...
        $("#viewActivity").click(function() {
            location.href="/delegatexweb2/activity.htm?myid=<% out.print(entity.get("relationid"));%>" + "&substationid=" + <% out.print(divisionList.get("myid"));%>;
        })
        
        $("#report").click(function() {
            location.href="/delegatexweb2/report.htm?myid=<% out.print(entity.get("relationid"));%>" + "&substationid=" + <% out.print(divisionList.get("myid"));%>;
        })
        </script>
    </body>
</html>
