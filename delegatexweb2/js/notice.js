...
$(function () {
    ...
    notice_substationid = substationid ;
  ...
  //获取代表团名
    RssApi.Table.List("station_sub_id").condition( { "myid": notice_substationid   } ).keyvalue({ "pagesize": 10 }).getJson(function ( data ) {
        for (var i = 0; i < data.length; i++) {
...
$(function () {
            ...
            location.href = "contactstation.htm?substationid=" + notice_substationid ;  
            });
            $("#notice_contactStation").click(function(){ //点击联络站概况
                location.href = "contactstationDetail.htm?substationid=" + notice_substationid ;  
            });

            $("#notice_organization").click(function(){//组织机构
                location.href = "organization.htm?substationid=" + notice_substationid ;  
            });
            $("#notice_workdynamics").click(function(){//工作动态
                location.href = "workdynamics.htm?classify=1&state=2&substationid=" + notice_substationid ;           
            });
            $("#notice_delegate").click(function(){//人大代表
               location.href = "representative.htm?substationid=" + notice_substationid ;         
            });
...
//               location.href = "notice.htm?classify=3&state=2";           
            ...
            $("#notice_institution").click(function(){//工作制度
                location.href = "institution.htm?substationid=" + notice_substationid ;             
            });
