...
var livelihood_substationid = "100";
...
$(function () {
    ...
    console.log(" __________ classify", classify );
    console.log(" __________ substationid", substationid )
    ...
    livelihood_substationid =  substationid ;
...
$("#firstPage").click(function(){ //点击首页
    location.href = "contactstation.htm?substationid=" + livelihood_substationid ;
});
$("#livelihood_contactStation").click(function(){ //点击联络站概况
    location.href = "contactstationDetail.htm?substationid=" + livelihood_substationid ;
});

$("#livelihood_organization").click(function(){//组织机构
    location.href = "organization.htm?substationid=" + livelihood_substationid ;
});
$("#livelihood_workdynamics").click(function(){//工作动态
    location.href = "workdynamics.htm?classify=1&state=2&substationid=" + livelihood_substationid ;           
});
$("#livelihood_delegate").click(function(){//人大代表
   location.href = "representative.htm?substationid=" + livelihood_substationid ;          
});
$("#livelihood_notice").click(function(){//通知公告
   location.href = "notice.htm?classify=3&state=2&substationid=" + livelihood_substationid ;          
});
$("#livelihood_allstation").click(function(){//联络总站
   location.href = "/delegatexweb/bmweb.jsp";      
})

$("#livelihood_institution").click(function(){//工作制度
    location.href = "institution.htm?substationid=" + livelihood_substationid ;          
});        

function newsShowContent(rssid) {
    location.href = "News_show.htm?id=" + rssid + "&substationid=" + livelihood_substationid ;
}
