...
var forenotice_substationid = "100" ;
...
$(function () {
    ...
    forenotice_substationid =  substationid ;
...
$("#firstPage").click(function(){ //点击首页
    location.href = "contactstation.htm?substationid=" + forenotice_substationid ;
});
$("#forenotice_contactStation").click(function(){ //点击联络站概况
    location.href = "contactstationDetail.htm?substationid=" + forenotice_substationid ;
});

$("#forenotice_organization").click(function(){//组织机构
    location.href = "organization.htm?substationid=" + forenotice_substationid ;
});
$("#forenotice_workdynamics").click(function(){//工作动态
    location.href = "workdynamics.htm?classify=1&state=2&substationid=" + forenotice_substationid ;         
});
$("#forenotice_delegate").click(function(){//人大代表
   location.href = "representative.htm?substationid=" + forenotice_substationid ;          
});
$("#forenotice_notice").click(function(){//通知公告
   location.href = "notice.htm?classify=3&state=2&substationid=" + forenotice_substationid ;         
});
$("#forenotice_allstation").click(function(){//联络总站
   location.href = "/delegatexweb/bmweb.jsp";      
})

$("#forenotice_institution").click(function(){//工作制度
    location.href = "institution.htm?substationid=" + forenotice_substationid ;          
});        

function newsShowContent(rssid) {
    location.href = "News_show.htm?id=" + rssid + "&substationid=" + forenotice_substationid ;;
}
