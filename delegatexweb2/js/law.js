...
$(function () {
    ...
    law_substationid = substationid;
    console.log("____ substationid is : " +  substationid );
    console.log("____ state is : " +  state );
console.log("____ classify is : " +  classify );
    state = 2 ;
...
$("#firstPage").click(function(){ //点击首页
    location.href = "contactstation.htm?substationid=" + law_substationid ;     
});
$("#law_contactStation").click(function(){ //点击联络站概况
    location.href = "contactstationDetail.htm?substationid=" + law_substationid ;  
});

$("#law_organization").click(function(){//组织机构
    location.href = "organization.htm?substationid=" + law_substationid ;  
});
$("#law_workdynamics").click(function(){//工作动态
    location.href = "workdynamics.htm?classify=1&state=2&substationid=" + law_substationid ;            
});
$("#law_delegate").click(function(){//人大代表
   location.href = "representative.htm?substationid=" + law_substationid ;             
});
$("#law_notice").click(function(){//通知公告
   location.href = "notice.htm?classify=3&state=2&substationid=" + law_substationid ;             
});
$("#law_allstation").click(function(){//联络总站
   location.href = "/delegatexweb/bmweb.jsp";      
})
        

$("#law_institution").click(function(){//工作制度
    location.href = "institution.htm?substationid=" + law_substationid ;             
});
