$(function () {
   ...
   RssApi.Table.List("ztimges").condition({"collectiontype":1,"type":1}).keyvalue({ "pagesize": 12 }).getJson(function (data) {
        console.log(data);
    ...
    RssApi.Table.List("ztimges").condition({"collectiontype":1,"type":2}).keyvalue({ "pagesize": 12 }).getJson(function (data) {	
    ...
    RssApi.Table.List("ztimges").condition({"collectiontype":1,"type":3}).keyvalue({ "pagesize": 12 }).getJson(function (data) {
     ...
     RssApi.Table.List("ztimges").condition({"collectiontype":1,"type":4}).keyvalue({ "pagesize": 12 }).getJson(function (data) {
...
function showLi(rssid) {
    location.href = "collection_show.htm?id=" + rssid + "";
}
