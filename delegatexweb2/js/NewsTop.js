...
$(function () {
    ...
    newstop_substationid = substationid;
    state = 2 ;
    
    console.log("____ newstop classify is : " +  classify );
    console.log("____ newstop state is : " +  state );

    console.log("____ newstop substationid is : " +  substationid );
    ...
    RssApi.Table.List("stationcontent").condition( { "classify": classify  ,"state": state , "substationid":substationid } ).keyvalue({ "pagesize": 1000 }).getJson(function (data) {
        var liStr = "";
            console.log("____ newstop data is : " +  data );
    ...
    RssApi.Table.List("station_sub_id").condition( { "myid": substationid   } ).keyvalue({ "pagesize": 10 }).getJson(function ( data ) {
            console.log("____ newstop data is : " +  data[0] );
...
$(function () {
            ...
            $("#firstPage").click(function(){ //点击首页
                location.href = "contactstation.htm?substationid=" + newstop_substationid ;  
            });
            $("#lvzhi_contactStation").click(function(){ //点击联络站概况
                location.href = "contactstationDetail.htm?substationid=" + newstop_substationid ;  
            });

            $("#lvzhi_organization").click(function(){//组织机构
                location.href = "organization.htm?substationid=" + newstop_substationid ;  
            });
            $("#lvzhi_workdynamics").click(function(){//工作动态
                location.href = "workdynamics.htm?classify=1&state=2&substationid=" + newstop_substationid ;            
            });
            $("#lvzhi_delegate").click(function(){//人大代表
               location.href = "representative.htm?substationid=" + newstop_substationid ;             
            });
            $("#lvzhi_notice").click(function(){//通知公告
               location.href = "notice.htm?classify=3&state=2&substationid=" + newstop_substationid ;             
            });
            $("#lvzhi_allstation").click(function(){//联络总站
               location.href = "/delegatexweb/bmweb.jsp";      
            })
            
           //工作制度
            $("#institution_contactStation").click(function(){ //点击联络站概况
                location.href = "contactstationDetail.htm?substationid=" + newstop_substationid ;  
            });

            $("#institution_organization").click(function(){//组织机构
                location.href = "organization.htm?substationid=" + newstop_substationid ;  
            });
            $("#institution_workdynamics").click(function(){//工作动态
                location.href = "workdynamics.htm?classify=1&state=2&substationid=" + newstop_substationid ;            
            });
            $("#institution_delegate").click(function(){//人大代表
               location.href = "representative.htm?substationid=" + newstop_substationid ;             
            });
            $("#institution_notice").click(function(){//通知公告
               location.href = "notice.htm?classify=3&state=2&substationid=" + newstop_substationid ;             
            });
            $("#institution_allstation").click(function(){//联络总站
               location.href = "/delegatexweb/bmweb.jsp";      
            })
            
            
            //代表风采
            $("#fengcai_contactStation").click(function(){ //点击联络站概况
                location.href = "contactstationDetail.htm?substationid=" + newstop_substationid ;  
            });

            $("#fengcai_organization").click(function(){//组织机构
                location.href = "organization.htm?substationid=" + newstop_substationid ;  
            });
            $("#fengcai_workdynamics").click(function(){//工作动态
                location.href = "workdynamics.htm?classify=1&state=2&substationid=" + newstop_substationid ;            
            });
            $("#fengcai_delegate").click(function(){//人大代表
               location.href = "representative.htm?substationid=" + newstop_substationid ;             
            });
            $("#fengcai_notice").click(function(){//通知公告
               location.href = "notice.htm?classify=3&state=2&substationid=" + newstop_substationid ;             
            });
            $("#fengcai_allstation").click(function(){//联络总站
               location.href = "/delegatexweb/bmweb.jsp";      
            })
