...
$(function () {
    ...
    report_substationid = substationid ;
    state = 2 ;
    console.log("________ classify" , classify );
    console.log("________ substationid" , substationid );
...
$("#firstPage").click(function(){ //点击首页
    location.href = "contactstation.htm?substationid=" + report_substationid ;  
});
$("#report_contactStation").click(function(){ //点击联络站概况
    location.href = "contactstationDetail.htm?substationid=" + report_substationid ; 
});

$("#report_organization").click(function(){//组织机构
    location.href = "organization.htm?substationid=" + report_substationid ; 
});
$("#report_workdynamics").click(function(){//工作动态
    location.href = "workdynamics.htm?classify=1&state=2&substationid=" + report_substationid ;           
});
$("#report_delegate").click(function(){//人大代表
   location.href = "representative.htm?substationid=" + report_substationid ;           
});
$("#report_notice").click(function(){//通知公告
   location.href = "notice.htm?classify=3&state=2&substationid=" + report_substationid ;            
});
$("#report_allstation").click(function(){//联络总站
   location.href = "/delegatexweb/bmweb.jsp";      
})

$("#report_institution").click(function(){//工作制度
    location.href = "institution.htm?substationid=" + report_substationid ;           
});        

function newsShowContent(rssid) {
    location.href = "News_show.htm?id=" + rssid + "&substationid=" + report_substationid ; 
}
