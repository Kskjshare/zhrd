...
$(function () {
    ...
    document_substationid = substationid;
...
$("#firstPage").click(function(){ //点击首页
    location.href = "contactstation.htm?substationid=" + document_substationid ;   
});
$("#document_contactStation").click(function(){ //点击联络站概况
    location.href = "contactstationDetail.htm?substationid=" + document_substationid ;   
});

$("#document_organization").click(function(){//组织机构
    location.href = "organization.htm?substationid=" + document_substationid ;   
});
$("#document_workdynamics").click(function(){//工作动态
    location.href = "workdynamics.htm?classify=1&state=2&substationid=" + document_substationid ;          
});
$("#document_delegate").click(function(){//人大代表
   location.href = "representative.htm?substationid=" + document_substationid ;              
});
$("#document_notice").click(function(){//通知公告
   location.href = "notice.htm?classify=3&state=2&substationid=" + document_substationid ;             
});
$("#document_allstation").click(function(){//联络总站
   location.href = "/delegatexweb/bmweb.jsp";      
})
  
$("#document_institution").click(function(){//工作制度
    location.href = "institution.htm?substationid=" + document_substationid ;             
});           
