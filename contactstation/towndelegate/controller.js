...
//    }
    popuplayer.display("/contactstation/towndelegate/edit.jsp?TB_iframe=true", '新增', {width: 830, height: 550});
}
transadapter["edit"] = function (t)
{
    ...
    popuplayer.display("/contactstation/towndelegate/edit.jsp?relationid=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 830, height: 500});
}
transadapter["delete"] = function (t)
{
    ...
    popuplayer.display("/contactstation/towndelegate/delete.jsp?relationid=" + rid + "&account=" +account2 + "&rolelist=" +rolelist2 + "&TB_iframe=true", '删除', {width: 300, height: 80});
}
