        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                        RssList list = new RssList(pageContext, "contactstation_new");
                        list.request();
                        int a = 1;
                        list.pagesize = 30;
  		            ...
  		            <%
                            ...
                            {
                            %>
                 	    <span class="ys chakan" style="font-weight:bold;" id="<% out.print(list.get("id")); %>" name="<% out.print(list.get("name")); %>">管理站点</span> 
                            ...
                            |<span class="ys append" style="font-weight:bold;color:orange" id="<% out.print(list.get("id")); %>">新增联络站</span> 
...
//                popuplayer.display("/contactstation/substation/list_new.jsp?id=" + id + "&TB_iframe=true", '管理站点', {width: 980, height: 600});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/contactstation/contactstation/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 380, height: 160});
                })
            });
             $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/contactstation/contactstation/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 230, height: 80});
                })
            });
             ...
             $(function(){
                ﻿$(".append").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/contactstation/contactstation/append.jsp?id=" + id + "&TB_iframe=true", '新增联络站', {width: 640, height: 420});
                })
            });
