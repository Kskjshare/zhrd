...
<%
    ...
    RssList editentity = new RssList(pageContext, "contactstation_new");
...
<!--                    <tr>
                     ...
                     <tr>
                        <td class="dce" style="font-size:16px;font-family: 微软雅黑">名称<em class="red">*</em></td>
                        <td colspan="5"><input style="font-size:16px;font-family: 微软雅黑" type="text" maxlength="80"  name="name" value="<% entity.write("name"); %>" /></td>
                    </tr>
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        <td><textarea type="text"  name="opentime"><% entity.write("opentime"); %></textarea></td>
                    </tr>
                    <tr>
