    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td class="dce">站点名称：</td><td><input name="title"></td></tr>
                    <tr><td class="dce">所属联络站：</td><td><input name="name"></td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/contactstation/substation/list.jsp?name="+formfun("name")+"&title="+formfun("title")
