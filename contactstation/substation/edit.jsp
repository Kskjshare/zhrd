                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="font-size:16px">
                            <input type="text" class="w200 Wdate" name="opentime"  rssdate="<% out.print(entity.get("opentime")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly">
                        </td>
                    </tr>
                    <tr>
