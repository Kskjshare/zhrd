    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td class="dce">联络站名称：</td><td><input name="name"></td></tr>
                    <tr><td class="dce">管理员名称：</td><td><input name="linkman"></td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/contactstation/list.jsp?name="+formfun("name")+"&linkman="+formfun("linkman")
