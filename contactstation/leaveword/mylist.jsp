                    ...
                    <tbody>
                        <%
                            ...
                            if ( cookies.Get("powergroupid").equals("7") || cookies.Get("powergroupid").equals("8") || cookies.Get("powergroupid").equals("16")|| cookies.Get("powergroupid").equals("22")) {
                                ...
                                list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%'" + " and objid="+ UserList.MyID(request)).get_page_desc("id"); 

//                                list.select().where("objid=" + UserList.MyID(request)).get_page_desc("id");
                            }
...
<!--                            <td><% out.print(list.get("title")); %></td>-->
                            ...
                            <span class="ys jiaojie" id="<% out.print(list.get("id")); %>" style="color:blue;font-weight: bold" >交接1<%out.print(cookies.Get("powergroupid").equals("7"));%></span>
                            |<span class="ys notjiaojie" id="<% out.print(list.get("id")); %>" style="color:blue;font-weight: bold" >不予接受1</span>
