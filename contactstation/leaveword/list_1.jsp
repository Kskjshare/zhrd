...
<html>
    ...
    <body>
        <form method="post" id="mainwrap">
            <div class="toolbar">
                <button type="button" transadapter="quicksearchhh" select="false" class="quicksearch">查询</button>
                <!--<button type="button" transadapter="editt" class="butedit">交接</button>-->
                <!--<button type="button" transadapter="returnn" class="butedit">驳回代表</button>-->
                    ...
                    <tbody>
                        <%
                            ...
                            if ( cookies.Get("powergroupid").equals("7") || cookies.Get("powergroupid").equals("8") || cookies.Get("powergroupid").equals("16")|| cookies.Get("powergroupid").equals("22")) {
                               // list.select().where("objstate=1 and handover=0").get_page_desc("id");
                                list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%'" + " and state=1 and handover=0 and objstate=1").get_page_desc("id"); 
