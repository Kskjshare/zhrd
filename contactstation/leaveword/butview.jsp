        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        <td class="dce w100 ">留言人：</td>
                        <td><% entity.write("myname"); %></td>
                        <td class="dce w100 ">联系手机：</td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><div><% entity.write("matter");%></div></td>
                    </tr>
                    <!--zyx 增加回信为空时不显示-->
                    <%
                    if ( entity.get("write_back") !=""){
                    %>
                    <tr>
                        <td class="dce w100 ">回信</td>
                        <td colspan="3"><div><% entity.write("write_back");%></div></td>
                    </tr>
                    <%
                    };
                    %>
