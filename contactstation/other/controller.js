...
//    }
    popuplayer.display("/contactstation/other/edit.jsp?TB_iframe=true", '新增', {width: 830, height: 550});
}
transadapter["edit"] = function (t)
{
    ...
    popuplayer.display("/contactstation/other/edit.jsp?relationid=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 830, height: 500});
}
transadapter["delete"] = function (t)
{
    ...
    popuplayer.display("/contactstation/other/delete.jsp?relationid=" + rid + "&account=" +account2 + "&rolelist=" +rolelist2 + "&TB_iframe=true", '删除', {width: 300, height: 80});
}
function ck_ondblclick() {

    $('tbody tr').dblclick(function () {
        popuplayer.display("/contactstation/other/butview.jsp?relationid=" + $(this).attr('idd') + "&TB_ifram.e=true", '查看', {width: 830, height: 560});
    })

}
transadapter["quicksearch"] = function (t)
{
    popuplayer.display("/contactstation/other/quicksearch.jsp", '查询', {width: 400, height: 250});
}
transadapter["butreview"] = function (t)
{
    popuplayer.display("/contactstation/other/butreview.jsp", '审查', {width: 830, height: 400});
}
﻿transadapter["butview"] = function (t)
{
    ...
    popuplayer.display("/contactstation/other/butview.jsp?relationid=" + transadapter.id + "&TB_iframe=true", '查看', {width: 830, height: 560});
}
