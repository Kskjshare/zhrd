    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="dce">类别：</td><td><select name="classify" dict-select="stationcontent"><option></option></select></td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/contactstation/my/list.jsp?classify="+formfun("classify")+"&title="+formfun("title")
