        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td colspan="4" id="tabheader">议案查看</td></tr>
                    ...
                    <tr><td class="w120 dce">议案编号</td><td class="w261"><% entity.write("realid"); %></td><td class="w120 dce">提交类型</td><td class="w261" lwstate="<% entity.write("lwstate"); %>"></td></tr>
                    <tr><td class="w120 dce">议案题目</td><td colspan="3"><% entity.write("title"); %></td></tr>
                    ...
                    <tr>
                        <td colspan="4" class="marginauto uetd">
                            <ul><li class="sel">议案内容</li><li>提出者信息</li><li>议案办复信息</li><li>操作相关日志</li></ul>
                            <% entity.write("matter"); %>
                        </td>
                    </tr>
                </table>
