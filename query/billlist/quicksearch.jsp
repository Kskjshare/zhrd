    ...
    <body>
        ...
        <script>
            $(".footer>[query]").click(function () {
                parent.quicksearch("/query/suggest/list.jsp?id="+formfun("id")+"&sortid="+formfun("sortid")+"&title="+formfun("title")+"&matter="+formfun("matter")+"&reviewclass="+formfun("reviewclass")+"&methoded="+formfun("methoded")+"&realname="+formfun("realname"))
                popuplayer.close();
            })
