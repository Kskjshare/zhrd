                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + list.get("title") + "%' and methoded like '%" + list.get("methoded") + "%' and organizer like '%" + list.get("organizer") + "%' and lwid like '%" + list.get("lwid") + "%' and realid like '%" + list.get("realid") + "%' and lwstate=1").get_page_desc("realid");
                            while (list.for_in_rows()) {
                        %>
                        <tr ondblclick="ck_dbAbnlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
