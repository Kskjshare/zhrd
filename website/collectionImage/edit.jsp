...
<%
    ...
    RssList entity = new RssList(pageContext, "ztimges");
...
<!--                    <tr>
                    ...
                    <tr><td class="dce w100 ">新闻图片</td>
                     ...
                     <tr >
                        ...
                        <td class="dce w100 ">专题类别</td>
                        <td><select class="w250" name="collectiontype" dict-select="collectionType" def="<% entity.write("collectiontype"); %>"></select></td>
                    </tr>
                    
                    <tr >
                        <td class="dce w100 ">内容类型</td>
                        <td><select class="w250" name="type" dict-select="contentType" def="<% entity.write("type"); %>"></select></td>                       
