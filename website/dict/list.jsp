                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and classifyid=17").get_page_desc("id");
        ...
        <script>
            ...
            ﻿$(".delete").click(function(){
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/dict/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 830, height: 380});
                })
            });
