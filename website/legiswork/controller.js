transadapter["append"] = function (t)
{
    ...
    popuplayer.display("/website/legiswork/edit.jsp?&TB_iframe=true", '添加', {width: 830, height: 550});
}
...
//    });
//    rid = tid.join(",");
//    popuplayer.display("/website/legiswork/edit.jsp?id=" + rid + "&TB_iframe=true", '编辑', {width: 800, height: 550});
...
transadapter["delete"] = function (t)
{
    ...
    rid = tid.join(",");
    popuplayer.display("/website/legiswork/delete.jsp?relationid=" + rid + "&TB_iframe=true", '删除', {width: 300, height: 80});
}

transadapter["quicksearch"] = function (t)
{
    popuplayer.display("/website/legiswork/quicksearch.jsp", '快速查询', {width: 500, height: 200});
}
