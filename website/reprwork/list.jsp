                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and classifyid=7").get_page_desc("shijian");
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
        ...
        <script>
            ...
            $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/reprwork/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 960, height: 720});
                })
            });
            ...
            ﻿$(".toutiao").click(function(){
                let id = $(this).attr("id");
             //popuplayer.display("/supervision/zhifajiancha/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
             popuplayer.display("/website/reprwork/headline.jsp?id=" + id + "&TB_iframe=true", '设置头条新闻', {width: 400, height: 140});
            ...
            ﻿$(".horselight").click(function(){
                let id = $(this).attr("id");
             //popuplayer.display("/supervision/zhifajiancha/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
             popuplayer.display("/website/reprwork/horselight.jsp?id=" + id + "&TB_iframe=true", '设置图片新闻', {width: 360, height: 120});
