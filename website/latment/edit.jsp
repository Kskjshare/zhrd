...
//                entity.keymyid(cookie.Get("myid"));
                ...
                //if ( entity1.get("newsid").equals("1") ){
                    ...
                    newinformation.remove("relationid", "classifyid", "meetid", "keywords", "summary", "ico", "picture", "organize", "leader", "enclosure", "enclosurename", "publiclassifyid", "typeid", "newsid", "origin", "classification");                                  
                    newinformation.keyvalue( "title" , entity1.get("title") );
                    newinformation.keyvalue( "isFromwebsite" , "1" );
                    newinformation.keyvalue( "infotype" , 2 );
                    newinformation.keyvalue( "myid" , UserList.MyID(request) ); 
                    newinformation.keyvalue( "matter" , entity1.get("matter") ); 
                    newinformation.keyvalue( "relationid" , entity1.get("id") ); 
                    ...
                    notify_messages.keyvalue( "infotype" , 2 );
...
<!--                    <tr>
                    ...
                    <tr style="display: none;">
                        ...
                        <td><select class="w250 classify" name="classifyid" dict-select="releasumclassifys" def="8"></select></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">是否发布</td>
                        <td><select class="b99" name="state" dict-select="releasumstate" def="<% entity.write("state"); %>"></select></td>
                    </tr>
