    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "reldirector");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td directortype="<% out.print(list.get("worktitle")); %>"></td>
                            <td>
        ...
        <script>
            ...
            ﻿$(".delete").click(function(){
             ...
             popuplayer.display("/website/director/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/director/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 830, height: 380});
                })
            });
        </script>
