...
<%
    ...
    RssList entity = new RssList(pageContext, "reldirector");
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        <td class="dce w100 ">职称<em class="red">*</em></td>
                        <td><select class="w250" name="worktitle" dict-select="directortype" def="<% entity.write("worktitle"); %>"></select></td>
                        <td class="dce w100 ">职务</td>
                        <td colspan="3"><input type="text" maxlength="180" class="w254" name="job" value="<% entity.write("job"); %>" /></td>
                    </tr>
                    
                    <tr>                     
                        <td class="dce w100 ">分工</td>
                          <td colspan="3"><input type="text" maxlength="255" class="b95" name="branch" value="<% entity.write("branch"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">主任头像</td>
