                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <!--<td releasumclassifys="<% // entity.write("classifyid"); %>"></td>-->
                         <td releasumclassifys="<% out.print("风景信息"); %>"></td>
                    </tr>
                    <tr>
                            ...
                            <%
                                ...
                                if (!entity.get("ico").isEmpty()) {
                                    ...
                                    for (int idx = 0; idx < str1.length; idx++) {
                                        arry1[idx] = str1[idx];
                            %>
                            <input style="font-size:15px;font-weight: bold;line-height:34px; " readonly="true" class="xz" value="<%  entity.write("ico"); %>"/><a href="/upfile/<% out.print(arry1[idx]); %>" style="cursor: pointer;color:blue;font-weight: bold;">点击查看</a>
                            <%
                                    }
                                }
                            %>
