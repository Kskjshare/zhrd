            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" maxlength="80" class="b99" name="realname" value="<% entity.write("realname"); %>" /></td>
                    </tr>
                     <tr>
                        <td class="dce w100 ">职位</td>
                        <td colspan="3"><input type="text" maxlength="80" class="b99" name="job" value="<% entity.write("job"); %>" /></td>
                    </tr>
...
//                    return false;
//                }
//                if ($("[name='job']").val() == undefined || $("[name='job']").val() == "") {
//                    alert("请填写职务");
//                    $("[name='job']").focus();
//                    return false;
//                }
