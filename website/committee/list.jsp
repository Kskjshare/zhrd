    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "user_committee");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("realname like '%" + URLDecoder.decode(list.get("realname"), "utf-8") + "%'").get_page_desc("shijian");
        ...
        <script>
             $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/committee/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 648, height: 480});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
             ...
             popuplayer.display("/website/committee/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/committee/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 648, height: 480});
                })
            });
