                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and classifyid=13").get_page_desc("id");
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td releasumclassify="<% out.print(list.get("organize")); %>"></td>
        ...
        <script>
            ...
            ﻿$(".delete").click(function(){
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/bulletin/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 830, height: 380});
                })
            });
