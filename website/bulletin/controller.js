transadapter["append"] = function (t)
{
    ...
    popuplayer.display("/website/bulletin/edit.jsp?&TB_iframe=true", '添加', {width: 830, height: 550});
}
...
transadapter["delete"] = function (t)
{
    ...
    rid = tid.join(",");
    popuplayer.display("/website/bulletin/delete.jsp?relationid=" + rid + "&TB_iframe=true", '删除', {width: 800, height: 400});
}

transadapter["quicksearch"] = function (t)
{
    popuplayer.display("/website/bulletin/quicksearch.jsp", '快速查询', {width: 500, height: 200});
}
