...
<!--                    <tr>
                    ...
                    <tr style="display: none;">
                        ...
                        <td><select class="b99 classify" name="classifyid" dict-select="releasumclassify" def="3"></select></td>
                    </tr>
                    <tr>
                        <td class="dce w100">会议分类</td>
                        <td><select class="b99" name="meetid" dict-select="releasummeetid"  def="<% entity.write("meetid"); %>"></select></td>
