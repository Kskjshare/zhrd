transadapter["append"] = function (t)
{
    ...
    popuplayer.display("/website/proposal/edit.jsp?&TB_iframe=true", '新增', {width: 960, height: 720 });
}
...
//    popuplayer.display("/website/parbugov/edit.jsp?id=" + rid + "&TB_iframe=true", '编辑', {width: 800, height: 550});
 var tid = []
    ...
    popuplayer.display("/website/proposal/edit.jsp?id=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 960, height: 720});
}
...
transadapter["delete"] = function (t)
{
    ...
    rid = tid.join(",");
    popuplayer.display("/website/proposal/delete.jsp?relationid=" + rid + "&TB_iframe=true", '删除', {width: 300, height: 80});
}

transadapter["quicksearch"] = function (t)
{
    popuplayer.display("/website/proposal/quicksearch.jsp", '快速查询', {width: 500, height: 200});
}
