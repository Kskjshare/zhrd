...
<!--                    <tr>
                    ...
                    <tr style="display: none;">
                        ...
                        <td><select class="w250 classify" name="classifyid" dict-select="releasumclassifys" def="2"></select></td>
                    </tr>
                    <tr>
...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="w250 Wdate" name="shijian"  rssdate="<% out.print(entity.get("shijian")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly"></td>
