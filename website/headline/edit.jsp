...
<%
    ...
    RssList entity = new RssList(pageContext, "imagin_news");
...
//                entity.timestamp();
                ...
                break;
            case "update":
//                RssList entity1 = new RssList(pageContext, "imagin_news");
//                entity1.request();
//                entity1.select().where("id=?", req.get("id")).get_first_rows();
//
//                entity1.remove("relationid");
//                entity1.remove("matter");
//                entity1.keyvalue("matter",entity.get("matter"));
//                entity1.keyvalue("title",entity.get("title"));
//                entity1.keyvalue("ico",entity.get("ico"));
//                
//                entity1.update().where("id=?", req.get("id")).submit();
...
<!--                    <tr>
                    ...
                    <tr><td class="dce w100 ">新闻图片</td>
                      ...
                      <tr>
                        ...
                        <td ><input type="text" maxlength="80" class="b99" name="origin" value="<% entity.write("origin"); %>" /></td>
                    </tr>
