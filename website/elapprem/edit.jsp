...
<!--                    <tr>
                    ...
                    <tr style="display: none;">
                        ...
                        <td><select class="w250 classify" name="classifyid" dict-select="releasumclassifys" def="10"></select></td>
                    </tr>
                    <tr>
                     ...
                     <tr>
                        ...
                        <td colspan="3"><input type="text" maxlength="80" class="w250" name="origin" value="<% entity.write("origin"); %>" /></td>
                     </tr>
                    ...
                    <tr>
                        <td class="dce w100 " colspan="4"><script ueditor="toolbars: [['fullscreen','undo','redo','|','bold','italic','underline','fontborder','strikethrough','superscript','subscript','removeformat','formatmatch','autotypeset','pasteplain','|','forecolor','backcolor','insertorderedlist','insertunorderedlist','|','rowspacingtop','rowspacingbottom','lineheight','|','fontfamily','fontsize','|','justifyleft','justifycenter','justifyright','justifyjustify','indent','|','link','unlink','anchor','|','imagenone','imageleft','imageright','imagecenter','|','insertimage','emotion','spechars','insertvideo']],initialFrameHeight:400" id="matter" name="matter" style="width:100%;"  type="text/plain"><% entity.write("matter"); %></script></td>
                    </tr>
