...
<%
    ...
    RssList entity = new RssList(pageContext, "deputy_member");
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        <td colspan="4" class="institle dce">代表信息</td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">姓名<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="nickname" value="<% entity.write("nickname"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">代表层次<em class="red">*</em></td>
                        <td><select class="w250" name="worktitle" dict-select="delegatetype" def="<% entity.write("worktitle"); %>"></select></td>
                        
                        <td class="dce w100 ">代表团<em class="red">*</em></td>
                        <td><select class="w250" name="delegation" dict-select="delegation" def="<% entity.write("delegation"); %>"></select></td>
<!--                        <td class="dce w100 ">职务</td>
                        <td colspan="3"><input type="text" maxlength="180" class="w254" name="job" value="<% entity.write("job"); %>" /></td>-->
                    </tr>
                    
                    <tr>
                        <td class="dce w100 ">职务<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="180" class="b95" name="job" value="<% entity.write("job"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">代表头像</td>
        ...
        <script>
            $(".footer>button").click(function () {
                if ($("[name='nickname']").val() == undefined || $("[name='nickname']").val() == "") {
                    alert("请填写姓名");
                    $("[name='nickname']").focus();
                    return false;
                }
