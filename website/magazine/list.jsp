        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "magazine");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and classifyid=19").get_page_desc("id");
...
<!--                            <td releasumclassify="<% 
        ...
        <script>
              $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 830, height: 460});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/magazine/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 830, height: 480});
                })
            });
