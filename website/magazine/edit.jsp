...
<%
    ...
    RssList entity = new RssList(pageContext, "magazine");
...
<!--                    <tr>
                    ...
                    <td colspan="3">
                            ...
                            <div style="display: none;"><span id="fjfile2" rid="2" style="color:blue;font-size:16px;font-family: 微软雅黑;font-weight: bold;">点击选择杂志</span>
                                <input type="hidden" id="enclosure2" ></div>
                            <div style="display: none;"><span id="fjfile3" rid="3" style="color:blue;font-size:16px;font-family: 微软雅黑;font-weight: bold;">点击选择杂志</span>
                                <input type="hidden"id="enclosure3" ></div>
                        </td>
                     </tr>
                    
                    <tr style="display: none;" type="hidden">
                        <td class="dce w100 ">分类<em class="red">*</em></td>
                        <td><select class="w250 classify" name="classifyid" dict-select="releasumclassifys" def="19"></select></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">是否发布</td>
                        <td><select class="w250" name="state" dict-select="releasumstate" def="<% entity.write("state"); %>"></select></td>
                        
<!--                        <td class="dce w100 mettcls">分类</td>
                        <td class="mettcls"><select class="w250" name="publiclassifyid" dict-select="publiclassifyid" def="<% entity.write("publiclassifyid"); %>"></select></td>         -->
                    </tr>
<!--                    <tr>
                    ...
                    <tr>
                        <td class="dce w100 " colspan="4"><script ueditor="toolbars: [['fullscreen','undo','redo','|','bold','italic','underline','fontborder','strikethrough','superscript','subscript','removeformat','formatmatch','autotypeset','pasteplain','|','forecolor','backcolor','insertorderedlist','insertunorderedlist','|','rowspacingtop','rowspacingbottom','lineheight','|','fontfamily','fontsize','|','justifyleft','justifycenter','justifyright','justifyjustify','indent','|','link','unlink','anchor','|','imagenone','imageleft','imageright','imagecenter','|','insertimage','emotion','spechars','insertvideo']],initialFrameHeight:200" id="matter" name="matter" style="width:100%;"  type="text/plain"><% entity.write("matter"); %></script></td>
                    </tr>
            ...
            $("#filee").change(function () {
                ...
                return false;
                           ...
                           function PreviewImage(fileObj, imgPreviewId, divPreviewId) {
                                var allowExtention = ".jpg,.bmp,.gif,.png,.pdf,.doc,.docx"; //�����ϴ��ļ��ĺ�׺��document.getElementById("hfAllowPicSuffix").value;
