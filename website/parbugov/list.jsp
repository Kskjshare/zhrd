                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and classifyid=11").get_page_desc("id");
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
        ...
        <script>
              $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 960, height: 820});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/parbugov/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 960, height: 820});
                })
            });
