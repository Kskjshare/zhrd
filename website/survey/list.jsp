        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "pcsurvey");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td releasumclassify="<% out.print(list.get("matter")); %>"></td>
        ...
        <script>
           $(function(){
            ...
            ﻿$(".delete").click(function(){
             ...
             popuplayer.display("/website/survey/delete_1.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/website/survey/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 1248, height: 740});
                })
            });
        </script>
