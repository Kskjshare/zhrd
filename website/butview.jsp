        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w120 dce">分类</td>
                        <td colspan="3"><% 
                             if ( entity.get("classifyid").equals( "14" ) ) {
                                if ( entity.get("publiclassifyid").equals( "1" ) ) {
                                    
                                out.print("报告");
                                }
                                else if ( entity.get("publiclassifyid").equals( "2" ) ) {
                                    
                                out.print("预算公开");
                                }
                                else if ( entity.get("publiclassifyid").equals( "3" ) ) {
                                    
                                out.print("预算调整");
                                }
                                else if ( entity.get("publiclassifyid").equals( "4" ) ) {
...
//                            entity.write("classifyid"); 
                              if ( entity.get("classifyid").equals( "1" ) ) {
                                    
                                out.print("人大要闻");
                                }
                                else if ( entity.get("classifyid").equals( "2" ) ) {
                                    
                                out.print("通知公告");
                                }
                                else if ( entity.get("classifyid").equals( "4" ) ) {
                                    
                                out.print("立法工作");
                                }
                                else if ( entity.get("classifyid").equals( "5" ) ) {
                                    
                                out.print("乡镇人大");
                                }
                                else if ( entity.get("classifyid").equals( "6" ) ) {
                                    
                                out.print("监督工作");
                                }
                                else if ( entity.get("classifyid").equals( "7" ) ) {
                    ...
                    <!--<tr><td class="w120 dce">附件</td><td colspan="3"><a href="/upfile/<% entity.write("enclosure");%>" alt=""/><% entity.write("enclosurename");%></a></td></tr>-->
                    <tr>
                        <td class="w120 dce">发布时间</td><td colspan="3"  rssdate="<% out.print(entity.get("shijian")); %>,yyyy-MM-dd hh:mm:ss"></td>
                    </tr>
                    <!--<tr><td class="w120 dce">来源</td><td colspan="3"><% out.print(entity.get("source"));%></td></tr>-->
                    <tr>
                        <td colspan="4" class="marginauto uetd">
                            <ul><li class="sel">内容</li></ul>
                            <div class="iframe"><p><iframe src="butview_matter.jsp?id=<% out.print(entity.get("id"));%>"></iframe></p></div>
                        </td>
                    </tr>
                </table>
            </div>
