...
<%@page import="RssEasy.MySql.User.UserClassifyList"%>
<%@page import="RssEasy.Core.PoPupHelper"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%
    request.setCharacterEncoding("utf-8");
    StaffList.IsLogin(request, response);
    UserClassifyList entity = new UserClassifyList(pageContext);
                    ...
                    <tr>
                        <td class="w200">
                            <div class="h480 hscol">
                                ...
                                <ul levelhelper="userclassify" key="pid" dict-offset="1" class="lanmubankuai"></ul>
                            </div>
                        </td>
                        <td>
                            <table class="wp100 cellbor">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="name" name="name" class="w100" value="<% entity.write("name"); %>" maxlength="50" /><label for="mingcheng"></label>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
