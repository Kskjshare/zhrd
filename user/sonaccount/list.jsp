                ...
                <table class="wp100 tc cellbor">
                    ...
                    <tbody>
                        <%
                            ...
                            list.request();
                            list.select("myid,account,realname,avatar,nickname,sex,shijian,recharge,withdraw,frozencapital,classifyid,balance").where("parentid="+UserList.MyID(request)+" and myid!="+UserList.MyID(request)).get_page_desc("myid");
                            while (list.for_in_rows()) {
                                String usertype = "";
                                switch (list.get("classifyid")) {
                                    case "1":
                                        usertype = "普通用户";
                                        break;
                                    case "2":
                        ...
                        <tr>
                            ...
                            <td><% out.print(list.get("balance")); %></td>
