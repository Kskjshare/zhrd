...
//                } else 
                    ...
                    if (time > pwdshijian) { 
                        ...
                        try {
                            ...
                            staff.login();
                            response.sendRedirect("/index.jsp#uid:top13,sid:top13menutop1notice");
                        } catch (Exception ex) {
...
<html>
    ...
    <body style="text-align: center;">
        ...
        <div style="width: 444px; height: 527px; background-image:url(LoginPage/images/dlk.png);background-size:100% 100%; text-align:center;position:absolute; left:50%; margin-left:-222px; top:50%; margin-top:-263px;">
            <form  method="post" id="trylogin">
                ...
                <img src="LoginPage/images/yhm-30-lanse.png"  style="margin-top: 40px;" />
                ...
                <img src="LoginPage/images/mm-30-lanse.png"  style="margin-top: 20px;" />
               ...
               <select style="display: none;" name="powergroupid" dict-select="powergroup"><option value="0">默认角色</option></select>
                <img id="login" src="LoginPage/images/trylogin.png" style="margin-top: 10px;" />
