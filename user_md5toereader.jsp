...
//            window.location.href = "http://42.193.106.246/ereader/login.jsp?verify=<% out.print(sMd5); %>&username=<% list.write("account");%>&ip=42.193.106.246";
            window.location.href = "http://117.158.113.36:9003/ereader/login.jsp?verify=<% out.print(sMd5); %>&username=<% list.write("account");%>&ip=117.158.113.36";
