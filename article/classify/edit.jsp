...
<%
    ...
    RssClassifyList entity = new RssClassifyList(pageContext,"article");
...
<html>
    ...
    <body>
                    ...
                    <tr>
                        <td class="w200">
                            <div class="h480 hscol">
                                ...
                                <ul levelhelper="articleclassify" key="pid" def="<% entity.write("pid"); %>" offset="1" class="lanmubankuai"></ul>
                            </div>
                        </td>
                        <td>
        ...
        <script src="/data/article.js" type="text/javascript"></script>
