...
<body style="background-size: 100% 100%;background-attachment: fixed; margin: 0;padding: 0;width: 100%;height: 100%;">
    ...
    height: 404px;
    background-image: url(LoginPage/images/dlk.png);
    ...
    margin-top: -110px;">
        <form method="post" id="trylogin" style="min-width:100px; min-height:80px;">
            ...
            <input name="__RequestVerificationToken" type="hidden"
                value="jT5z0Ku5xqeh9NuHdjif9clSnTQTzsOoMWeHk9quKOajVdx2mVMofyLKiAq7VL2LJQcjqLSranersSdS3WKDYTQLpgJuDXNEU8inroTjlucvc_NLX75ncC1kKDNM9Pmj2m1ZU2sq2lLyl7IKyVCFWs9kWRqnCJuz48Fe2kKe7o41" />
            <img src="LoginPage/images/logo.png" style="margin-top: 60px;" />
            ...
            <img src="LoginPage/images/yhm-30-lanse.png" style="margin-top: -11px;" />
            <input type="text" placeholder="输入账号" id="account" name="account"
                value="<% out.print(req.get("account")); %>" style="width:252px;
                       height: 36px; line-height: 36px; font-size: 16px; border: 0px; background: rgba(0, 0, 0, 0); background-color:rgba(0, 0, 0, 0) !important;
                       outline: none; position: relative; top: -40px;left:20px; " />


            <img src="LoginPage/images/mm-30-lanse.png" style="margin-top: -16px;" />
            <input type="password" placeholder="输入密码" id="pwd" name="pwd" value="<% out.print(req.get("pwd"));%>" style="width:252px;
                       height: 36px; line-height: 36px; font-size: 16px; border: 0px; background: rgba(0, 0, 0, 0);
                       outline: none; position: relative;top: -40px; left:20px;" />



            <img src="LoginPage/images/mm-30-1anse.png"
                style="width: 174px;position: relative;top: -16px;left: -63px" />
            <div style="height:44px; position: absolute;left: 80px;margin-top:-30px;">
                <input name="numbercodepre" type="text" placeholder="输入验证码"
                    style="width: 129px;height: 40px;position: relative;top: -44px;left: 21px;border: none; background: rgba(0, 0, 0, 0);font-size: 16px;" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <img id="imgnumber" src="/number.jsp" style="width: 105px;
    height: 40px;
    position: relative;
    left: -19px;
    top: -28px;" />
            </div>
            <select style="display: none;" name="powergroupid" dict-select="powergroup">
                <option value="0">默认角色</option>
            </select>
            <!--<img id="login" src="LoginPage/images/trylogin.png" style="width: 295px;display: block;position: relative;left: 58px;height: 39px;top: 11px;" />-->
            <button type="submit" style='width: 297px;
    display: block;
    background-color: rgb(222,1,16);
    color: #fff;
    height: 40px;
    position: relative;
    left: 56px;
    font-size: 16px;
    font-weight: 600;'>登 录</button>
            <input type="hidden" name="action" value="login" />

        </form>
        <div id="code"><span><img src="css/limg/DowloadApp.png" alt=""></span></div>
        <!--<div id="footerBox">-->
        ...
        <!--            <div id="footer">
            <p style="font-size:14px;color:#BE2229;margin-top:48%;">版权所有©汝州市人大常委会办办公室</p>
            </div>-->
