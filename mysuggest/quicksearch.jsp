...
<tr>
        ...
        <script>
            ...
            $(".footer>[query]").click(function () {
                parent.quicksearch("/mysuggest/list.jsp?lwid="+formfun("lwid")+"&realid="+formfun("realid")+"&title="+formfun("title")+"&matter="+formfun("matter")+"&reviewclass="+formfun("reviewclass")+"&methoded="+formfun("methoded")+"&realname="+formfun("realname"))
                popuplayer.close();
            })
