        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="auto tablechuang">
                    <tr>
                        <td colspan="4" class="backdce blue">确定承办单位情况</td>
                    </tr>
                    <tr>
                        <td class="w100 tdd">提出者：</td>
                        <td id="ullist"><input type="text" readonly="readonly" class="input w500" name="fenlei"/>
                            <div>
                                <table><thead><tr><th>编号</th><th>姓名</th><th>职务</th><th></th></tr></thead>
                                    <tbody>
                                        <%
                    ...
                    <tr><td colspan="4" class="td"><a class="submission">确定</a></td></tr>
                </table>
            </div>
        </form>
...
//            })
                ...
                RssWin.open("/selectwin/selectoneuser.jsp?state=2", 400, 500);
            });
