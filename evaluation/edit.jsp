...
<%
    ...
    if (!entity1.get("action").isEmpty()) {
        ...
        entity1.update().where("id="+opinion.get("id")).submit();
        PoPupHelper.adapter(out).iframereload();
        PoPupHelper.adapter(out).showSucceed();
    }
    opinion.select().where("opinionid="+opinion.get("id")).get_first_rows();
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <form method="post" class="popupwrap">
            <div>
                <table class="wp120 cellbor">
                    ...
                    <tr><td colspan="10" class="dce">议案(建议)标题</td><td colspan="10"> <% out.print(opinion.get("title"));%><span id="titlecode">编号： <% out.print(opinion.get("realid"));%></span></td></tr>
                    <tr><td colspan="10" class="dce">主办单位</td><td colspan="10"><span id="cbdw" rid="<%  out.print( opinion.get("companyid")); %>"><%  out.print( opinion.get("allname")); %></span><input type="hidden" name="companyid" value="<%  out.print( opinion.get("companyid")); %>"></td></tr>
                    <tr><td colspan="10" class="dce">您是否收到答复函</td><td colspan="10"><select class="w206" name="reply" dict-select="state" def="<%  out.print( opinion.get("reply")); %>"></select></td></tr>
                    <tr><td colspan="10" class="dce">收到时间</td><td colspan="10"><input type="text" class="w200 Wdate" name="replyshijian"  rssdate="<% out.print(opinion.get("replyshijian")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly"></td></tr>
                    ...
                    <tr>
                        ...
                        <td colspan="10"><textarea name="opinion"><% opinion.write("opinion");%></textarea></td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="10" class="startlist">
                            ...
                            <input type="number" name="business" class="inline-range-val" value="<% out.print(opinion.get("business"));%>"/>分
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="10" class="startlist">
                            <em name="business"><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a></em>
                            <input type="number" class='inline-range-val' name="initiative" value="<% out.print(opinion.get("initiative"));%>"/>分
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="10" class="startlist">
                            <em name="business"><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a></em>
                            <input type="number" class='inline-range-val' name="communication" value="<% out.print(opinion.get("communication"));%>"/>分
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="10" class="startlist">
                            <em name="business"><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a></em>
                            <input type="number" class='inline-range-val' name="counter" value="<% out.print(opinion.get("counter"));%>"/>分
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="10" class="startlist">
                            <em name="business"><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a></em>
                            <input type="number" class='inline-range-val' name="consensus" value="<% out.print(opinion.get("consensus"));%>"/>分
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="10" class="startlist">
                            <em name="business"><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a><a></a></em>
                            <input type="number" class='inline-range-val' name="evaluate" value="<% out.print(opinion.get("evaluate"));%>"/>分
                        </td>
                    </tr>
                </table>
            </div>
            <div class="footer">
                <input type="hidden" name="effect" value="<% opinion.write("effect");%>">
                <input type="hidden" name="allscore" value="<% opinion.write("allscore");%>">
...
//                });
//            }
           var effectval =  parseInt($("input[name='effect']").val());
             $("#effect").find("label").eq(effectval-1).click();
