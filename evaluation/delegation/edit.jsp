            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td class="dce w150 ">结果评定：</td>
                        <td><select class="w260" name="result" dict-select="effect" def="<% entity.write("result"); %>"></select>
                    </tr>
                    <tr>
