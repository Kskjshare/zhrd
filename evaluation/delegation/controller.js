...
{
    popuplayer.display("/evaluation/delegation/append_1.jsp?id=" + transadapter.id + "&TB_iframe=true", '评分', {width: 630, height: 200});

}
//﻿transadapter["append"] = function (t)
//{
//    popuplayer.display("/evaluation/delegation/edit.jsp?TB_iframe=true", '"新增', {width: 790, height: 500});
//}
...
//        return false;
//    }
//    popuplayer.display("/evaluation/delegation/edit.jsp?id=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 790, height: 580});
//}
//transadapter["delete"] = function (t)
//{
//    var tid=[],rid="";
...
//    });
//    rid=tid.join(",");
//    popuplayer.display("/evaluation/delegation/delete.jsp?id=" +rid + "&TB_iframe=true", '删除', {width: 300, height: 80});
//}
//transadapter["apd"] = function (t)
//{
//    popuplayer.display("/evaluation/delegation/apd.jsp", '导入', {width: 550, height: 200});
//}