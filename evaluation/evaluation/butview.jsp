        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w120 dce">单位名称</td><td colspan="3" class="w261"><% entity.write("company"); %></td></tr>
                    ...
                    <tr><td class="w120 dce">电子邮箱</td><td  colspan="3" class="w261"><% entity.write("email"); %></td></tr>
                </table>
                <div id="middletitle" style="display:none;">工作人员</div>
                <table id="section" style="display:none;">
