    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        <td class="dce w150 ">被测评单位：<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="companyname" value="<% entity.write("companyname"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w150 ">测评内容：<em class="red">*</em></td>
                        <td colspan="3"><textarea type="text"  class="b95" name="content"><% entity.write("content"); %></textarea></td>
                    </tr>
                    <tr>
                        <td class="dce w150 ">参加测评代表(人数)：<em class="red">*</em></td>
                    ...
                    <tr>
                        <!--   <td class="dce w150 ">测评档次：</td>
                        <td><select class="w260" name="grade" dict-select="effect" def="<% entity.write("grade"); %>"></select>-->
                        <td class="dce w150 ">结果评定：<em class="red">*</em></td>
                        <td colspan="3"><select class="w260" name="result" dict-select="effect" def="<% entity.write("result"); %>"></select>
                    </tr>
                    <tr>
        ...
        <script>
            $(".footer>button").click(function () {
                if ($("[name='companyname']").val() == undefined || $("[name='companyname']").val() == "") {
                    alert("请填写被评测单位");
                    $("[name='companyname']").focus();
                    return false;
                }
                if ($("[name='content']").val() == undefined || $("[name='content']").val() == "") {
                    alert("请填写评测内容");
                    $("[name='content']").focus();
                    return false;
                }
                if ($("[name='peoplenumber']").val() == undefined || $("[name='peoplenumber']").val() == "") {
                    alert("请填写参加评测人数");
                    $("[name='peoplenumber']").focus();
                    return false;
                }
