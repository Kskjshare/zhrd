...
<%
    ...
    RssList entity2 = new RssList(pageContext, "suggest_clue");
    RssListView entity = new RssListView(pageContext, "suggest_clue");
    entity.request();
    entity2.request();
            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td><select class="w200" name="classify" dict-select="clueclassify" def="<% entity.write ("classify"); %>"></select></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">是否发布：</td>
                        <td><select class="w200" name="state" dict-select="noticestate" def="<% entity.write ("state"); %>"></select></td>
                    ...
                    <tr>
                        <td class="dce w100 " colspan="4"><script ueditor="toolbars: [['fullscreen','undo','redo','|','bold','italic','underline','fontborder','strikethrough','superscript','subscript','removeformat','formatmatch','autotypeset','pasteplain','|','forecolor','backcolor','insertorderedlist','insertunorderedlist','|','rowspacingtop','rowspacingbottom','lineheight','|','fontfamily','fontsize','|','justifyleft','justifycenter','justifyright','justifyjustify','indent','|','link','unlink','anchor','|','imagenone','imageleft','imageright','imagecenter','|','insertimage','emotion','spechars','insertvideo']],initialFrameHeight:200" id="matter" name="matter" class="w750" type="text/plain"><% out.print(entity.get("matter")); %></script></td>
                    </tr>
                 <tr class="thismyid">
                        <td class="tr">作者ID：</td>
