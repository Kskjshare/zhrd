...
<%
    ...
    RssList entity1 = new RssList(pageContext, "suggest_clue");
    entity.request();
            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td clueclassify="<% entity.write("classify"); %>"></td>
                    </tr>
                    <tr>
                    ...
                    <tr><td colspan="4" id="matter"><div> <% out.print(entity.get("matter"));%></div></td></td>
                    </tr>
                    <!--                 <tr class="thismyid">
                                            <td class="tr">作者ID：</td>
