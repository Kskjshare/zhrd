    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <!--<tr><td class="dce">分类：</td><td><select name="infotype" dict-select="infotype"></select></td></tr>-->
                    <tr><td class="dce">是否发布：</td><td><select name="state" dict-select="noticestate"></select></td></tr>
                    <tr><td class="dce">提交者：</td><td><input name="realname"></td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str ="/suggest/clue/list.jsp?title="+formfun("title")+"&&state="+formfun("state")+"&realname="+formfun("realname")
