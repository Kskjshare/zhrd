...
<html>
    <head>
        ...
        <style>
             .w206{width: 99%; height:40px;}
             .w200{width: 99%; height:40px;}
        </style>
    </head>
    <body>
...
//                var str = "/suggest/list.jsp?lwid=" + formfun("lwid") + "&realid=" + formfun("realid") + "&title=" + formfun("title") + "&realcompanyname=" + formfun("realcompanyname") + "&allname=" + formfun("allname") + "&methoded=" + formfun("methoded") + "&realname=" + formfun("realname")、
                var str = "/suggest/list.jsp?lwid=" + formfun("lwid") + "&allname=" + formfun("allname") + "&title=" + formfun("title") + "&realcompanyname=" + formfun("realcompanyname") + "&telphone=" + formfun("telphone") + "&sessionid=" + formfun("sessionid") + "&realname=" + formfun("realname") + "&year=" + formfun("year")+ "&meetingnum=" + formfun("meetingnum");
