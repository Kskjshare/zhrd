...
<!--                            <th   class="handle no">办理情况</th>-->
                            ...
                            <th class="realcompanyname no">重点建议</th>
                            <!--zyx增加重点建议列-->
                                <%
                                } else {
                                %>
                            <th style="width: 200px;" class="realcompanyname no">主办单位</th>
                            <th class="importance">重点建议</th>
                                <%
                                    }
                                %>
                            ...
                            switch (powerid) {
                                case "5":    //代表//环节1                           
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" +
                                            ...
                                            URLDecoder.decode(req.get("meetingnum"), "utf-8") + "%' and lwstate=1 and draft=2 and myid=" + cookie.Get("myid");
                                    break;
...
//                                    }
                                    keywhere += 
                                            ...
                                            "%' and lwstate=1 and draft=2 and isysw=21";
                                    break;
                                case "22": //代表团(审查)
                                    ...
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + //---------------
                                            ...
                                            "%' and year like '%" + URLDecoder.decode(req.get("year"), "utf-8") + 
                                            "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + 
                                            "%' and lwstate=1 and draft=2 and mission=" + cookie.Get("myid");
//                                                                               "%' and draft=2 " ;
...
//                                    System.out.println("11111111111111111111"+keywhere);
                                ...
                                case "8": //选联委(审查)或人代委  ding:议审委
                                    ...
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" + 
                                            ...
                                            "%' and lwstate=1 and draft=2 and  isysw=0";
                                    ...
                                    break;
                                case "25": // 乡镇人大主席团 乡镇(审查)//环节3/在flowtype为1代表团初审时流程，乡镇层次支流程
                                    ...
                                    if ( meetingTime.equals("1") ) {
                                        keywhere += " and examination= 2" ;//ding change 2--> 5  2021.3.31 
                                    }
...
//                                            "%' and lwid like '%" + URLDecoder.decode(req.get("lwid"), "utf-8") + 
                                   //added by ding 汝州项目督察局只能审批市级代表，所以加一个level条件查找记录  
                                    ...
                                    keywhere += 
                                            ...
                                            "%' and realid like '%" + URLDecoder.decode(req.get("realid"), "utf-8") + 
                                            "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + 
                                            "%' and lwstate=1 and draft=2 and examination =2";
...
//                                    }
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" + URLDecoder.decode(req.get("title"), "utf-8") +
                                            "%' and methoded like '%" + URLDecoder.decode(req.get("methoded"), "utf-8") + "%' and realcompanyname like '%" + URLDecoder.decode(req.get("realcompanyname"), "utf-8") 
                                            ...
                                            + "%' and realid like '%" + URLDecoder.decode(req.get("realid"), "utf-8") + "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") 
                                            + "%' and lwstate=1 and draft=2 and deal =1 and companyid=" + cookie.Get("myid"); 
...
//                            System.out.println("keywhere::"+keywhere);
                        ...
                        <tr ondblclick="ck_dbdmlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                           ...
                           <td><% out.print(list.get("realid")); %>
                            -->
                              
                           <td  style="font-size:14px;" class="title no" ><% out.print(list.get("title")); %>
                              <%
...
<!--                        zyx 当建议为重点议案时编号后增加红色*点缀。        --></td>
                            ...
                            <td style="font-size:14px;" ><% out.print(list.get("realname")); %></td>
                            <td style="font-size:14px;" ><% out.print(list.get("numpeople")); %></td>
                            <td style="font-size:14px;" class="lwstate no" lwstate="<% list.write("lwstate"); %>"></td>
                            <td style="font-size:14px;" class="permission no" judgment="<% list.write("permission"); %>"></td>
                            <td style="font-size:14px;" class="seconded no" seconded="<% list.write("seconded"); %>"></td>
                            <td style="font-size:14px;" class="opinioned no" opinioned="<% list.write("opinioned"); %>"></td>
                            <td style="font-size:14px;" class="meet no" judgment="<% list.write("meet"); %>"></td>
                            <td style="font-size:14px;" class="methoded no" methoded="<% list.write("methoded"); %>"></td>
                            <td style="font-size:14px;" class="shijian no" registertype="<% list.write("registertype"); %>"></td>
                            <td style="font-size:14px;" class="registertype no" registertype="<% list.write("registertype"); %>"></td>
                            <td style="font-size:14px;" class="reviewclass no" companytypeeclassify="<% list.write("reviewclass"); %>"></td>
                            <!--<td class="handle no">-->
                                <% //examination:    审查状态 1:未审查,2:已审查,3:置回,5:待审查,6:乡镇已审查
                                  ...
                                  if (list.get("handlestate").equals("3")) {
                                    ...
                                    //dyz patched 
                                    if ( list.get("workflow").equals("1") &&  (cookie.Get("powergroupid")).equals("22")  ){
                                        btnAuditShow = 0 ;
                                    }
                                %>
                                <!--</td>-->
...
//                                    out.print(companyname);
                                      out.print( list.get("realcompanyname") ) ;
                                %>
                            </td>
...
<!--                         <td class="w120 dce">审查意见</td>-->
<!--                         <td  class="realcompanyname no"> -->
                               
		            <%
                           String pid = cookie.Get("powergroupid");
                           
                            if  (pid != null && ("8").equals(pid)  ){
...
<!--                            zyx修改，当importance=1默认否，如果importance=2是就会点亮-->
                            ...
                            <td>
                                ...
                                <!--view-source:http://localhost:8084/examine/list_2.jsp?lwstate=1&examination=5&isdbtshenhe=1&iscs=1&draft=2-->
                                <!--view-source:http://localhost:8084/examine/list_2.jsp?lwstate=1&isdbtshenhe=1&examination=2&draft=2-->

		            <%
                            
                            if ( (pid != null && (("8").equals(pid) || ("7").equals(pid) || ("22").equals(pid) || ("7").equals(pid) || ("25").equals(pid) )) && ( btnAuditShow == 1 ) ){
                            %>
		            ...
		            <span class="ys shencha" style="font-weight:bold;" id="<% out.print(list.get("id")); %>">审查</span> | 
                            ...
                            <% 
                            if ( ("5").equals(pid) ||  ("7").equals(pid) ||  ("8").equals(pid)  ){
                            %> 
                            ...
                            if ( (pid != null && (  ("5").equals(pid) || ("8").equals(pid) || ("7").equals(pid) || ("22").equals(pid) || ("7").equals(pid) || ("25").equals(pid) ))){
                            %> 
        ...
        <script>
            ...
            $(function(){
                ﻿$(".chakan").click(function(){
                    ...
                    popuplayer.display("/suggest/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 1024, height: 660});
            ...
            $(function(){
                ﻿$(".bianji").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/suggest/editupdate.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 820, height: 560});
                })
            });
            $(function(){
            ﻿$(".delete").click(function(){
             ...
             popuplayer.display("/suggest/delete.jsp?id=" + id + "&TB_iframe=true&myid="+myid, '删除', {width: 360, height: 120});
            })
            });
            $(function(){
...
{
    popuplayer.display("/suggest/apd.jsp", '导入', {width: 550, height: 200});
}
