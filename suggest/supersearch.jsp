...
<html>
    <head>
        ...
        <style>
           ...
           .popupwrap{ -webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;}
            .popupwrap .popnav li{float: left;width: 118px;height: 28px;line-height: 28px;text-align: center;color: #fff;font-size: 12px;cursor: pointer;}
            ...
            .supersearch span{font-size: 12px;color: #186aa3;padding: 0 10px;cursor: pointer;}
    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <ul class="popnav"><li class="sel">基本信息</li><li>提出者信息</li><li>办理信息</li></ul>
