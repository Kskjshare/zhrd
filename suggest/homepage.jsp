...
<html>
    <head>
        ...
        <style>
            ...
            .rz{ 
                /*width: 100%;*/
                /*height: 79%;*/
                margin-left: 15px;display: flow-root;}
            .rizhi{position: absolute;
                   width: 247px;
                   left: 68%;
                   top: 63%;padding-bottom: 8px;display: inline-table;}
            p>em{color: red;font-size: large;}
            .rz span{font-size: 10px; float: left;}
            .red{color:red;}
    ...
    <body>
        <ul>
            ...
            <li powerid="200" bindclick="top11"><img src="../css/limg/homepage6.png" alt=""/><p>人大监督</p></li>
            <li powerid="287" bindclick="top15"><img src="../css/limg/homepage6.png" alt=""/><p>立法工作平台</p></li>
