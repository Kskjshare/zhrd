                ...
                <ol>
                    <li>
                        <table id="smalltab" class="cellbor">
                            <thead><tr><td class="w30"></td><td class="w30"><input type="checkbox" name="allreport"></td><td>序号</td><td>编号</td><td class="w300">标题</td><td></td></tr></thead>
                            <tbody>
                    ...
                    <li>
                        ...
                        <label><input type="radio" name="reporttype" url="companysat">单位满意度</label>
                        ...
                        <!--                        <label><input type="radio" name="reporttype">单位承办提案数量</label>
                                                <label><input type="radio" name="reporttype">交办单</label>
                                                <label><input type="radio" name="reporttype">交办单及提案原件</label>
                                                <label><input type="radio" name="reporttype">提案办复单</label>
                                                <label><input type="radio" name="reporttype">单位办复提案进度表</label>
                                                <label><input type="radio" name="reporttype">办复提案解决程度统计</label>-->
                    </li>
                </ol>
            </div>
            <div class="footer">
