...
//        suggest.request();
//        suggest.select().where("lwstate=1 and myid=" + req.get("myid") ).get_page_desc("id");
//        //领衔人
...
//        int a = 1;
//        list.pagesize = 30;
//        String keywhere ="lwstate=1 and draft=2 and id=" + req.get("id");
...
//        
        //需要验证一下
          ...
          newinformation.delete().where("relationid in(" + req.get("id") + ")").submit();
