    ...
    <body>
        <form method="post"  class="labelright nomargin" id="uesrupfile">           
            <div class="mainwrapassist notitletoolbar">
                <input type="file" name="img" id="file" multiple><a href="./suggest.xlsx">下载模板</a>
                <table class="wp100 cellbor">
                    <tr><td>届次</td><td>会议次数</td><td>层次</td><td>标题</td><td>领衔代表姓名</td><td>联名人人</td><td>内容</td><td>审查分类</td></tr>  
...
//                        console.log(a);
                    ...
                    if (state == "2") {
                        ...
                        $("#abc>h1").text(ts);
                        if (err != "no") {
                            $("#abc tbody").append("<tr><td>届次</td><td>会议次数</td><tr>")
                ...
                $("#uesrupfile").ajaxSubmit({
                    ...
                    success: function (json) {
                        $.get("/suggest/excel.jsp", {'n': json.url}, function (e) {
                            var a = JSON.parse(e);
