    ...
    <body>
        ...
        <script>
            ...
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/suggest/sessionManager/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 380, height: 180});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/suggest/sessionManager/edit.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 640, height: 240});
                })
            });
