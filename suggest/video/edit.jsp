...
<%
    ...
    RssVideoList entity = new RssVideoList(pageContext, "suggest");
    entity.request();
            ...
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        ...
                        <td><input type="text" maxlength="20" class="w500" name="title" value="<% entity.write("title"); %>" /><label>最多20个字符</label></td>
                    </tr>         
                    <tr>
                        <td class="tr">节次：</td>
                        <td>
