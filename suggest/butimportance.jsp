        ...
        <form method="post" class="popupwrap">
            <div class="infowrap">
                <table class="wp120 cellbor">
                    <tr><td colspan="4" id="tabheader">建议信息</td></tr>
                    ...
                    <tr><td class="w120 dce">重点建议</td><td><select class="w206" name="importance" dict-select="importance" def="<% list.write("importance"); %>"></select></td><td class="w120 dce">督办领导</td><td>
