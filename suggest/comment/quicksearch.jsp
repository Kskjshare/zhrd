    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="dce">分类</td><td><select name="reviewclass" dict-select="reviewclass"><option></option></select></td></tr>
                    <tr><td class="dce">领衔代表</td><td><input name="realname"></td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str ="/suggest/comment/list.jsp?title="+formfun("title")+"&&reviewclass="+formfun("reviewclass")+"&realname="+formfun("realname")
