...
<%
    ...
    RssList entity = new RssList(pageContext, "suggest_comment");
    entity.request();
    if (!entity.get("action").isEmpty()) {
        entity.remove("id");
        entity.keyvalue("suggestid",entity.get("id"));
        entity.timestamp();
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        <td colspan="4" class="institle dce">建议点评</td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">点评内容</td>
