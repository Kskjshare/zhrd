                    ...
                    <tbody>
                        <%
                            ...
                            if (powergroupid.equals("16")) {
                                sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and handle<>3 and handle<>4";
                            } else {
                                sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and handle<>3 and handle<>4 and gtdepar="+parentid+"";
                            }
