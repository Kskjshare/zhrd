                    ...
                    <tbody>
                        <%
                            ...
                            if (powergroupid.equals("16")) {
                                //sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and handle<>1 and handle<>2";
                                sql = "handle<>1 and handle<>2";
                            } else {
                                //sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and handle<>1 and handle<>2 and gtdepar="+parentid+"";
                                sql = "handle<>1 and handle<>2 and gtdepar="+parentid+"";
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td rssdate="<% out.print(list.get("procestime")); %>,yyyy-MM-dd"></td>
