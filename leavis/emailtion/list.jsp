    ...
    <body>
        <form method="post" id="mainwrap">
            <div class="toolbar">
                ...
                <!--<button type="button" transadapter="" class="butdelect">完善信息</button>-->
                    ...
                    <tbody>
                        <%
                            ...
                            if (powergroupid.equals("16")) {
                                //sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and petitionclassify=3 and handle is null";
                                sql = "petitionclassify=3 and handle is null";

                            } else {
                                //sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and petitionclassify=3 and handle is null and gtdepar="+parentid+"";
                                sql = "petitionclassify=3 and handle is null and gtdepar="+parentid+"";
                            }
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            %></td>
                           <td><span class="ys view" id= "<% out.print( list.get("id")); %>" style="color:blue;font-weight: bold;">查看内容</span>  
                            | <span class="ys export" id= "<% out.print(list.get("id")); %>" style="color:blue;font-weight: bold;">导出</span> 
          ...
          $(function(){
            ...
            $(function(){
                ﻿$(".export").click(function(){
                    let id = $(this).attr("id");
                    location.href = "/leavis/emailtion/companylist.jsp?relationid=" + id;
                })
            });    
            ...
            $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/leavis/emailtion/delete.jsp?relationid=" + id + "&TB_iframe=true", '删除', {width: 360, height: 90});
                })
            });    
            ...
            $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/leavis/emailtion/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 1248, height: 740});
                })
            });    
        </script>
    </body>
