                    ...
                    <tbody>
                        <%
                            ...
                            if (powergroupid.equals("16")) {
                                sql = "title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and handle=8";
                            } else {
                                sql = "title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and handle=8 and gtdepar="+parentid+"";
                            }
