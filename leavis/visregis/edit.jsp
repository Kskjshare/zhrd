...
<!--                    <tr>
                        <td colspan="4" class="institle dce">来访登记</td>
                    </tr>-->
                    <tr>
                        <td class="dce w100 ">来访主题<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b99" name="title" value="<% entity.write("title"); %>" /></td>
                    </tr>
                    <tr>
                        <!--<td class="dce w100 ">信访编号<em class="red">*</em></td>-->
                        <!--<td><input type="text" maxlength="80" class="b99" name="petition" value="<% entity.write("petition"); %>" /></td>-->
                        <td class="dce w100 ">性别</td>
                        <td  colspan="3"><select class="b99 classify" name="sex" dict-select="sex" def="<% entity.write("sex"); %>"></select></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">姓名<em class="red">*</em></td>
                        <td><input type="text" maxlength="80" class="b99" name="petitioner" value="<% entity.write("petitioner"); %>" /></td>
                        <td class="dce w100 ">身份证号</td>
                        <td><input type="text" maxlength="80" class="b99" name="idcard" value="<% entity.write("idcard"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">涉及人数<em class="red">*</em></td>
                        <td><input type="text" maxlength="80" class="b99" name="numpeinv" value="<% entity.write("numpeinv"); %>" /></td>
                        <td class="dce w100 ">住址<em class="red">*</em></td>
                        <td><input type="text" maxlength="80" class="b99" name="addr" value="<% entity.write("addr"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">接谈人</td>
                        <td><input type="text" maxlength="80" class="b99" name="reciever" value="<% entity.write("reciever"); %>" /></td>
                        <td class="dce w100 ">来访日期</td>
                        <td><input type="text" class="b99 Wdate" name="datapetition"  rssdate="<% out.print(entity.get("datapetition")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly"></td>
                    </tr>
                    <tr style="display: none;">
                        <td class="dce w100 ">信访形式<em class="red">*</em></td>
                        <td><select class="b99 classify" name="petitionclassify" dict-select="petitionclassify" def="2"></select></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">信访原因<em class="red">*</em></td>
                        <td><select class="b99" name="reapetition" dict-select="reapetitionclassify" def="<% entity.write("reapetition"); %>"></select></td>
                        <td class="dce w100 ">问题属地</td>
                        <td><input type="text" maxlength="80" class="b99" name="problemter" value="<% entity.write("problemter"); %>" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="dce w100 " colspan="4"><script ueditor="toolbars: [['fullscreen','undo','redo','|','bold','italic','underline','fontborder','strikethrough','superscript','subscript','removeformat','formatmatch','autotypeset','pasteplain','|','forecolor','backcolor','insertorderedlist','insertunorderedlist','|','rowspacingtop','rowspacingbottom','lineheight','|','fontfamily','fontsize','|','justifyleft','justifycenter','justifyright','justifyjustify','indent','|','link','unlink','anchor','|','imagenone','imageleft','imageright','imagecenter','|','insertimage','emotion','spechars','insertvideo']],initialFrameHeight:440" id="matter" name="matter" class="w960" type="text/plain"><% entity.write("matter"); %></script></td>
                    </tr>
