                    ...
                    <tbody>
                        <%
                            ...
                            if (powergroupid.equals("16")) {
                                sql = "title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and type=1 and handle is null";
                            } else {
                                sql = "title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and type=1 and handle is null and gtdepar="+parentid+"";
                            }
                            //list.select().where("petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and type=1 and handle is null").get_page_desc("id");

                            list.select().where( "type=1 and handle is null").get_page_desc("id");
          ...
          $(function(){
            ...
            $(function(){
                ﻿$(".export").click(function(){
                    let id = $(this).attr("id");
                    location.href = "/leavis/letregtion/companylist.jsp?relationid=" + id;
                })
            });    
            ...
            $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/leavis/letregtion/delete.jsp?relationid=" + id + "&TB_iframe=true", '删除', {width: 360, height: 90});
                })
            });    
            ...
            $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                    popuplayer.display("/leavis/letregtion/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 1248, height: 740});
                })
            });    
        </script>
