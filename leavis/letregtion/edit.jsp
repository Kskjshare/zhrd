...
<!--                    <tr>
                ...
                <!--//         <td class="dce w100 ">信访件编号<em class="red">*</em></td>-->
                        ...
                        <td colspan="3"><select class="w630" name="sex" dict-select="sex" def="<% entity.write("sex"); %>"></select></td>
                    </tr>
                    <tr>
                    ...
                    <tr style="display: none;">
                        ...
                        <td><select class="w630 classify" name="petitionclassify" dict-select="petitionclassify" def="1"></select></td>
                    </tr>
                    <tr>
