    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td>信访编号</td>
                        <!--<td><input class="w200" name="petition"></td>-->
                        <td colspan="3"><input type="text" maxlength="80" class="b99" name="petition" ></td>
        ...
        <script>
            ...
            $(".footer>[query]").click(function () {
                var str = "/leavis/dohaovsup/list.jsp?petition=" + formfun("petition");
