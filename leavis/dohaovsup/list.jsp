    ...
    <body>
        <form method="post" id="mainwrap">
            <div class="toolbar">
                ...
                <!--<button type="button" transadapter="" class="butdelect">接收</button>-->
                    ...
                    <tbody>
                        <%
                            ...
                            if (powergroupid.equals("16")) {
                                //sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and petitionclassify=4 and handle is null";
                                sql = "petitionclassify=4 and handle is null";
                            } else {
                                //sql = "petition like '%" + URLDecoder.decode(list.get("petition"), "utf-8") + "%' and petitionclassify=4 and handle is null and gtdepar="+parentid+"";
                                sql = "petitionclassify=4 and handle is null and gtdepar="+parentid+"";
                            }
            ...
            $(function(){
              ...
              $(function(){
                  ﻿$(".export").click(function(){
                      let id = $(this).attr("id");
                      location.href = "/leavis/dohaovsup/companylist.jsp?relationid=" + id;
                  })
              });    
              ...
              $(function(){
                  ﻿$(".delete").click(function(){
                      let id = $(this).attr("id");
                      popuplayer.display("/leavis/dohaovsup/delete.jsp?relationid=" + id + "&TB_iframe=true", '删除', {width: 360, height: 90});
                  })
              });    
              ...
              $(function(){
                  ﻿$(".edit").click(function(){
                      let id = $(this).attr("id");
                      popuplayer.display("/leavis/dohaovsup/edit.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 1248, height: 740});
                  })
            });    
        </script>
    </body>
