...
<!--                    <tr>
             ...
             <!--//            <td class="dce w100 ">信访件编号<em class="red">*</em></td>-->
                        ...
                        <td colspan="3"><select class="w630 classify" name="sex" dict-select="sex" def="<% entity.write("sex"); %>"></select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="w630 Wdate" name="datapetition"  rssdate="<% out.print(entity.get("datapetition")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly"></td>
                    </tr>
                    <tr style="display: none;">
                        <td class="dce w100 ">信访形式<em class="red">*</em></td>
                        <td><select class="w630 classify" name="petitionclassify" dict-select="petitionclassify" def="4"></select></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">信访原因<em class="red">*</em></td>
                        <td><select class="w630" name="reapetition" dict-select="reapetitionclassify" def="<% entity.write("reapetition"); %>"></select></td>
