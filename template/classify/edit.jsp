...
<%
    ...
    RssClassifyList entity = new RssClassifyList(pageContext,"template");
                    ...
                    <tr>
                        <td class="w200">
                            <div class="h480 hscol">
                                ...
                                <ul levelhelper="templateclassify" key="pid" def="<% entity.write("pid"); %>" offset="1" class="lanmubankuai"></ul>
                            </div>
                        </td>
                        <td>
