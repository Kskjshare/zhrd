...
<html>
    ...
    <body>
		...
		if(cookie.Get("powergroupid").equals("23")){
			%>
			<script src="js/menudata1.js?v1.032"></script>
			<%
		}else{
		%>
...
//                                }
            ...
            $("#editindex").click(function () {
                ...
                if (Cookie.Get("powergroupid") == "5") {
                    jsp = jsp;
                }
                if (Cookie.Get("powergroupid") == "18") {
                    jsp = "/company/edit.jsp?relationid=";
                }
                if (Cookie.Get("powergroupid") == "22") {
                    jsp = "/delegation/edit.jsp?id=";
                }
                popuplayer.display(jsp + <%out.print(idd);%> + "&TB_iframe=true", '编辑信息', {width: 830, height: 300});
            })
