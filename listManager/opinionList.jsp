                ...
                <table class="wp100 tc cellbor" id="section">
                    <thead>
                        <tr>
                            ...
                            <th class="realcompanyname no">重点意见</th>
                            <!--zyx增加重点意见列-->
                                <%
                                } else {
                                %>
                            <th class="realcompanyname no">主办单位</th>
                            <th class="importance">重点意见</th>
                                <%
                                    }
                                %>
                            ...
                            switch (powerid) {
                                case "5":    //代表//环节1                           
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" +
                                            ...
                                            URLDecoder.decode(req.get("meetingnum"), "utf-8") + "%' and lwstate=4 and draft=2 and myid=" + cookie.Get("myid");
                                    break;
...
//                                            "%' and lwid like '%" + URLDecoder.decode(req.get("lwid"), "utf-8") + 
                                    ...
                                    keywhere += 
                                            ...
                                            "%' and lwstate=4 and draft=2 and isysw=21";
//                                    System.out.println("1------------------------------------" + keywhere);
                                ...
                                case "22": //代表团(审查)
                                    ...
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + //---------------
                                            ...
                                            "%' and year like '%" + URLDecoder.decode(req.get("year"), "utf-8") + 
                                            "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + 
                                            "%' and lwstate=4 and draft=2 and ismeet=1 and mission=" + cookie.Get("myid");
                                     }
                                     else {
                                           keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + //---------------
                                            "%' and title like '%" + URLDecoder.decode(req.get("title"), "utf-8") + //------------
                                            ...
                                            "%' and year like '%" + URLDecoder.decode(req.get("year"), "utf-8") + 
                                            "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + 
                                            "%' and lwstate=4 and draft=1 and ismeet=0 and mission=" + cookie.Get("myid");
                                     }
                                    //梁小竹注释
//                                    System.out.println("11111111111111111111"+keywhere);
                                ...
                                case "8": //选联委(审查)或人代委  ding:议审委
                                    ...
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" + 
                                            ...
                                            "%' and lwstate=4 and draft=2 and  isysw=0";
...
//                                            "%' and lwid like '%" + URLDecoder.decode(req.get("lwid"), "utf-8") + 
                                   //added by ding 汝州项目督察局只能审批市级代表，所以加一个level条件查找记录  
                                    ...
                                    keywhere += 
                                            ...
                                            "%' and realid like '%" + URLDecoder.decode(req.get("realid"), "utf-8") + 
                                            "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + 
                                            "%' and lwstate=4 and draft=2 and examination =2";
...
//                                        rid = cookie.Get("myid");
//                                    }
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" + URLDecoder.decode(req.get("title"), "utf-8") + "%' and methoded like '%" + URLDecoder.decode(req.get("methoded"), "utf-8") + "%' and realcompanyname like '%" + URLDecoder.decode(req.get("realcompanyname"), "utf-8") + "%' and lwid like '%" + URLDecoder.decode(req.get("lwid"), "utf-8") + "%' and importance like '%" + URLDecoder.decode(req.get("importance"), "utf-8") + "%' and ProposedBill like '%" + URLDecoder.decode(req.get("ProposedBill"), "utf-8") + "%' and year like '%" + URLDecoder.decode(req.get("year"), "utf-8") + "%' and realid like '%" + URLDecoder.decode(req.get("realid"), "utf-8") + "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + "%' and lwstate=4 and draft=2 and deal =1 and companyid=" + cookie.Get("myid");
                                    break;
                                default://commented by jackie
                                    keywhere = "realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" + URLDecoder.decode(req.get("title"), "utf-8") + "%' and methoded like '%" + URLDecoder.decode(req.get("methoded"), "utf-8") + "%' and realcompanyname like '%" + URLDecoder.decode(req.get("realcompanyname"), "utf-8") + "%' and lwid like '%" + URLDecoder.decode(req.get("lwid"), "utf-8") + "%' and importance like '%" + URLDecoder.decode(req.get("importance"), "utf-8") + "%' and allname like '%" + URLDecoder.decode(req.get("allname"), "utf-8") + "%' and sessionid like '%" + URLDecoder.decode(req.get("sessionid"), "utf-8") + "%' and telphone like '%" + URLDecoder.decode(req.get("telphone"), "utf-8") + "%' and realid like '%" + URLDecoder.decode(req.get("realid"), "utf-8") + "%' and ProposedBill like '%" + URLDecoder.decode(req.get("ProposedBill"), "utf-8") + "%' and year like '%" + URLDecoder.decode(req.get("year"), "utf-8") + "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + "%' and lwstate=4 and draft=2";
                                    break;
                            }
            ...
            $(function(){
             ...
             $(function(){
                ﻿$(".bianji").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/billlist/editupdate_2.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 832, height: 560});
                })
            });
             $(function(){
               ...
               popuplayer.display("/listManager/delete4.jsp?id=" + id + "&TB_iframe=true&myid" + myid , '删除', {width: 360, height: 100});
                })
            });
            $(function(){
...
{
    popuplayer.display("/listManager/quicksearch_1.jsp", '快速查询', {width: 500, height:100});
}
//zyx重点
                            $(".shi").click(function () {
                            let id = $(this).attr("id");
