                    ...
                    <thead>
                        <tr>
                           ...
                           <%
                            ...
                            <th class="realcompanyname no">重点记录</th>
                            <!--zyx增加重点记录列-->
                                <%
                                } else {
                                %>
                            <th class="realcompanyname no">主办单位</th>
                            <th class="importance">重点记录</th>
                                <%
                                    }
                                %>
...
<!--                            zyx修改，当importance=1默认否，如果importance=2是就会点亮-->        
		            ...
		            <%
                            ...
                            if ( (pid != null && (("8").equals(pid)  || ("22").equals(pid) || ("25").equals(pid) )) && ( btnAuditShow == 1 ) ){
                            %>
		            ...
		            <span class="ys shencha" style="font-weight:bold;" id="<% out.print(list.get("id")); %>">审查</span> | 
                            ...
                            <%   
                            if( pid != null && ("8".equals( pid ) || ("7").equals( pid ) || ("22").equals( pid ) || ("25").equals( pid ) )){
                            %>
                            |<span class="ys delete" style="font-weight:bold;" id="<% out.print(list.get("id")); %>">删除</span> 
                            <%
                            }
                            %>
                            ...
                            <%
                            String pid1 = cookie.Get("powergroupid");
                            if ( pid1 != null && (("5").equals( pid )  )){
                             %>
                              | <span class="ys liucheng" style="font-weight:bold;" id="<% out.print(list.get("id")); %>">测评</span>   
                            <%
                            }
                            %>
            ...
            $(function(){
             ...
             $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
               popuplayer.display("/billlist/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
                })
            });
            $(function(){
