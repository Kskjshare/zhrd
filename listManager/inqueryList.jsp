                ...
                <table class="wp100 tc cellbor" id="section">
                    <thead>
                        <tr>
                            ...
                            <th class="realcompanyname no">重点质询</th>
                            <!--zyx增加重点质询列-->
                                <%
                                } else {
                                %>
                            <th class="realcompanyname no">主办单位</th>
                            <th class="importance">重点质询</th>
                                <%
                                    }
                                %>
        ...
        <script>
            ...
            $(function(){
                ﻿$(".bianji").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/billlist/editupdate_3.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 832, height: 560});
                })
            });
             $(function(){
               ...
               popuplayer.display("/listManager/delete5.jsp?id=" + id + "&TB_iframe=true&myid="+myid, '删除', {width: 360, height: 100});
                })
            });
            $(function(){
