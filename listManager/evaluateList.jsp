...
<%
    ...
    //permission.select().where(sql).get_page_desc("shijian");
    ...
    if ( swtich.equals("0")) {
      ...
      warningText = warningText +  permission.get("title");
...
//                                    }
                            ...
                            %>
                             ...
                             | <span class="ys handleQulity" style="font-weight:bold;" id="<% out.print(list.get("id")); %>">办理质量</span> 
                             <%
                           }                          
                            %>
                            ...
                            %>
                             ...
                             | <span class="ys suggestQulity" style="font-weight:bold;" id="<% out.print(list.get("id")); %>">建议质量</span> 
                             <%
                           }                          
                            %>
        ...
        <script>
            ...
            $(function(){
                ﻿$(".suggestQulity").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/opinion/suggestQulity.jsp?id=" + id + "&TB_iframe=true", '建议质量', {width: 830, height:280});
