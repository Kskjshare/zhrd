    ...
    function echart2() {
        ...
        var myChart2 = echarts.init(document.getElementById('main2'));
           ...
           var datasss =[ 
              {name:"涉法涉诉",value:13},
              {name:"生活待遇",value:5},
              {name:"山林土地权属纠纷",value:23},
              {name:"拆迁补偿和住房保障",value:50},  
              {name:"劳动和社会保障",value:40},
              {name:"安全、生产和环境保护",value:10},
              {name:"行政执法和行业服务",value:30},
              {name:"城市建设和管理",value:10},
              {name:"其他",value:20},
            ]
...
//        icon: 'circle',
        ...
        top: '20%',
        // bottom: 0,
        data: ['涉法涉诉', '生活待遇', '山林土地权属纠纷', '拆迁补偿和住房保障', '劳动和社会保障', '安全、生产和环境保护', '行政执法和行业服务', '城市建设和管理', '其他']
    },
    ...
    function echart_businessAccepted( dataAccepted ) {
        var businessAccepted = echarts.init(document.getElementById('businessAccepted'));
        option = {
            backgroundColor: '#FFFFFF',
            title: {
                text: '业务受理统计',
...
//                    color: "#fff",
        ...
        businessAccepted.setOption(option);
        window.addEventListener("resize",function(){
            businessAccepted.resize();
        });
...
//            ],
    ...
    function businessHandleChart( businessHandle ) {
        
         console.log("____________ businessHandle =",businessHandle)

        var businessHandleChart = echarts.init(document.getElementById('businessHandle'));
        option = {
            backgroundColor: '#FFFFFF',
...
//                    color: "#fff"
        ...
        businessHandleChart.setOption(option);
        window.addEventListener("resize",function(){
            businessHandleChart.resize();
        });
