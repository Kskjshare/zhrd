...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <div id="suggesttype" style="display: none;">类&nbsp;&nbsp;&nbsp;别：<select name="lwstate"><option value="2">议案</option><option value="1">建议</option></select></div>
                <h1>人民代表大会代表议案、批评和意见</h1>
                <table class="wp100 cellbor"><%                    RssListView user = new RssListView(pageContext, "user_delegation");
                    user.request();
                    ...
                    <tr>
                        ...
                        <td colspan="2"><input style="font-size:16px;font-family: 微软雅黑" type="text" maxlength="80" class="w260" name="meetingnum" value="<% entity.write("meetingnum"); %>" /><label class="labtitle"></label></td>
                    ...
                    <tr>
                        <td>代表团</td><td id="parentname" colspan="3"><% user.write("delegationname"); %></td>
                        <td>议案编号</td><td id="parentname"><% user.write("realid"); %></td>
                    </tr>
                    <tr>
                        <td class="w150 dce">议案标题<em class="red">*</em></td>
                    ...
                    <tr><td>通讯地址</td><td colspan="3" id="homeaddress"><% user.write("daibiaoDWaddress"); %></td><td>邮政编号</td><td id="postcode"><% user.write("postcode"); %></td></tr>
                    ...
                    <tr>
                        ...
                        <td><b class="selectuser">添加议案附议人</b></td>
                    </tr>

                    <tr class="">
                        <td colspan="6" class="marginauto uetd">
                            <ul><li class="sel">议案内容</li></ul>
                    ...
                    <tr style="display: none;"><td rowspan="6">相关情况</td><td colspan="5" selradio>代表对公开此议案有关情况的意见<label><input type="radio" name="perm">同意全文公开</label><label><input type="radio" name="perm">仅同意公开标题</label><input type="hidden" name="permission"></td></tr>
                    <tr style="display: none;"><td colspan="5" selradio>此议案由代表通过调查研究形成<label><input type="radio" name="type1">专题调研</label><label><input type="radio" name="type1">座谈</label><label><input type="radio" name="type1">走访等其他形式</label><input type="hidden" name="sugformation"></td></tr>
                    ...
                    <tr style="display: none;"><td colspan="5" selbox>此议案请主办单位在工作中研究参考,不需要书面答复<input selbox type="checkbox" name="type4"><input type="hidden" name="written"></td></tr>
                    ...
                    <tr style="display: none;"><td>议案联系人</td><td colspan="4"><ul id="jylxr">
                                <%
                                    if (!entity.get("id").isEmpty()) {
                        ...
                        <td><b class="selectuser" >添加议案联系人</b></td></tr>
                    ...
                    <tr class="thismyid">
                        <td class="tr">作者ID：</td>
                        <td colspan="3"><input type="text" name="myid" style="" class="w50" value="<% entity.write("myid"); %>" selectuser=""/> <label>默认当前登陆用户ID：<% out.print(UserList.MyID(request)); %></label><input name="secound"><input name="contacts"><input name="scr"><input name="usercomp"><input name="numpeople"><input name="enclosure"></td>
                    </tr>   
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            ...
            $('.selectuser').click(function () {
                ...
                RssWin.onwinreceivemsg = function (dict) {
                    ...
                    $.each(dict, function (k, v) {
                        if ($("em[myid='" + v.myid + "']").length == "0") {
                            t.append("<li myid='" + v.myid + "'><em  style='display: inline;width: 21%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;border-left: 0px;'>" + v.realname + "</em><em style='inline block;width: 31.2%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;'>&nbsp;" + v.telphone + "</em><em style='display: inline;width: 32%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;'>&nbsp;" + v.daibiaoDWaddress + "</em><em style='display: inline;width: 11%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;'>&nbsp;" + v.code + "</em><em class='red'>删除</em></li>")
