...
<html>
    ...
    <body>
        <form method="post" id="mainwrap">
            <div class="toolbar">
                <!--<button type="button">test的<% out.print(cookie.Get("powergroupid"));%></button>-->
              ...
              <!--    <button type="button" transadapter="butreports" select="false" class="butreports" powerid="153">报表</button>-->
                <button type="button" transadapter="yareports" select="false" class="yareports" powerid="153">报表</button>
...
<!--                            <td><% out.print(list.get("allname")); %></td>
        ...
        <script>
                            ...
                            function listshow() {
                             ...
                             function yareportsshow() {
                                    <% 
                                     String str_powerid =cookie.Get("powergroupid");
                                     if(str_powerid.equals("8")){//如果是选联委权限则显示报表操作
                                    %>
                                        $(".yareports").show();     
                                    <% 
                                     }
