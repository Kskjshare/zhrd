...
<tr>
        ...
        <script>
            $(".footer>[query]").click(function () {
                 var str = "/billlist/list.jsp?lwid="+ formfun("lwid") + "&allname=" + formfun("allname") + "&title=" + formfun("title") + "&realcompanyname=" + formfun("realcompanyname") + "&telphone=" + formfun("telphone") + "&sessionid=" + formfun("sessionid") + "&realname=" + formfun("realname") + "&year=" + formfun("year")+ "&meetingnum=" + formfun("meetingnum");
