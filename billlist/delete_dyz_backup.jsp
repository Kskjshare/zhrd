...
<%
    ...
    if (req.get("action").equals("delete")) {
        ...
        suggest.request();
        suggest.select().where("lwstate=" + req.get("lwstate") + " and myid=" + req.get("myid") ).get_page_desc("id");
        //领衔人
...
//        int a = 1;
//        list.pagesize = 30;
//        String keywhere ="lwstate="+ req.get("lwstate") + " and draft=2 and id=" + req.get("id");
...
<html>
    ...
    <body>
        <form method="post" class="popupwrap">
            <div class="infowrap">
                删除后不可恢复，请谨慎操作？<%out.print(req.get("myid"));%>
            </div>
            <div class="footer">
