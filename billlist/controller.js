...
{
    popuplayer.display("/billlist/quicksearch.jsp", '快速查询', {width: 500, height: 100});
}
...
﻿transadapter["butview"] = function (t)
{
    ...
    popuplayer.display("/billlist/butview.jsp?id=" + transadapter.id + "&TB_iframe=true", '查看', {width: 850, height: 560});
}
...
function ck_dbaclclick() {
    ...
    $('tbody tr').dblclick(function () {
        ...
        popuplayer.display("/billlist/butview.jsp?id=" + $(this).attr('idd') + "&TB_iframe=true", '查看', {width: 850, height: 550});
    })
