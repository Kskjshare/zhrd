...
//    rank_sort_list.select().where("myid=" + req.get("myid") ).get_page_desc("id"); 
    ...
    if (req.get("action").equals("delete")) {
        ...
        //删除记录的时候，同时更新排行榜分值。由于出错，暂时注释。

//        //先读取记录，判断当前用户myid是否有领衔记录，用于下面的绩算
//        RssList suggest = new RssList(pageContext, "suggest");
//        suggest.request();
//        suggest.select().where("lwstate=2 and myid=" + req.get("myid") ).get_page_desc("id");
//        //领衔人
...
//          
//            int suggestcnt = 0 ;
//            if ( rank_sort_list.get("suggest") != null ) {                          
//                Integer.parseInt ( rank_sort_list.get("suggest") );
//                if ( suggestcnt > 0 ) {
//                   suggestcnt -- ;   
//                }
//            }
...
//            
//            int num = 0 ;
//            if ( rank_sort_list.get("num") != null ) {                  
//                Integer.parseInt ( rank_sort_list.get("num") );
//               
//                if ( num > 0 ) {
//                   num -- ;   
//                }
...
//        int a = 1;
//        list.pagesize = 30;
//        String keywhere ="lwstate=2 and draft=2 and id=" + req.get("id");
