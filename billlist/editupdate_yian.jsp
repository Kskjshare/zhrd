    ...
    if (!entity.get("action").isEmpty()) {
         ...
         switch (entity.get("action")) {
            ...
            case "update":
                 ...
                 //如果是置回状态，修改以后，回复到原始状态。代表团才可以审查
                if (entity.get("examination").equals("3")) {
...
-->
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <!--<td colspan="2"><input style="font-size:16px;font-family: 微软雅黑" type="text" class="w260" name="sessionid" value="<% entity.write("sessionid"); %>" /><label class="labtitle"></label></td>-->
                        ...
                        <!--<td colspan="2"><input style="font-size:16px;font-family: 微软雅黑" type="text" class="w99" name="meetingnum" value="<% entity.write("meetingnum"); %>" /><label class="labtitle"></label></td>-->
...
//            }
            ...
            $('.selectscr').click(function () {
                ...
                RssWin.onwinreceivemsg = function (dict) {
                    ...
                    $.each(dict, function (k, v) {
                        if ($("em[myid='" + v.myid + "']").length == "0") {
                            t.append("<li myid='" + v.myid + "'><em  style='display: inline;width:53.7%;height: 100%;float: left;border-top: 0px;border-right: 0px;border-left: 0px;'>" + v.realname + "</em><em style='float: right;margin-right:30%;font-size:16px;font-weight:bold;' class='red'>删除</em></li>")
