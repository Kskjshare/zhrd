    ...
    if (!entity.get("action").isEmpty()) {
        ...
        switch (entity.get("action")) {
            case "append":
                ...
                sort.select().where("type=2").get_page_desc("realid");;
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        <td colspan="4" class="institle dce ">【建议】涉密议案请采用其他方式提交。</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><select class="w206" name="methoded" dict-select="methoded" def="<% entity.write("methoded"); %>"></select></td><td class="w150 dce">上传附件：</td>
                    ...
                    <tr>
                        ...
                        <td class="backdce"><select class="w206" name="opinioned" dict-select="opinioned" def="<% entity.write("opinioned"); %>"></select></td>
                        <td class="w150 dce">建议主办单位：</td>
                        <td><input class="w200" type="text" name="organizer" value="<% entity.write("organizer"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="w150 dce">可否联名提出：</td>
                        <td class="backdce"><select class="w206" name="seconded" dict-select="seconded" def="<% entity.write("seconded"); %>"></select></td>
                    ...
                    <tr class="thismyid">
                        <td class="tr">作者ID：</td>
                        <td colspan="3"><input type="text" name="myid" class="w50" value="<% entity.write("myid"); %>" selectuser=""/><input name="lwstate" value="2"><input name="secound"><input name="numpeople"></td>
                    </tr>   
                </table>
            </div>
            <div class="footer">
