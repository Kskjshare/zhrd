<%-- 
    Document   : butimportance_2
    Created on : 2021-3-30, 7:57:32
    Author     : EDZ
--%>
        ...
        <form method="post" class="popupwrap">
            <div class="infowrap">
                <table class="wp120 cellbor">
                    <tr><td class="w120 dce">重点议案</td><td><select class="w206" name="importance" dict-select="importance" def="<% list.write("importance"); %>" value="2"></select></td></tr>
                </table>  
            </div>
        </form>
