...
<!--                                    <em style='display: inline;width: 33%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;'>
                                ...
                                <li  myid='<% out.print(secondlist.get("userid"));%>'>
                                    <% out.print(secondlist.get("realname"));%><em style="float: right;margin-right:30%;font-size:16px;font-weight:bold;color:blue;" >删除</em></li>
                                    <%
                                            }
                                        }
                                    %>
...
<!--                                zyx增加判断，当有附件时显示附件名称， 当没有附件市显示点击选择件。   -->
                                </span>
...
//            }
            ...
            $('.selectscr').click(function () {
                ...
                RssWin.onwinreceivemsg = function (dict) {
                    ...
                    $.each(dict, function (k, v) {
                        if ($("em[myid='" + v.myid + "']").length == "0") {
                            t.append("<li myid='" + v.myid + "'><em  style='display: inline;width:63.7%;height: 100%;float: left;border-top: 0px;border-right: 0px;border-left: 0px;'>" + v.realname + "</em><em style='float: right;margin-right:30%;font-size:16px;font-weight:bold;' class='red'>删除</em></li>")
