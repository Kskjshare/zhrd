...
<!--                    <tr>
                            ...
                            <%
                                ...
                                if (!entity.get("enclosure").isEmpty()) {
                                    ...
                                    for (int idx = 0; idx < str1.length; idx++) {
                                        arry2[idx] = str1[idx];
                            %>
                            <input style="font-size:15px;font-weight: bold;line-height:34px; background: whitesmoke" readonly="true" class="xz" value="<%  entity.write("enclosurename"); %>"/><a href="/upfile/<% out.print(arry2[idx]); %>" style="cursor: pointer;color:blue;font-weight: bold;">点击查看</a>
                            <%
                                    }
                                }
                            %>
                    ...
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">正文</td></tr>
