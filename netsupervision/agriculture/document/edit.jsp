        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                   <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">文档</td></tr>
                    <tr>
                        <td class="dce w100" style="font-size:15px;font-family: 微软雅黑">文件名称<em class="red">*</em></td>
                    ...
                    <tr>
                        <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">公告类型</td>                       
                       ...
                       <tr>
                        <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">等级</td>
                        
                        <td colspan="3"><select  style="width:99%;" name="level" dict-select="level" def="<% entity.write("level"); %>"></select></td> 
                        
                        
                        <td class="dce w100" style="font-size:15px;font-family: 微软雅黑" >推送单位<em class="red">*</em></td>
                      
                        <td colspan="5"><input style="font-size:15px;font-family: 微软雅黑;width:99%;" type="text" maxlength="100" class="w98" name="unitobj" value="<% entity.write("unitobj"); %>" /><label class="labtitle"></label></td>
