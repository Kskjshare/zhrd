    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "constituency_classify");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
        ...
        <script>
              ...
              $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/netsupervision/registration/constituency/butview.jsp?id=" + id + "&TB_iframe=true", '查看', {width: 560, height: 140});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/netsupervision/registration/constituency/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 320, height: 160});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/netsupervision/registration/constituency/edit.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 830, height: 160});
                })
            });
