            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td activitiestypeclassify="<% entity.write("buildingtype"); %>"></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">建筑面积</td>
                        <td><% entity.write("area"); %></td>
                    </tr>
                    
                    <tr>
                        <td class="dce w100 ">建筑层高</td>
                        <td><% entity.write("layer"); %></td>
                    </tr>
...
<!--                     <tr>
                    ...
                    <tr>
                        <td class="dce" style="width:110px;">申报日期</td>
...
<!--                    <tr>
                    ...
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">备注</td></tr>
