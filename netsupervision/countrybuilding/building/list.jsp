    ...
    <body>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            RssList list = new RssList(pageContext, "supervision_countrybuilding");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and type=0").get_page_desc("id");
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td><% out.print(list.get("buildingtype"));%></td>
                            <td><% out.print(list.get("area")); %></td>
                            <td><% out.print(list.get("layer")); %></td>
                            ...
                            <span class="ys edit" id="<% out.print(list.get("id")); %>" style="color:purple;font-weight: bold" >审批</span> | 
        ...
        <script>
              ...
              $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/netsupervision/countrybuilding/building/butview.jsp?id=" + id + "&TB_iframe=true", '查看', {width: 830, height: 440});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/netsupervision/countrybuilding/building/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 380, height: 180});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/netsupervision/countrybuilding/building/edit.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 860, height: 580});
                })
            });
