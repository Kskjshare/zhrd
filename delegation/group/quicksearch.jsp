    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td class="dce">小组名称：</td><td><input name="realname"></td></tr>
                    <tr><td class="dce">所属代表团：</td><td><input name="dbtallname"></td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/delegation/group/list.jsp?realname=" + formfun("realname") + "&allname=" + formfun("dbtallname")
