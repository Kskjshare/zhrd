    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td class="dce">编号：</td><td><input name="daibiaotuanCode"></td></tr>
                    <tr><td class="dce">登录账号：</td><td><input name="account"></td></tr>
                    <tr><td class="dce">代表团名称：</td><td><input name="allname"></td></tr>
                    <tr><td class="dce">联系方式：</td><td><input name="telphone"</td></tr>
                    <tr><td class="dce">联系地址：</td><td><input name="missionAddr"></td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/delegation/list.jsp?daibiaotuanCode=" + formfun("daibiaotuanCode") + "&account=" + formfun("account") +"&allname=" + formfun("allname") + "&missionAddr=" + formfun("missionAddr") + "&telphone=" + formfun("telphone")
