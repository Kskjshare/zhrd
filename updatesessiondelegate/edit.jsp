...
//                entity2.remove("userid");
                ...
                entity2.append().submit();
                  ...
                  //加到通知列表
                entity_newinformation.remove("username");
                ...
                entity_newinformation.keyvalue("title", entity2.get("title") );
                else
                entity_newinformation.keyvalue("title", entity2.get("notice") );
                
                entity_newinformation.keyvalue("matter", entity2.get("note") );   
                entity_newinformation.keyvalue("infotype",  1 );
                entity_newinformation.keyvalue("realname",userlist.get("realname"));

                entity_newinformation.keyvalue("myid", UserList.MyID(request));
                entity_newinformation.timestamp();
                entity_newinformation.keyvalue("relationid", entity2.autoid);

                entity_newinformation.append().submit();
                
                lzmessage.keyvalue("realid", entity_newinformation.autoid);
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        <td class="dce" style="width:120px;">活动地点</td>
...
<!--                    <tr>
                    ...
                    <tr class="dce beginshijian">
                        <td class="dce startimeCaption" style="width:110px;">开始时间</td>
...
//            $(".en //rollendtime").hide();
            ...
            $('input[name="enroll"]').click(function () {
                if ($(this).val() == 1) {
                    ...
                    //$(".beginshijian").hide()
                    //$(".finishshijian").hide();
                    $(".startimeCaption").text("报名开始日期");
                    $(".endtimeCaption").text("报名截止日期");
...
//                    $(".enrollstartime").hide();
                    ...
                    //$(".finishshijian").show();
                    //$(".beginshijian").show()
                    $(".startimeCaption").text("开始时间");
                    $(".endtimeCaption").text("结束时间");
