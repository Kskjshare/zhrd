...
﻿transadapter["edit"] = function (t)
{
    ...
    popuplayer.display("/drsuggest/edit.jsp?id=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 830, height: 550});
}
...
{
    popuplayer.display("/drsuggest/quicksearch.jsp", '快速查询', {width: 500, height: 400});
}
