...
{
    popuplayer.display("/drsuggest/quicksearch.jsp", '快速查询', {width: 500, height: 100});
}
transadapter["quicksearch1"] = function (t)
{
    popuplayer.display("/drsuggest/quicksearch_2.jsp", '快速查询', {width: 500, height: 100});
}
transadapter["quicksearch2"] = function (t)
{
    popuplayer.display("/drsuggest/quicksearch_3.jsp", '快速查询', {width: 500, height: 100});
}
transadapter["quicksearch3"] = function (t)
{
    popuplayer.display("/drsuggest/quicksearch_4.jsp", '快速查询', {width: 500, height: 100});
}
