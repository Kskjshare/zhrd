                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        <td colspan="4" class="marginauto uetd">
                            <ul><li class="sel">内容</li><li>提出者信息</li><li>建议办复信息</li><li>代表意见</li><li>操作日志记录</li></ul>
...
//                                                }
                                    %>
                                    <em>办复人：</em><b><% company.get("linkman"); %></b><br>
                                    <em>办复人电话：</em><span><% company.get("worktel"); %></span>
                                    <%
                                    } else {
                                    %>
