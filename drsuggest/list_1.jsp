                ...
                <table  class="wp100 tc cellbor" id="section">
                    <thead>
                        <tr>
                            ...
                            <!--<th class="w60">序号</th>
                            <th class="w60" style="font-size:16px;font-family: 微软雅黑">建议编号</th>
                            -->
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                             String keywhere ="realname like '%" + URLDecoder.decode(req.get("realname"), "utf-8") + "%' and title like '%" + URLDecoder.decode(req.get("title"), "utf-8") + "%' and methoded like '%" + URLDecoder.decode(req.get("methoded"), "utf-8") + "%' and organizer like '%" + URLDecoder.decode(req.get("organizer"), "utf-8") + "%' and lwid like '%" + URLDecoder.decode(req.get("lwid"), "utf-8") + "%' and importance like '%" + URLDecoder.decode(req.get("importance"), "utf-8") + "%' and realid like '%" + URLDecoder.decode(req.get("realid"), "utf-8") + "%' and meetingnum like '%" + URLDecoder.decode(req.get("meetingnum"), "utf-8") + "%' and examination=3 and lwstate=1 and draft=2 and myid=" + cookie.Get("myid");
...
//            zyx
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/drsuggest/editupdate.jsp?id=" + id , '编辑', {width: 830, height: 560});
                })
            });
             $(function(){
