...
//                var str = "/suggest/list.jsp?lwid=" + formfun("lwid") + "&realid=" + formfun("realid") + "&title=" + formfun("title") + "&realcompanyname=" + formfun("realcompanyname") + "&allname=" + formfun("allname") + "&methoded=" + formfun("methoded") + "&realname=" + formfun("realname")、
                var str = "/drsuggest/opionList.jsp?lwid=" + formfun("lwid") + "&allname=" + formfun("allname") + "&title=" + formfun("title") + "&realcompanyname=" + formfun("realcompanyname") + "&telphone=" + formfun("telphone") + "&sessionid=" + formfun("sessionid") + "&realname=" + formfun("realname") + "&year=" + formfun("year") + "&meetingnum=" + formfun("meetingnum");
