    ...
    if (!entity.get("action").isEmpty()) {
        ...
        switch (entity.get("action")) {
            case "append":
                ...
                break;
            case "update":
                String[] bb1 = entity.get("scr").split(",");
                ...
                for (int i = 0; i < bb1.length; i++) {
                    ...
                    read.keyvalue("objid", bb1[i]);
                    read.keyvalue("type", 1);
                    read.append().submit();
                }
                entity.keyvalue("examination", 1);
                entity.keyvalue("reviewopinion", 0);
...
<html>
    ...
    <body>
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr class="">
                        ...
                        <td colspan="4" class="marginauto uetd">
                            <ul><li class="sel">内容</li><li>提出者信息</li><li>附议代表</li></ul>
                    ...
                    <tr class="thismyid">
                        <td class="tr">作者ID：</td>
                        <td colspan="3"><input type="text" name="myid" class="w50" value="<% entity.write("myid"); %>" selectuser=""/> <label>默认当前登陆用户ID：<% out.print(UserList.MyID(request)); %></label><input name="secound"><input name="numpeople"><input name="scr"></td>
                    </tr>   
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            var comlist = [];
            <%
                RssListView all = new RssListView(pageContext, "user");
