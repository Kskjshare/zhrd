        ...
        <form method="post" id="mainwrap">
            <div class="toolbar">
                ...
                <ul wz="0">
                    ...
                    <li><label><input type="checkbox" name="field" sel="handle" checked="checked">办理方式</label></li>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            String keywhere = "title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and methoded like '%" + URLDecoder.decode(list.get("methoded"), "utf-8") + "%' and organizer like '%" + URLDecoder.decode(list.get("organizer"), "utf-8") + "%' and lwid like '%" + URLDecoder.decode(list.get("lwid"), "utf-8") + "%' and realid like '%" + URLDecoder.decode(list.get("realid"), "utf-8") + "%' and meetingnum like '%" + URLDecoder.decode(list.get("meetingnum"), "utf-8") + "%' and draft=1 and myid=" + UserList.MyID(request);
                        ...
                        <tr ondblclick="ck_dbAbvlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td class="handle no" handle="<% list.write("handle"); %>"></td>
