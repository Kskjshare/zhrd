...
<%
    ...
    if (!entity.get("action").isEmpty()) {
        ...
        switch (entity.get("action")) {
            case "append":
                entity.timestamp();
//                entity.keyvalue("draft", 2);//1 草稿，2提交
...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <div id="suggesttype" style="display: none;">类&nbsp;&nbsp;&nbsp;别：<select name="lwstate" class="lstate" dict-select="lwstate" def="<% entity.write("lwstate"); %>"></select> </div>
                <h1><%
                    if ( entity.get("lwstate").equals("1")){
                        out.print(" 人民代表大会代表建议");
                    }
                    if ( entity.get("lwstate").equals("2")){
                        out.print(" 人民代表大会代表议案");
                    }
                    if ( entity.get("lwstate").equals("3")){
                        out.print(" 人民代表大会代表批评");
                    }
                    if ( entity.get("lwstate").equals("4")){
                        out.print(" 人民代表大会代表意见");
                    }
                    if ( entity.get("lwstate").equals("5")){
                        out.print(" 人民代表大会代表质询");
                    }
                   %></h1>
