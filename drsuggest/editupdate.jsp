...
//                entity.keyvalue("draft", 2);//修改建议为已提交状态
            ...
            case "update":
                ...
                entity.keyvalue("isdbtshenhe", 2 );
                entity.keyvalue("permission", 0 );
                entity.keyvalue("examination", 1 );
                entity.keyvalue("iscs", 0 );
                entity.keyvalue("isysw", 0 );
                ...
                //更新通知
                newinformation.remove("sessionid");
                newinformation.remove("reviewopinion");
                newinformation.remove("reviewclass");
                newinformation.remove("meetingnum");
                newinformation.remove("permission");
                newinformation.remove("perm");
                newinformation.remove("sugformation");
                newinformation.remove("type1");
                newinformation.remove("type2");
                newinformation.remove("sugyears");
                newinformation.remove("communicate");
                newinformation.remove("written");
                newinformation.remove("seconded");
                newinformation.remove("lwstate");
                newinformation.remove("secound");
                newinformation.remove("contacts");
                newinformation.remove("usercomp");
                newinformation.remove("numpeople");
                newinformation.remove("fileName");
                newinformation.remove("level");
                newinformation.remove("ProposedBill");
                newinformation.remove("draft");
                newinformation.remove("scr");
                newinformation.remove("year");
                newinformation.remove("numpeople");
                newinformation.remove("numpeople");
                newinformation.remove("numpeople");

                newinformation.keyvalue("matter",entity.get("matter") );             
                newinformation.update().where("id="+newinformation.get("id")).submit();
    ...
    //enclosurename = entity.get("enclosurename");
    String[] arry = {"", "", ""};
    ...
    //消息列表
    //ewinformation.select().where("title like '%" + URLDecoder.decode(entity.get("title"), "utf-8") + %'").get_page_desc("id");
    newinformation.select().where("title like '%" + URLDecoder.decode(entity.get("title"), "utf-8") + "%'" ).get_first_rows();
    String aaa = newinformation.get("id");
...
-->
                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <!--<td colspan="2" style="font-size:16px;font-family: 微软雅黑"><select style="font-size:16px;font-family: 微软雅黑" type="text" maxlength="80" class="w260" name="meetingnum" dict-select="companytypeeeclassify" def="<% entity.write("meetingnum"); %>" ></select></td>-->
