...
<html>
    <head>
        ...
        <style>
            ...
            .zuo{margin-left: 32%;}/*张迎新修改*/
            .zuo1{margin-left: 30%;}/*张迎新修改*/
             .zuo2{margin-left: 10%;}/*张迎新修改*/
             span{margin-left: 28%;};/*张迎新修改*/
        </style>
    </head>
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w120 dce">编号</td><td class="w261"><% entity.write("realid"); %></td><td class="w120 dce">类型</td>
                    <td class="w261" lwstate="<% 
                    ...
                    <tr>
                        <td colspan="4" class="marginauto uetd">
                            <ul><li class="sel">内容</li><li>提出者信息</li><li>办理信息</li><li>代表评价</li><li>操作日志记录</li></ul>
                            ...
                            <div id="resumeinfo">
                                <h6>领衔代表意见说明</h6>
<!--                                <p class="yjsm">
                                    <b><% entity.write("realname"); %>：</b>
                                    <b effect="<% out.print(entity.get("effect")); %>"></b>
                                    ：&nbsp;&nbsp;&nbsp;<% entity.write("opinion");%>
                                </p>-->
                                    <table class="wp100 cellbor">
                                    <tbody>
...
//                                    comments.query("select * from suggestcomments_list_view where suggestid="+entity.get("id"));
                                ...
                                %>
<!--                                <p class="yjsm"><b><% comments.write("realname"); %>：</b>
                                    <b effect="<% out.print(comments.get("effect")); %>"></b>
