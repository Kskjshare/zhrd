    ...
    <body>
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/company/list.jsp?code="+formfun("code")+"&comtype="+formfun("comtype")+"&allname="+formfun("allname")+"&person="+formfun("person")+"&returnxt="+formfun("returnxt")+"&companysort="+formfun("companysort")+"&sessionid="+formfun("sessionid")
