...
<%
    ...
    RssList suggest1 = new RssList(pageContext, "suggest");
...
//        if (suggest1.select().where("myid=?", UserList.MyID(request)).get_first_rows()) {
        entity1.remove("id");
        ...
        String[] companyarry = entity1.get("companyidlist").split(",");
        for (int idx = 0; idx < companyarry.length; idx++) {
            entity1.keyvalue("companyid", companyarry[idx]);
