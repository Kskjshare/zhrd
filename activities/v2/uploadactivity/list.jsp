...
//            console.log(State,"vvv")
        ...
        <script>
            ...
            $(function(){
                ﻿$(".sign").click(function(){
                   let id = $(this).attr("id");
                   popuplayer.display("/activities/v2/uploadactivity/doattendance.jsp?id=" + id + "&TB_iframe=true", '签到', {width: 600, height: 450});
                })
            });  
             ...
             $(function(){
              ...
              $(function(){
                ﻿$(".view").click(function(){
                   let id = $(this).attr("id");
                  popuplayer.display("/activities/v2/uploadactivity/attendance.jsp?id=" + id+ "&TB_iframe=true", '履职人员', {width: 800, height:500});
                })
            });  
             ...
             $(function(){
                ﻿$(".delete").click(function(){
                   let id = $(this).attr("id");
                  popuplayer.display("/activities/v2/uploadactivity/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
                })
            });  
