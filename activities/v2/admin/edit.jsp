        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    %>
                    <tr>
                        <td class="dce w100 ">报名类型</td>
                        <td >
                            <input id="ziyuan" style="width:55px;height:16px;" name="enroll"  type="radio" value="1" >自愿报名
                           <input id="qiangzhi" style="width:55px;height:16px;"  name="enroll"  type="radio" value="2" checked="1">指定报名
                        </td>
                    </tr>
                    <tr class="baoming">
                        <td class="dce w100 ">报名人数</td>
                        <td><input  type="number" maxlength="80" class="w250" name="maxperson" value="<% entity.write("maxperson"); %>" /></td>
                    </tr>
                    <tr>
...
<!--                    <tr>
                        ...
                        <td   id="userrolesel">
                            <input class="w250" readonly="readonly" value="<% req.write("department"); %>"/>
                    ...
                    <tr>
                        <td class="dce w100" >活动类型</td>
                        <td><select style="width:91%;" name="classify" dict-select="activitiestypeclassify1" def="<%entity.write("classify"); %>"></select></td>
                    </tr>
                     
                    <tr>
                        <td class="dce w100" >组织单位</td>
                        <td><select style="width:91%;" name="department" dict-select="activitiesdepartment" def="<%entity.write("department"); %>"></select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <span id="fjfile" style="color:blue;font-weight: bold;"><% out.print(entity.get("enclosurename").isEmpty() ? "点击选择文件" : entity.get("enclosurename")); %></span>
        ...
        <script>
            ...
            %>
                            ...
                            $("#userrolesel>input").click(function () {
                                ...
                                RssWin.open("/activities/myactivities/selectuserrole_1.jsp", 700, 650);
                            });
        </script>
    </body>
</html>