        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    %>
                    <tr>
                       <td class="dce" style="width:110px;">报名开始日期</td>
                        ...
                        <td class="dce w100 ">报名状态</td>
                         ...
                         <% 
                            if ( cookie.Get("powergroupid").equals("5") ) {
                                ...
                                if ( entity.get("currentperson").equals( entity.get("maxperson") )) {
...
//                        entity2.select().where("activitiesid=?",entity.get("id") + " and attendancetype=1" ).query();
                        entity2.select().where("activitiesid=" + entity.get("id") + " and attendancetype=1" ). get_page_desc("id");
...
//                        entity3.select().where("activitiesid=?",entity.get("id")+" and attendancetype=0").query();
                        entity3.select().where("activitiesid=" + entity.get("id") + " and attendancetype=2" ). get_page_desc("id");
