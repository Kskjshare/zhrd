    ...
    <body>
            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="dce">乡镇街道：</td><td><input name="name3"></td></tr>
                            <%if (!(req.get("usertype").equals("")||req.get("usertype").equals("0"))) {%>
                    <tr><td class="dce">考核状态：</td><td><select name="state<%req.write("usertype");%>"> <option value=""></option><option value="0">待评</option><option value="1">已评</option></select></td></tr>
                    <%}%>
        ...
        <script>
            $(".footer>[query]").click(function () {
                parent.quicksearch("/activities/evaluation/evaluate/list.jsp?name1=" + formfun("name1") + "&name2=" + formfun("name1") + "&name3=" + formfun("name3") + "&state1=" + formfun("state1") + "&state2=" + formfun("state2") + "&state3=" + formfun("state3") + "&state4=" + formfun("state4"))
                popuplayer.close();
            })
