                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="department" value="<% out.print(list.get("company")); %>" realname="<% out.print(list.get("company")); %>" postcode="<% out.print(list.get("postcode")); %>" homeaddress="<% out.print(list.get("homeaddress")); %>"  /></td>
    ...
    <script type="text/javascript">
        $('.footer>button').click(function () {
            ...
            $("input[name='department']:checked").each(function () {
                e.push({"myid": $(this).attr("value"), "myname": $(this).parents("tr").find("td").eq(3).text()})
            })
            if (e.length == 0) {
                alert("请选择单位");
                return false;
