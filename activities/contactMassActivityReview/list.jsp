                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        ...
                        <%
                            ...
                            //开始获取realname满足的myid
                            if(list.get("inputname") != null && !list.get("inputname").equals("")){
                                RssList user1 = new RssList(pageContext, "user");
                                user1.select().where(" realname like '%" + URLDecoder.decode(list.get("inputname"),"utf-8") + "%'").get_page_asc("myid");
                                List<String> list11 = new ArrayList();
                                while (user1.for_in_rows()) {
//                                    if(user.get("myid") != null && !user.get("myid").equals("")){
                                        list11.add(user1.get("myid"));
...
//                            System.out.println(URLDecoder.decode(req.get("realname"),"utf-8") +"*");
                            if(list.get("rid") != null && !list.get("rid").equals("")){
//                                System.out.println(list.get("rid") + "***");
                                sql += " and state in (" + list.get("rid") + ")";
                            }
//                            System.out.println(list.get("rid") + "***");
...
//                                    html += "&nbsp;|&nbsp;<a style=' text-decoration: none;' href='javascript:flowStepRecord(\"" + list.get("id") + "\");'>日志</a>";
                            ...
                            <td>
                                <%
                                    html = "";
//                                    if (list.get("state").equals("1")) {//1为待审核，2为通过,3为未通过
//                                        html += "<a style='text-decoration: none;' href='javascript:closeDbLzhd("+list.get("id")+")'>审核</a>";              
////                                        html += "<a style='text-decoration: none;' href='javascript:closeDbLzhd("+list.get("id")+",2)'>驳回</a>";
////                                          html += "<a style=' text-decoration: none; color:#B0B0B0;' href='javascript:void(0);'>待审核</a>";
//                                    }
////                                    else if(list.get("state").equals("2")) {
////                                        html += "<a style=' text-decoration: none; color:#B0B0B0;' href='javascript:void(0);'>通过</a>";
////                                        html += "<a style=' text-decoration: none; color:#B0B0B0;' href='javascript:void(0);'>驳回</a>";
////                                    }
//                                    else{
//                                        html += "<a style=' text-decoration: none; color:#B0B0B0;' href='javascript:void(0);'>通过</a>&nbsp;&nbsp;&nbsp;&nbsp;";
//                                        html += "<a style=' text-decoration: none; color:#B0B0B0;' href='javascript:void(0);'>驳回</a>";
...
//                }
                popuplayer.display("/activities/contactMassActivityReview/close.jsp?id=" + id + "&TB_iframe=true", '联系群众活动审核', {width: 600, height: 330});
            }
        </script>
    </body>
</html>