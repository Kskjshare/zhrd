...
<%
    ...
    RssList entity = new RssList(pageContext, "legislative_project_library");
...
<!--                    <tr>
                        <td colspan="4" class="institle dce">添加立法项目</td>
                    </tr>-->
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id='adminsel'>
                            <input name="proposer" class="w200" readonly="readonly" value="<% user.write("realname"); %>">
                        </td>
                    </tr>

                    <tr>
                        <td class="dce w200 ">提出单位或代表团：<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="proposingunit" value="<% entity.write("proposingunit"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="dce w200 ">提出时间：<em class="red">*</em></td>
                        <td><input type="text" class="w200 Wdate" name="Proposaltime" value="<% out.print(entity.get("shijian")); %>"  onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly"></td>
                    </tr>
                    <tr>
                        <td class="dce w200 ">备注信息：<em class="red">*</em></td>
        ...
        <script>
            $(".footer>button").click(function () {
                ...
                if ($("[name='proposer']").val() == undefined || $("[name='proposer']").val() == "") {
                    alert("请填写提出人");
                    $("[name='proposer']").focus();
                    return false;
                }
                if ($("[name='proposingunit']").val() == undefined || $("[name='proposingunit']").val() == "") {
                    alert("请填写单位或代表团");
                    $("[name='proposingunit']").focus();
                    return false;
                }
                if ($("[name='Proposaltime']").val() == undefined || $("[name='Proposaltime']").val() == "") {
                    alert("请填写提出时间");
                    $("[name='Proposaltime']").focus();
                    return false;
                }
                if ($("[name='remarks']").val() == undefined || $("[name='remarks']").val() == "") {
                    alert("请填写备注信息");
                    $("[name='remarks']").focus();
                    return false;
                }
