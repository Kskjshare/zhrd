        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "legislative_project_library");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td>
                                <% out.print(list.get("proposer")); %>
                            </td>
                            <td><% out.print(list.get("proposingunit")); %></td>
                            <td ><% out.print(list.get("proposaltime")); %></td>
                            <td>
                                <%
