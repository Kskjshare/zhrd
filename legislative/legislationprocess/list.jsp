    ...
    <body>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and state=0").get_page_desc("id");
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <span class="ys audit"  id="<% out.print(list.get("id")); %>" style="color:red;font-weight: bold" >提请一审</span>                           
        ...
        <script>
            ...
            $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/legislative/legislationprocess/butview.jsp?id=" + id + "&TB_iframe=true", '查看', {width: 830, height: 440});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/legislative/legislationprocess/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 380, height: 180});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/legislative/legislationprocess/edit.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 860, height: 580});
                })
            });
             ...
             $(function(){
                ﻿$(".audit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/legislative/legislationprocess/auditview.jsp?id=" + id + "&TB_iframe=true", '提请一审' , {width: 830, height: 440});
                })
            });
