...
//                   out.print("<script>alert('update')</script>");
                ...
                break;
            default:
                   out.print("<script>alert('default:')</script>");
                break;
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                   <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">提请一审</td></tr>
                    <tr>
            ...
            <div class="footer">
                ...
                <!--
                <button style="float:left;" type="submit"  ><% out.print("否");%></button>
                --> 
                <button type="submit"><% out.print("是");%></button>
