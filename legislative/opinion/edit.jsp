...
<%
    ...
    RssList entity = new RssList(pageContext, "legislative_push");
    ...
    <body>
                ...
                <table class="wp100 cellbor">
                   <!--<tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">公告</td></tr>-->
                    ...
                    <tr>
                       ...
                       <tr>                     
                      <td class="dce w100" style="font-size:15px;font-family: 微软雅黑" >征集开始日期<em class="red">*</em>
                      </td>
                      
                      <td colspan="3" style="font-size:15px">
                        <input style="width:99%;" type="text" class="w200 Wdate" name="startshijian"  rssdate="<% out.print(entity.get("startshijian")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly">
                      </td>
                      
                    
                      <td class="dce w100" style="font-size:15px;font-family: 微软雅黑">征集结束日期<em class="red">*</em></td>
                       <td colspan="3" style="font-size:15px">
                        <input style="width:99%;" type="text" class="w200 Wdate" name="endshijian"  rssdate="<% out.print(entity.get("endshijian")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly">
                      </td>
        ...
        <script>
            $(".footer>button").click(function () {
             ...
             if ($("[name='startshijian']").val() != undefined && $("[name='startshijian']").val() != "") {
                    var timestamp = new Date($("[name='startshijian']").val());
                    $("[name='startshijian']").val(timestamp / 1000);
                }else {
                    alert("请选择开始日期");
                    $("[name='startshijian']").focus();
                    return false;
                }
                
                 if ($("[name='endshijian']").val() != undefined && $("[name='endshijian']").val() != "") {
                    var timestamp = new Date($("[name='endshijian']").val());
                    $("[name='endshijian']").val(timestamp / 1000);
                }else {
                    alert("请选择结束日期");
