    ...
    <body>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td rssdate="<% out.print(list.get("startshijian")); %>,yyyy-MM-dd" ></td>
                            <td rssdate="<% out.print(list.get("endshijian")); %>,yyyy-MM-dd" ></td>
                            <td><% out.print(list.get("participant")); %></td>         
                            <td>
                            <% 
                               String participant =  list.get("participant");
                                if ( !participant.equals("0") ) {              
                            %>
                            <span class="ys view" id="<% out.print(list.get("id")); %>" style="color:blue;font-weight: bold" >查看征集信息</span> | 
                            <%
                            }
                            %>    
        ...
        <script>
            ...
            $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
//                popuplayer.display("/legislative/notice/edit.jsp?id=" + id + "&TB_iframe=true", '查看征集信息', {width: 840, height: 560});
                })
            });
        </script>
