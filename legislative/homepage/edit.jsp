    ...
    <body>
        ...
        <form method="post" class="popupwrap">
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        <td colspan="4" class="institle dce">添加立法</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="dce w100 ">通过时间：<em class="red">*</em></td>
                        <td><input type="text" class="w200 Wdate" name="passingtime"  rssdate="<% entity.write("passingtime"); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly"></td>
                    </tr>
                    <tr>
                        <td class="dce w100 ">备注信息：<em class="red">*</em></td>
                        <td colspan="3"><input type="text" maxlength="80" class="b95" name="remarks" value="<% entity.write("remarks"); %>" /></td>
                    </tr>
                    <tr style="display:none">
                        <td class="dce w100 ">登录人id：<em class="red">*</em></td>
                        <td><input type="text" class="w200 Wdate" name="myid" value="<% out.print(UserList.MyID(request));%>"></td>
                    </tr>
        ...
        <script>
                            $(".footer>button").click(function () {
                                ...
                                if ($("[name='passingtime']").val() == undefined || $("[name='passingtime']").val() == "") {
                                    alert("请填写立法通过时间");
                                    $("[name='passingtime']").focus();
                                    return false;
                                }
