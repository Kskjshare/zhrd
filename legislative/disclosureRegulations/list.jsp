        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "disclosure_regulations");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td><% out.print(list.get("passtime")); %></td>
                            <td><% out.print(list.get("approvethetime")); %></td>
                            <td><% out.print(list.get("announcementtime")); %></td>
                            <td><% out.print(list.get("implementationtime")); %></td>
                            <td>
                                <%
                                    RssList user1 = new RssList(pageContext, "user");
                                    user1.select().where("myid=?", list.get("myid")).get_first_rows();
