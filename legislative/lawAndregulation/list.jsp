    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "legislative_lawandregulation");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td><% 
                                ...
                                if ( list.get("Effectivenesslevel").equals("1") ) {
                                  out.print( "法律" );   
                                }
                                else if ( list.get("Effectivenesslevel").equals("2") ) {
                                  out.print( "行政法规" );   
                                }
                                else if ( list.get("Effectivenesslevel").equals("3") ) {
                                  out.print( "规章" );   
                                }
                                else if ( list.get("Effectivenesslevel").equals("4") ) {
                                  out.print( "司法解释" );   
                                }
                                else if ( list.get("Effectivenesslevel").equals("5") ) {
                                  out.print( "司法指导性文件" );   
                                }
                                else if ( list.get("Effectivenesslevel").equals("6") ) {
                                  out.print( "部门规章" );   
                                }
                               
                            %></td>
                            <td><% 
                                if ( list.get("timeliness").equals("1") ) {
                                  out.print( "现行有效" );   
                                }
                                else if ( list.get("timeliness").equals("2") ) {
                                  out.print( "尚未生效" );   
                                }
                                else if ( list.get("timeliness").equals("3") ) {
                                  out.print( "部分有效" );   
                                }
                                else if ( list.get("timeliness").equals("4") ) {
                                  out.print( "已失效" );   
                                }
                            %></td>
        ...
        <script>
              ...
              $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/legislative/lawAndregulation/butview.jsp?id=" + id + "&TB_iframe=true", '查看', {width: 1248, height: 780});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/legislative/lawAndregulation/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 380, height: 180});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/legislative/lawAndregulation/editSpecialreport.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 1248, height: 780});
                })
            });
