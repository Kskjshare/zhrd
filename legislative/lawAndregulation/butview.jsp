            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td>
                        <%
                             if ( entity.get("Effectivenesslevel").equals("1") ) {
                                  out.print( "法律" );   
                                }
                                else if ( entity.get("Effectivenesslevel").equals("2") ) {
                                  out.print( "行政法规" );   
                                }
                                else if ( entity.get("Effectivenesslevel").equals("3") ) {
                                  out.print( "规章" );   
                                }
                                else if ( entity.get("Effectivenesslevel").equals("4") ) {
                                  out.print( "司法解释" );   
                                }
                                else if ( entity.get("Effectivenesslevel").equals("5") ) {
                                  out.print( "司法指导性文件" );   
                                }
                                else if ( entity.get("Effectivenesslevel").equals("6") ) {
                                  out.print( "部门规章" );   
                                }
                        %></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <%                          
                             if ( entity.get("timeliness").equals("1") ) {
                                  out.print( "现行有效" );   
                                }
                                else if ( entity.get("timeliness").equals("2") ) {
                                  out.print( "尚未生效" );   
                                }
                                else if ( entity.get("timeliness").equals("3") ) {
                                  out.print( "部分有效" );   
                                }
                                else if ( entity.get("timeliness").equals("4") ) {
                                  out.print( "已失效" );   
                                }    
                            %>
                        </td>
