    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "year_classify");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
        ...
        <script>
            ...
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/legislative/programofLegislation/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 380, height: 180});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/legislative/programofLegislation/edit.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 640, height: 240});
                })
            });
