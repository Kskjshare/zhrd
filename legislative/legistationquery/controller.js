...
{
//    alert(t)
    popuplayer.display("/legislative/legistationquery/edit.jsp", '添加', {width: 800, height: 580});
}
﻿transadapter["edit"] = function (t)
{
    ...
    lid = tid.join(",");
    popuplayer.display("/legislative/legistationquery/edit.jsp?id=" + lid, '修改', {width: 800, height: 550});
}
...
transadapter["delete"] = function (t)
{
    ...
    lid = tid.join(",");
    popuplayer.display("/legislative/legistationquery/delete.jsp?id=" + lid + "&TB_iframe=true", '删除', {width: 300, height: 80});
}

transadapter["quicksearch"] = function (t)
{

    popuplayer.display("/legislative/legistationquery/quicksearch.jsp", '查询', {width: 450, height: 250});
...
transadapter["export"] = function (t)
{
    ...
    location.href = "/legislative/legistationquery/companylist.jsp?legislativeid=" + legislativeid;
}