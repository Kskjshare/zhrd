    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                   <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">立法计划项目征集</td></tr>
                                              
                    
                    <tr>
                        <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">法规名称<em class="red">*</em></td>                      
                    ...
                    <tr>
                        <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">立法必要性</td>                        
                        <td colspan="7"><input style="font-size:15px;font-family: 微软雅黑;width:99%;" type="text" maxlength="100" class="w98" name="necessity" value="<% entity.write("necessity"); %>" /><label class="labtitle"></label></td>
                    </tr>
                
                    <tr>
                        <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">重点解决问题及拟确立的主要制度</td>                        
                        <td colspan="7"><input style="font-size:15px;font-family: 微软雅黑;width:99%;" type="text" maxlength="100" class="w98" name="mainsystem" value="<% entity.write("mainsystem"); %>" /><label class="labtitle"></label></td>
                    </tr>
                
                    <tr>
                        <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">起草工作计划</td>                        
                        <td colspan="7"><input style="font-size:15px;font-family: 微软雅黑;width:99%;" type="text" maxlength="100" class="w98" name="workplan" value="<% entity.write("workplan"); %>" /><label class="labtitle"></label></td>
                    </tr>
                
                    
                     <tr>                    
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑" >拟报市人大常委会审议时间<em class="red">*</em>
                        </td>
                        <td colspan="2" style="font-size:16px">
                            <input type="text" class="w200 Wdate" name="committeshijian"  rssdate="<% out.print(entity.get("committeshijian")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly">
                        </td>
                    </tr>  
        ...
        <script>
            $(".footer>button").click(function () {
                ...
                if ($("[name='yearname']").val() == undefined || $("[name='yearname']").val() == "") {
                   alert("请填写立法规划年度");
                   $("[name='yearname']").focus();
                   return false;
                } 
