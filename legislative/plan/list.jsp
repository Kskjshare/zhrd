    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "legislativeplan");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                        ...
                        <tr ondblclick="ck_dbablclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <% if ( list.get("state").equals("0")){
                             %>
                             <span class="ys handle" id="<% out.print(list.get("id")); %>" style="color:orange;font-weight: bold" >办理</span> |     
                            <%
                             }
                            %>
        ...
        <script>
            ...
            ﻿$(".handle").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/legislative/LegislativeProject/handleview.jsp?id=" + id + "&TB_iframe=true", '办理', {width: 460, height: 320});
            ...
            ﻿$(".view").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/legislative/LegislativeProject/butview.jsp?id=" + id + "&TB_iframe=true", '查看', {width: 830, height: 320});
            ...
            ﻿$(".delete").click(function(){
                let id = $(this).attr("id");
             popuplayer.display("/legislative/LegislativeProject/delete.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 380, height: 180});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/legislative/LegislativeProject/edit.jsp?id=" + id + "&TB_iframe=true", '修改', {width: 830, height: 360});
                })
            });
