    ...
    <body>
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 formor">
                    <tr><td>届次编号：</td><td><input class="w200" name="code"></td></tr>
                    <tr><td>届次名称：</td><td><input class="w200" name="name"</td></tr>
                </table>
            </div>
            <div class="footer">
        ...
        <script>
            $(".footer>[query]").click(function () {
                var str = "/setup/session/list.jsp?code="+formfun("code")+"&name="+formfun("name")
