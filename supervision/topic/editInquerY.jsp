...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
<!--                <h1 style="margin-top:3px;margin-bottom:10px;font-size:22px;font-family: 微软雅黑;text-align: center; ">质询和询问</h1>-->
                <table class="wp100 cellbor">
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">质询和询问</td></tr>
                    <!--zyx-->
                     <tr>
                    ...
                    <tr>
                        ...
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">质询询问<em class="red">*</em></td>           
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">质询询问单位<em class="red">*</em></td>
                        <td  colspan="2" style="font-size:16px;font-family: 微软雅黑"> <% user.write("realname"); %></td>   
                        
                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">质询询问地点<em class="red">*</em></td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">质询询问方案<em class="red">*</em></td>
                        <td colspan="5">
                            <div>
                     ...
                     <tr>
                     <td class="dce w100" style="font-size:16px;font-family: 微软雅黑" >质询询问时间<em class="red">*</em>
                        </td>
...
//                                }
           ...
           else if ($("#inspecttype select").val() == 5){ //特定问题调查
               v_type = 'specialproblem/edit';
           }
            else if ($("#inspecttype select").val() == 6 ){ //工作评议
               v_type = 'topic/editWorkRevieW';
           }
