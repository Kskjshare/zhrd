...
<!--                <h1 style="margin-top:3px;margin-bottom:10px;font-size:22px;font-family: 微软雅黑;text-align: center; ">执法检查</h1>-->
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">执法检查类别<em class="red">*</em></td>           
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">被检查单位<em class="red">*</em></td>
                        <td  colspan="2" style="font-size:16px;font-family: 微软雅黑"> <% user.write("realname"); %></td>   
                        
                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">执法检查地点<em class="red">*</em></td>
                        <td colspan="2">
                    ...
                    <tr>
                     ...
                     <tr>
                     <td class="dce w100" style="font-size:16px;font-family: 微软雅黑" >检查时间<em class="red">*</em>
                        </td>
