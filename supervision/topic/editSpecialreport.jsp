                ...
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="5" selradio>
                             <select style="width:200px;font-size:16px" value="<% entity.write("reviewclass"); %>" name="reviewclass"> 
                                <%
...
<!--                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">听取审议地点<em class="red">*</em></td>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td colspan="5"><input style="font-size:16px;font-family: 微软雅黑;width:99%;" type="text" class="w98" name="directormeetingnum" value="<% entity.write("directormeetingnum"); %>" /><label class="labtitle"></label></td>
...
//                                }
           ...
           if ($("#inspecttype select").val() == 1) {// 视察调研
                v_type = 'edit';
            }
