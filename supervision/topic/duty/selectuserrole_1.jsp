                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" name="company" value="<% out.print(list.get("company")); %>" company="<% out.print(list.get("company")); %>" postcode="<% out.print(list.get("postcode")); %>" homeaddress="<% out.print(list.get("homeaddress")); %>"  /></td>
