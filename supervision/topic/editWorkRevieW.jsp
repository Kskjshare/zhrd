...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <!--<h1 style="margin-top:3px;margin-bottom:10px;font-size:22px;font-family: 微软雅黑;text-align: center; ">工作评议</h1>-->
                <table class="wp100 cellbor">
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">工作评议</td></tr>
                    <!--zyx-->
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">评议类别<em class="red">*</em></td>           
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">评议单位<em class="red">*</em></td>
                        <td  colspan="2" style="font-size:16px;font-family: 微软雅黑"> <% user.write("realname"); %></td>   
                        
                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">评议地点<em class="red">*</em></td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">评议方案<em class="red">*</em></td>
                        <td colspan="5">
                            <div>
                     ...
                     <tr>
                     <td class="dce w100" style="font-size:16px;font-family: 微软雅黑" >评议时间<em class="red">*</em>
                        </td>
