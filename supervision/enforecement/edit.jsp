    ...
    if (!entity.get("action").isEmpty()) {
        switch (entity.get("action")) {
            case "append":
                ...
                entity.timestamp();
                entity.keyvalue("typeid", 3 );
                entity.keyvalue("previewleadername",entity2.get("previewleadername") );
                
                
                entity.keyvalue("initiator", user.get("realname"));//方案制定者
                //entity.keyvalue("progress", "待执法检查");//方案制定者等
...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <!--<h1 style="margin-top:3px;margin-bottom:10px;font-size:22px;font-family: 微软雅黑;text-align: center; ">执法检查</h1>-->
                  ...
                  <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">执法检查</td></tr>
                    ...
                    <tr>
                        ...
                        <select style="width:206px;font-size:16px;font-family: 微软雅黑" name="lwstate">
                            ...
                            <option value="3" style="font-size:15px;font-family: 微软雅黑">执法检查</option>
                    ...
                    <tr>
                        ...
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑" >执法检查时间<em class="red">*</em>
                        </td>
...
<!--                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">听取审议地点<em class="red">*</em></td>
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">执法检查方案<em class="red">*</em></td>
                        <td colspan="2">
                            <div>
                        ...
                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">执法检查地点</td>
                        <td  colspan="2">
            ...
            <div class="footer">
                ...
                <input type="hidden" id="previewleadernameid" name="previewleadername" value="<% entity2.write("previewleadername"); %>">
