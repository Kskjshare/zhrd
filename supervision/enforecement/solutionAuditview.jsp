     ...
     if (!entity.get("action").isEmpty()) {
        switch (entity.get("action")) {
            case "submit":     
                ...
                entity.keyvalue("state",7 );     // 主任会审议提交常委会
...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        out.print( "<b style='color:CadetBlue;font-size:14px;' >执法检查报告和交办意见审议中</b>" );
                        else
                         out.print( "<b style='color:CadetBlue;font-size:14px;' >执法检查方案审议中</b>" );
            ...
            %>
            <tr>
                <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">执法工作报告</td>
                 <td colspan="5" style="font-weight:bold;">
                 <%
                     String[] arry1 = {"", "", ""};
                     if (!entity.get("workreportenclosure").isEmpty()) {
                         ...
                         for (int idx = 0; idx < str1.length; idx++) {
                             arry1[idx] = str1[idx];
                 %>
                 <%  entity.write("workreportenclosure"); %><a href="/upfile/<% out.print( arry1[idx] );%>" style="cursor: pointer;color:blue;font-weight: bold;font-size: 15px;float: right;margin-right:10%;">点击查看</a>
                 </td>
                 <%
                   }
                 }
            ...
            %>
            <tr>
                <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">执法检查报告</td>
                 <td colspan="5" style="font-weight:bold;">
                 <%
                     String[] arry1 = {"", "", ""};
                     if (!entity.get("Reportenclosure").isEmpty()) {
