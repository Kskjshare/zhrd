     ...
     if (!entity.get("action").isEmpty()) {
        switch (entity.get("action")) {
            ...
            case "report": 
                 ...
                 if ( entity.get("leaderpreview").equals("2") ) {    // 不需要预审
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>     
                <table class="wp100 cellbor">
                   <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">执法检查</td></tr>
                    ...
                    <tr>
                        ...
                        out.print( "<b style='color:DarkOrange;font-size:14px;' >执法检查中</b>" );
                        ...
                        out.print( "<b style='color:CadetBlue;font-size:14px;' >承办单位办理中</b>" );
                ...
                <td colspan="5">
                <div>
                    <span id="fjfileHandlReport" rid="2" style="color:blue ;font-size:16px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;">点击选择办理报告</span>
