                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String organizationid = list.get("company");
                            ...
                            if ( list.get("state").equals("1") ) {
                               ...
                               if ( needpreview ) { //需要审批
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >待出执法检查工作报告</b>";
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >已出执法检查工作报告</b>";
                                //class_str = "enforcement";
                                //cmd_str = "提交执法检查工作报告";
                                isShowcmd = false;
                                isShowEdit = false ;
        ...
        <script>
            ...
            $(function(){
                ﻿$(".enforcement").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/enforecement/workreportview.jsp?id=" + id , '提交执法工作报告', {width: 830, height: 260});
                })
            });
              $(function(){
