                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String organizationid = list.get("organizationid"); //company
                            int state = Integer.valueOf( list.get("state") ).intValue();                            
                            ...
                            if ( list.get("state").equals("1") ) {
                               ...
                               if ( needpreview ) { //需要审批
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >待出执法报告</b>";
                                class_str = "enforcement";
                                cmd_str = "提交执法检查报告";
                                isShowcmd = true;
                                isShowEdit = false ;
                            }
                            else if ( list.get("state").equals("5") ) {
                                if ( list.get("needsubmitmeeting").equals("2") ) { //不提交主任会议
                                    progress = "<b style='color:CadetBlue;font-size:14px;' >不需提交主任会议</b>";
                                }
                                else {
                                    progress = "<b style='color:CadetBlue;font-size:14px;' >已提交执法工作报告</b>";
                                }
                                isShowcmd  = false ;                             
                            }
                            else if ( list.get("state").equals("6") ) {
                                 progress = "<b style='color:CadetBlue;font-size:14px;' >执法检查报告和交办意见审议结束</b>";
                                 isShowcmd  = false ;                             
                                 cmd_str = "交办";
                                 class_str = "jiaoban";
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >研究处理执法检查报告和审议意见中</b>";
                                cmd_str = "提交常委会";
                                isShowcmd  = true ;              
                                class_str = "report";                          
                                isShowEdit = false ;
                             	   ...
                             	   if ( list.get("leaderpreview").equals("2") ) {    // 不需要预审
                             	    progress = "<b style='color:CadetBlue;font-size:14px;' >待出研究处理报告</b>";
                                  isShowcmd  = true ;              
                                	class_str = "report";                                 
                                  cmd_str = "提交报告";
                                 	isShowEdit = false ;
        ...
        <script>
               $(function(){
                ﻿$(".viewDetail").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/enforecement/inspectbutview.jsp?id=" + id , '查看详情', {width: 830, height: 360});
                })
            });
            $(function(){
                ﻿$(".submit").click(function(){
                    let id = $(this).attr("id");
                 popuplayer.display("/supervision/enforecement/submit.jsp?id=" + id , '提交主任会议审议', {width: 830, height: 460});
                 //popuplayer.display("/supervision/topic/duty/inspectReport.jsp?id=" + id, '主任会议审议', {width: 830, height: 460});
                })
            });
            
            $(function(){
                ﻿$(".enforcement").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/enforecement/enforcementview.jsp?id=" + id , '提交执法工作报告', {width: 830, height: 260});
                })
            });
              $(function(){
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/enforecement/edit.jsp?id=" + id , '编辑', {width: 830, height: 560});
                })
            });
             ...
             $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/enforecement/delete.jsp?id=" + id , '删除', {width: 330, height: 80});
                })
            });
             ...
             $(function(){
                ﻿$(".preview").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/enforecement/preview.jsp?id=" + id , '审阅', {width: 830, height: 320});
                })
            });
        </script>
    </body>
