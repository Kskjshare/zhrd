    ...
    if (!entity.get("action").isEmpty()) {
        switch (entity.get("action")) {
            case "update":
                ...
                entity.keyvalue("workreportenclosurename",entity2.get("workreportenclosurename"));
                entity.keyvalue("workreportenclosure",entity2.get("workreportenclosure"));
        ...
        <form method="post" class="popupwrap">           
            <div>
                ...
                <table class="wp100 cellbor">
                  <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">
                          执法检查</td></tr>              
                    <tr>
                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">执法工作报告<em class="red">*</em></td>
                        <td colspan="5">
                            <div>
                                <span id="fjfile" rid="1" style="color:blue ;font-size:16px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;">点击选择执法工作报告</span>
                                <input type="hidden" name="workreportenclosure" id="enclosure" value="<% entity2.write("workreportenclosure"); %>" >
                                <input type="hidden" name="workreportenclosurename" id="enclosurename" value="<% entity2.write("workreportenclosurename"); %>" >
                            </div>
<!--                            <div style="display: none;"><span id="fjfile2" rid="2" style="color:blue;font-size:16px;font-family: 微软雅黑;font-weight: bold;">点击选择方案文件</span>
        ...
        <script>
            ...
            $(".footer>button").click(function () {
                ...
                if ($("[name='workreportenclosure']").val() == undefined || $("[name='workreportenclosure']").val() == "") {
                    alert("请添加执法工作报告");
                    $("[name='workreportenclosure']").focus();
                    return false;
                }
            ...
            $("#filee").change(function () {
                ...
                if(data.url !== null && "" !== data.url){
                    $("#fjfile").text(filename)
                        $("input[name='workreportenclosure']").val(data.url);
                        $("input[name='workreportenclosurename']").val(filename);
                        //alert("上传成功");
                        }else{
                        $("#fjfile").text("点击选择文件")
                        $("input[name='workreportenclosure']").val(data.url);
