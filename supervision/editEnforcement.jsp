    ...
    <body>
        ...
        <form method="post" class="popupwrap"> 
            ...
            <div>
                ...
                <h1 style="font-size:22px;font-family: 微软雅黑">执法检查</h1>
...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="dce" style="font-size:16px;font-family: 微软雅黑">检查类别<em class="red">*</em></td>           
...
<!--                        <td style="font-size:16px;font-family: 微软雅黑">代表团</td>
                    ...
                    <tr>
                     <td class="dce" style="font-size:16px;font-family: 微软雅黑" >执法时间<em class="red">*</em>
                        </td>
