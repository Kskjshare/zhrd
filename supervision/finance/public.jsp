...
<!--                    <tr>
                        <td colspan="4" class="institle dce">发布公开</td>
                    </tr>-->
                    <tr>
...
<!--                    <tr><td class="dce w100 ">图片</td>
                    ...
                    <tr style="display: none;">
                        ...
                        <td><select class="w250 classify" name="classifyid" dict-select="releasumclassifys" def="14"></select></td>
                    </tr>
                     <tr>
                        <td class="dce w100 ">类别<em class="red">*</em></td>
                        <td>
                            <select class="w250 publiclassifyid" name="publiclassifyid" dict-select="publiclassifyid" ></select>
                        </td>
...
//                                var allowExtention = ".mp4,.png,.gif,.xls,.zip,.txt,.xlsx,.png,.jpg,.avi,.mp3,.rm,.kux,.mpeg-1,.apk,.doc,.docx,.pdf"; //�����ϴ��ļ��ĺ�׺��document.getElementById("hfAllowPicSuffix").value;
