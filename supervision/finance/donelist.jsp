                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String progress =  "<b style='color:CadetBlue;font-size:14px;' >特定问题调查已完成</b>" ;
                            ...
                            while (list.for_in_rows()) {
                                progress = "<b style='color:DarkOrange;font-size:14px;' >特定问题调查已完成</b>";
                        %>
        ...
        <script>
            $(function(){
                ﻿$(".viewDetail").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/specialinquery/detailview.jsp?id=" + id + "&TB_iframe=true", '查看详情', {width: 830, height: 560});
                })
            });
             ...
             $(function(){
                ﻿$(".evalute").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/evaluation.jsp?id=" + id + "&typeid=6", '测评', {width: 830, height: 360});
                })
            });
            ...
            $(function(){
                ﻿$(".satisfactionview").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/evaluationview.jsp?id=" + id + "&typeid=6", '查看测评满意度', {width: 560, height: 280});
                })
            });
