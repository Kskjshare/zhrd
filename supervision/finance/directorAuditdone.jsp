...
<!--                    <tr>
                    ...
                    <tr>
                        <td class="dce" style="width:140px;font-size:15px;font-family: 微软雅黑">审议意见<em class="red">*</em></td>
                        <td colspan="5">
                            <div>
                                <span id="fjfile" rid="1" style="color:blue ;font-size:15px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;">
                                    <%
                                    if (entity.get("enclosure1_1") == "") {
                                    %>
                                    点击选择文件
                                    <%
                                    }else{
                                    %>
                                    <% entity.write("enclosurename1_1"); %>
                                    <%
                                    };
                                    %>
                                </span>
                                <input type="hidden" name="enclosure1_1" id="enclosure" value="<% entity.write("enclosure1_1"); %>" >
                                <input type="hidden" name="enclosurename1_1" id="enclosurename" value="<% entity.write("enclosurename1_1"); %>" >
                            </div>
                     ...
                     <tr class="directormeeting">                     
                      <td class="dce" style="font-size:15px;font-family: 微软雅黑" >专题询问会时间<em class="red">*</em>
                      </td>
                      <td colspan="3" style="font-size:15px">
                        <input type="text"  style="width:98%;" class=" Wdate" name="inquerymeetingshijian"  rssdate="<% out.print(entity.get("inquerymeetingshijian")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly">
                      </td>
 
                      <td class="dce" style="font-size:15px;font-family: 微软雅黑">专题询问会届次<em class="red">*</em></td>
                      <td colspan="5"><input  style="font-size:15px;font-family: 微软雅黑;width:99%;" type="text" maxlength="8" class="w98" name="inquerymeetingnum" value="<% entity.write("inquerymeetingnum"); %>" /><label class="labtitle"></label></td>
                    </tr>
...
<!--                     <tr class="committeemetting">                     
                      ...
                      <td colspan="5"><input style="font-size:15px;font-family: 微软雅黑;width:99%;" type="number" maxlength="8" class="w98" name="committeemeetingnum" value="<% entity.write("committeemeetingnum"); %>" /><label class="labtitle"></label></td>
...
<!--           <tr class="co-committee-member" >
            ...
            <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">满意度测评成员</td></tr>
            <tr>
           ...
           <tr class="canyu" >
            ...
            <div class="footer">
                ...
                <button type="submit"><% out.print(entity.get("id").isEmpty() ? "提交" : "确认");%></button>
...
//               
                ...
                if ($("[name='inquerymeetingshijian']").val() != undefined && $("[name='inquerymeetingshijian']").val() != "") {
                    var timestamp = new Date($("[name='inquerymeetingshijian']").val());
                    $("[name='inquerymeetingshijian']").val(timestamp / 1000);
                }
                else {
                    alert("请添加专题询问会时间");
                    $("[name='inquerymeetingshijian']").focus();
                    return false;
                } 
                ...
                //兼职委员
                var arry2 = [];
                $("#selparttimecommitteesend>em[parttimecommitteemyid]").each(function () {
                    arry2.push($(this).attr("parttimecommitteemyid"))        
                })
                var str2 = arry2.join(",");
                ...
                //专家
                var arry3 = [];
                $("#selexpertsend>em[expertmyid]").each(function () {
                    arry3.push($(this).attr("expertmyid"))        
                })
                var str3 = arry3.join(",");
        ...
        $("#filee").change(function () {
            ...
            if(data.url !== null && "" !== data.url){
                $("#fjfile").text(filename)
                    $("input[name='enclosure1_1']").val(data.url);
                    $("input[name='enclosurename1_1']").val(filename);
                    //alert("上传成功");
                    }else{
                    $("#fjfile").text("点击选择文件")
                    $("input[name='enclosure1_1']").val(data.url);
...
//        });
          ...
          $('[selectparttimecommitteeuser]').click(function () {
            ...
            RssWin.onwinreceivemsg = function (dict) {
                $.each(dict, function (k, v) {
                    ...
                    if ($("em[parttimecommitteemyid='" + v.myid + "']").length == "0") {
                        
                        t.append("<em parttimecommitteemyid='" + v.myid + "'>" + v.realname + "<i>×</i></em>")                     
                    }
                })
        ...
        //专家
         $('[selectexpertuser]').click(function () {
            ...
            RssWin.onwinreceivemsg = function (dict) {
                $.each(dict, function (k, v) {
                    if ($("em[expertmyid='" + v.myid + "']").length == "0") {
                        t.append("<em expertmyid='" + v.myid + "'>" + v.realname + "<i>×</i></em>")
