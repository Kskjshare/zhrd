        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "finance_user");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                           
                            list.select().where("company like '%" + list.get("searchkey") + "%'" ).get_page_desc("myid");
//                            list.select().where("company like '%" + list.get("company") + "'%").get_page_desc("myid");
