            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <span id="fjfile"><% out.print(entity.get("reenclosurename").isEmpty() ? "点击选择文件" : entity.get("reenclosurename")); %></span>
                            <input type="hidden" name="reenclosure" value="<% entity.write("reenclosure"); %>" >
                            <input type="hidden" name="reenclosurename" value="<% entity.write("reenclosurename"); %>" >
                        </td>
                    </tr>
                    <tr>
                        <td class="dce">备注：</td>
                        <td><textarea type="text" class="w500 h200" name="rematter"><% entity.write("rematter");%></textarea></td>
                    </tr>
            ...
            $("#filee").change(function () {
                ...
                $("#fileeform").ajaxSubmit({
                    ...
                    success: function (data) {
                        ...
                        $("input[name='reenclosure']").val(data.url);
                        $("input[name='reenclosurename']").val(filename);
                        alert("上传成功");
                    }});
                return false;
            })
