                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("typeid=" + list.get("typeid") + " and title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and state<>5 and myid=" + UserList.MyID(request)).get_page_desc("id");
