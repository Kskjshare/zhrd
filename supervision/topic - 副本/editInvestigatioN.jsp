...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <!--<h1 style="margin-top:3px;margin-bottom:10px;font-size:22px;font-family: 微软雅黑;text-align: center; ">特定问题调查</h1>-->
                <table class="wp100 cellbor">
                    ...
                    <tr>
                       ...
                       <option value="8" style="font-size:16px;font-family: 微软雅黑">调研</option>
                        ...
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">调查类别<em class="red">*</em></td>           
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:16px;font-family: 微软雅黑">调查单位<em class="red">*</em></td>
                        <td  colspan="2" style="font-size:16px;font-family: 微软雅黑"> <% user.write("realname"); %></td>   
                        
                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">调查地点<em class="red">*</em></td>
                        <td colspan="2">
                     ...
                     <tr>
                     <td class="dce w100" style="font-size:16px;font-family: 微软雅黑" >调查时间<em class="red">*</em>
                        </td>
...
zyx 注销，原因吧标题和通知信息搬到上边-->
                    <tr class="">
                        <td colspan="6" class="marginauto uetd">
                            <ul><li class="sel" style="font-size:16px;font-family: 微软雅黑">意见</li></ul>
