...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
<!--                <h1 style="margin-top:3px;margin-bottom:10px;font-size:22px;font-family: 微软雅黑;text-align: center; ">调研</h1>-->
...
<!--                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">听取审议地点<em class="red">*</em></td>
                    ...
                    <tr>
                        ...
                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">视察调研地点</td>
                        <td colspan="2">
                    ...
                    <tr class="canyu" >
                     ...
                     <tr>
                        ...
                        <td  colspan="5" id="userrolesel">
                            <textarea  style="width:99%;" readonly="readonly" value="<% req.write("company"); %>"></textarea>
