                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <span class="ys submitToMeeting" id="<% out.print(list.get("id")); %>" style="color:blue;font-weight: bold" >提交主任会议</span> 
        ...
        <script>
            ...
            $(function(){
                ...
                //popuplayer.display("/supervision/topic/inspectReport.jsp?id=" + id + "&TB_iframe=true", '提交主任会议', {width: 830, height: 260});
                 popuplayer.display("/supervision/topic/duty/inspectReport.jsp?id=" + id, '提交主任会议', {width: 830, height: 260});
                })
            });
             ...
             $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/topic/delete.jsp?id=" + id , '删除', {width: 330, height: 80});
                })
            });
        </script>
    </body>
