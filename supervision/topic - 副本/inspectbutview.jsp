        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">视察调研信息</td></tr>
                    <tr>
                    ...
                    <tr><td class="w100 dce">当前进程</td><td>
                            <% 
                                 if ( entity.get("progress").equals("1") )
                                out.print( "<b style='color:CadetBlue;font-size:14px;' >视察调研中</b>" ); 
                    ...
                    <tr>
                        <td class="w100 dce">视察调研类别</td><td><% entity.write("reviewclass"); %></td>
                        <td colspan="2" class="w100 dce">视察调研地点</td><td><% entity.write("place"); %></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="w100 dce" style="font-size:14px;font-family: 微软雅黑;"class="w100 dce">视察调研时间</td>
                            ...
                            <%
                                ...
                                if (!entity.get("enclosure").isEmpty()) {
                                    ...
                                    for (int idx = 0; idx < str1.length; idx++) {
                                        arry1[idx] = str1[idx];
                            %>
                            <input style="font-size:14px;font-weight: bold;line-height:34px; " readonly="true" class="xz" value="<%  entity.write("enclosurename"); %>"/><a href="/upfile/<% out.print(arry1[idx]); %>" style="cursor: pointer;color:blue;font-weight: bold;">点击下载</a>
                            <%
                                    }
                                }
                            %>
                            ...
                            <%
                                ...
                                if (!entity.get("Reportenclosure").isEmpty()) {
                                    ...
                                    for (int idx = 0; idx < str1.length; idx++) {
                                        arry2[idx] = str1[idx];
                            %>
                            <input style="font-size:14px;font-weight: bold;line-height:34px; " readonly="true" class="xz" value="<%  entity.write("Reportenclosurename"); %>"/><a href="/upfile/<% out.print(arry2[idx]); %>" style="cursor: pointer;color:blue;font-weight: bold;">点击下载</a>
                            <%
                                    }
                                }
                            %>
