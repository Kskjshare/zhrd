                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String progress =  "<b style='color:DarkOrange;font-size:14px;' >视察中</b>" ;
            ...
            $(function(){
              ...
              $(function(){
                ﻿$(".report").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/inspection/reportview.jsp?id=" + id , '主任会议汇报', {width: 830, height: 420});
                })
            });
