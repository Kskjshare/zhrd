...
<!--                    <tr>
            ...
            <div class="footer">
                ...
                <input id="needpreviewid" type="hidden" name="needsubmitmeeting" value="<%out.print("needsubmitmeeting");%>" />
                <!--<input id="needpreviewid" type="hidden" name="needsubmitmeeting" value="<%entity.write("needsubmitmeeting");%>" />-->
            </div>
        </form>
