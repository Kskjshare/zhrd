                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String progress =  "<b style='color:CadetBlue;font-size:14px;' >视察中</b>" ;
...
//                            }
                            ...
                            if ( list.get("state").equals("1") ) {
                               ...
                               if ( needpreview ) { //需要审批
                                ...
                                if ( list.get("leaderpreview").equals("1") ) { //需要预审
                                    progress =  "<b style='color:CadetBlue;font-size:14px;' >已审阅</b>" ;
                                    isShowcmd = false ;
                                }
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >视察中</b>";
                                isShowcmd = false;
                                isShowEdit = false ;
                            }
                            else if ( list.get("state").equals("5") ) {
                               
                                progress = "<b style='color:CadetBlue;font-size:14px;' >视察报告和交办意见审议中</b>";
                                isShowcmd = false;
                                isShowEdit = false ;
                            }
                            else if ( list.get("state").equals("6") ) {
                               
                                progress = "<b style='color:CadetBlue;font-size:14px;' >视察报告和交办意见审议结束</b>";
                                isShowcmd = false;
                                isShowEdit = false ;
                            }
                            else if ( list.get("state").equals("7") ) {
                               
                                progress = "<b style='color:CadetBlue;font-size:14px;' >承办单位办理中</b>";
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >视察已结束</b>";
                                isShowcmd = false;
                                isShowEdit = false ;
                            }
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td><% out.print(list.get("reviewclass"));  out.print(list.get("organizationid").split(",").length);%></td>
        ...
        <script>
               $(function(){
                ﻿$(".viewDetail").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/inspection/inspectbutview.jsp?id=" + id + "&TB_iframe=true", '查看详情', {width: 830, height: 560});
                })
            });
            $(function(){
            ...
            $(function(){
                ﻿$(".assign").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/inspection/assignview.jsp?id=" + id , '交办', {width: 830, height: 460});
                })
            });
              $(function(){
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/inspection/edit.jsp?id=" + id , '编辑', {width: 830, height: 560});
                })
            });
             $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/inspection/delete.jsp?id=" + id , '删除', {width: 330, height: 80});
                })
            });
