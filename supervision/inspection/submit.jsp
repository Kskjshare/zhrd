...
-->
        ...
        <tr>
        <td class="w120 dce">视察报告<em class="red">*</em></td>
        <td colspan="5">
        <div>
            <span id="fjfileReport" rid="2" style="color:blue ;font-size:15px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;">点击选择文件</span>
            ...
            <td colspan="5">
            <div>
                <span id="fjfileOpinion" rid="3" style="color:blue ;font-size:15px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;">点击选择文件</span>
