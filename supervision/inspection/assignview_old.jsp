     ...
     if (!entity.get("action").isEmpty()) {
        switch (entity.get("action")) {
            ...
            case "auditpass":
                ...
                if ( !entity2.get("Reportenclosure").isEmpty() ) {
                    entity.keyvalue("Reportenclosure", entity2.get("Reportenclosure"));
                    entity.keyvalue("Reportenclosurename", entity2.get("Reportenclosurename"));
                }
                if ( !entity2.get("assignenclosure").isEmpty() ) {
                    entity.keyvalue("assignenclosure", entity2.get("assignenclosure"));
                    entity.keyvalue("assignenclosurename", entity2.get("assignenclosurename"));
                }
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>     
                <table class="wp100 cellbor">
                   <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">视察</td></tr>
                    ...
                    <tr>
                        ...
                        <td class="w100 dce" style="font-size:15px;font-family: 微软雅黑;"class="w100 dce">发布时间</td>
                        <td colspan="2" rssdate="<% entity.write("shijian"); %>,yyyy-MM-dd" ></td>
                    </tr>
                    
                          
                    <tr>
                        <td class="w120 dce" style="font-size:15px;font-family: 微软雅黑;"class="w100 dce">主任会议时间</td>
                ...
                <tr>
                    <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">视察方案</td>
  <!--
                    <td colspan="2">
                        <div>
...
-->
                ...
                <tr>
                   <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">视察报告</td>
                     <!--
                    <td colspan="2">
                        <div>
                ...
                <tr>
                 <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">交办意见</td>
                   <!--
                  <td colspan="2">
                      <div>
                          <span id="fjfile" rid="1" style="color:blue ;font-size:16px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;">点击更改方案</span>
                ...
                <tr>
                    <td class="dce w100 " style="color:blue;font-size:15px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;" >承办单位<em class="red">*</em></td>
                    <td  colspan="5" id="userrolesel">
                        <textarea  style="width:99%;" readonly="readonly" value="<% req.write("organizationid"); %>"><% entity2.get("organizationid"); %></textarea>
                        <input type="hidden" name="organizationid" id="userroleid" value="<% entity2.write("organizationid"); %>"/>
                    </td>
                </tr> 
...
//                    }
                   ...
                   if ($("[name='organizationid']").val() == undefined || $("[name='organizationid']").val() == "") {
                        alert("请添加承办单位");
                        $("[name='organizationid']").focus();
                        return false;
                    }   
                }
