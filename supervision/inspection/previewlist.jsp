                            ...
                            if ( list.get("previewleadername").contains( UserList.MyID(request))  ) {//如果是状态为1 ，并且需要领导预审的话，
                             ...
                             if ( list.get("state").equals("1") ) {
                               ...
                               if ( needpreview ) { //需要审批
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >视察已经完成</b>";
                                isShowcmd = false;
                                isShowEdit = false ;
                            }
            ...
            $(function(){
             ...
             $(function(){
                ﻿$(".preview").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/inspection/preview.jsp?id=" + id , '审阅', {width: 830, height: 320});
                })
            });
