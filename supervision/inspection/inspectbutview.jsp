            ...
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr><td class="w100 dce">当前进程</td><td>
                            <% 
                                if ( entity.get("state").equals("1") ) {
                                    ...
                                    if ( entity.get("leaderpreview").equals("1") ) { //需要预审
                                        out.print( "<b style='color:DarkOrange;font-size:14px;' >审议视察方案中</b>" ); 
                                    }else {
                                    ...
                                    if ( entity.get("leaderpreview").equals("1") ) { //需要预审
                                        out.print( "<b style='color:DarkOrange;font-size:14px;' >视察报告和交办主任会审议意见中</b>" ); 
                                    }else {
                                        out.print( "<b style='color:DarkOrange;font-size:14px;' >视察中</b>" );
                                    }     
                                    ...
                                    if ( entity.get("needsubmitmeeting").equals("2") ) {
                                        ...
                                        out.print( "<b style='color:CadetBlue;font-size:14px;' >不需要提交主任会议</b>" ); 
                                         ...
                                         out.print( "<b style='color:DarkOrange;font-size:14px;' >视察报告和交办意见主任会审议中</b>" ); 
                                    }
                                }
                                     ...
                                     out.print( "<b style='color:CadetBlue;font-size:14px;' >视察已完成</b>" );
                                }
                    ...
                    <tr>
                        ...
                        <td class="w100 dce" style="font-size:15px;font-family: 微软雅黑;"class="w100 dce">视察时间</td>
                            ...
                            <%
                                ...
                                if (!entity.get("handleReportenclosure").isEmpty()) {
                                    ...
                                    for (int idx = 0; idx < str1.length; idx++) {
                                        arry3[idx] = str1[idx];
                            %>
                            <input style="font-size:15px;font-weight: bold;line-height:34px; " readonly="true" class="xz" value="<%  entity.write("handleReportenclosurename"); %>"/><a href="/upfile/<% out.print(arry3[idx]); %>" style="cursor: pointer;color:blue;font-weight: bold;">点击查看</a>
                            <%
                                    }
                                }
                            %>
