...
//                entity2.request();
//                entity2.select().where("state=1").get_page_desc("shijian");
//
//                while (entity2.for_in_rows()) { //新增记录
//                RssList entity3 = new RssList(pageContext, "activities_notifystate"); 
//                entity3.request();
//                entity3.remove("reviewclass");
//                entity3.remove("inspecttime");
//                entity3.remove("enclosure"); 
//                entity3.remove("enclosurename");
//                entity3.remove("leaderpreview");
//                entity3.remove("previewleadername");
//                entity3.remove("previewLeaderRealName");
//                entity3.remove("lwstate");
//                
//                entity3.keyvalue("activitiesid",entity2.get("id"));
//                
//                  
//                int cnt = 1 ;
//                
//                if ( !entity2.get("previewleadername").isEmpty() ) {
//                  
//                    String[] previewerid = entity2.get("previewleadername").split(",");
//                    cnt = previewerid.length ;
//                }
//                
//                for ( int i = 0 ; i < cnt ; i ++ ){
//                  if ( !entity2.get("previewleadername").isEmpty() ) {   
//                    String[] str_previewerid = entity2.get("previewleadername").split(",");
//                    entity3.keyvalue("previewerid",str_previewerid [ i ] );
//                  }
//                
//                 entity3.keyvalue("activitiesid",entity2.get("id") );
//                 entity3.keyvalue("typeid",8 );
//
//                  
