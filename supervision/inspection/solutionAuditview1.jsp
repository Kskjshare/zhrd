...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        out.print( "<b style='color:DarkOrange;font-size:14px;' >视察报告和交办意见审议中</b>" );
                        else
                         out.print( "<b style='color:DarkOrange;font-size:14px;' >视察方案审议中</b>" );
            ...
            if (!entity.get("meetingshijian1").isEmpty()) {
             ...
             %>     
                ...
                <tr>
                    <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">视察方案</td>
            ...
            if (!entity.get("Reportenclosure").isEmpty()) {
             ...
             %>
            <tr>
                <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">视察报告</td>
                 <td colspan="5" style="font-weight:bold;">
                 <%
                     String[] arry1 = {"", "", ""};
                     if (!entity.get("Reportenclosure").isEmpty()) {
