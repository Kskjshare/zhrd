...
<!--        <link href="mui.min.css" rel="stylesheet" type="text/css"/>-->
    ...
    <body>
        <form method="post" class="popupwrap">
                ...
                <table class="wp120 cellbor">
                    ...
                    <tr>              
                        ...
                        <td colspan="10" >
                            ...
                            <label style="margin-left:16%;"><input type="radio" value="2" id="checkedid" name="evaluationSwitch">关闭满意度测评</label>
                        </td>
                    </tr>
            ...
            <div class="footer">
<!--                <input type="hidden" name="evaluationSwitchs" value="<% entity.write("evaluationSwitch");%>">-->
        ...
        <script>
            $(".footer>button").click(function(){
               var tt = $('input[name="evaluationSwitch"]').val()               
               if( tt == 1){
             ...
             $('input[name="evaluationSwitch"]').click(function () {
                   if ( $(this).val() ==  1 ) {
                        ...
                        $("#adutibtn").text("关闭"); 
                        $('input[name="evaluationSwitch"]').val("2")
                     }
                    }); 
//           
//        $('input[name="evaluationSwitch"]').click(function () {
...
//                $("#adutibtn").text("开启"); 
//                $("input[name='action']").val("open");  
//                $("input[name='evaluationSwitch']").val("1");  
//            }
//            else {
//                $("#adutibtn").text("关闭");  
//                $("input[name='action']").val("close");  
