                    ...
                    <tbody>
                        <%
                            ...
                            while (list.for_in_rows()) {
                                progress = "<b style='color:CadetBlue;font-size:14px;' >特定问题调查已完成</b>";
                        %>
        ...
        <script>
            $(function(){
                ﻿$(".viewDetail").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/specialproblem/detailview.jsp?id=" + id + "&TB_iframe=true", '查看详情', {width: 830, height: 360});
                })
            });
