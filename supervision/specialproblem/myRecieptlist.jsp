                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String progress =  "<b style='color:CadetBlue;font-size:14px;' >调研中</b>" ;
                            ...
                            if ( list.get("state").equals("1") ) {
                               progress =  "<b style='color:CadetBlue;font-size:14px;' >调研中</b>" ;
                               cmd_str = "提交主任会议审议";
        ...
        <script>
               $(function(){
                ﻿$(".viewDetail").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/inspectbutview.jsp?id=" + id + "&TB_iframe=true", '查看详情', {width: 830, height: 560});
                })
            });
            $(function(){
