    ...
    <head>
        ...
        <style>
            ...
            #selparttimecommitteesend em{background:rgb(0, 128, 225);padding: 1px 2px;color: #fff; border-radius: 5px;margin: 0 2px;cursor: pointer;}
             #selothersend em{background:rgb(0, 128, 225);padding: 1px 2px;color: #fff; border-radius: 5px;margin: 0 2px;cursor: pointer;}
        </style>
    </head>
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                ...
                <table class="wp100 cellbor">
                   <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">特定问题调查</td></tr>
                   <tr>
                    ...
                    <tr>
                        <td class="dce w120" style="font-size:15px;font-family: 微软雅黑">方案类别</td>
...
<!--                    <tr>
                    ...
                    <tr>
                        <td  class="dce">发起方式</td>
                        <td colspan="5" id="evaluation">
                            
<!--                            <label ><input type="hidden" value="1" name="initiator" checked="cheched" ></label>-->
                            <label style="margin-left:20%;"><input type="radio" value="2" name="initiator" checked="cheched" >主任会议</label>
                            <label style="margin-left:20%;"><input type="radio" value="3" name="initiator">常委会成员联名</label>
                            <!--<label style="float:right;"><input type="radio" value="3" name="initiator">常委会成员联名</label>-->                           
                    ...
                    <tr>
                        <td class="dce" style="width:140px;font-size:15px;font-family: 微软雅黑">特定问题调查文件<em class="red">*</em></td>
                        <td colspan="5">
                            <div>
                     ...
                     <tr class="directormeeting">                     
                      <td class="dce" style="font-size:16px;font-family: 微软雅黑" >主任会议时间<em class="red">*</em>
                      </td>
                     ...
                     <tr class="committeemetting">                     
                      <td class="dce" style="font-size:15px;font-family: 微软雅黑" >常委会议时间<em class="red">*</em>
                      </td>
                      ...
                      <td class="dce" style="font-size:15px;font-family: 微软雅黑">常委会议届次<em class="red">*</em></td>
            ...
            <tr class="co-committee-member" >
                <td class="dce" style="width:130px;">常委会联名成员<em class="red">*</em></td>
                <td id="selcocommitteesend" colspan="5"><em selectcocommitteeuser>点击选择常委会联名成员</em>
                </td>
            ...
            <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">特定问题调查委员会成员</td></tr>
            <tr>
                <td class="dce" >常委会成员</td>
...
<!--            
            ...
            <tr>
                <td class="dce" >其他人员</td>
                <td id="selothersend" colspan="5"><em selectothertuser>点击选择其他人员</em>                
                </td>                 
            </tr>     
            ...
            <div class="footer">
                ...
                <input type="hidden" id="delegatememberName" name="delegatememberName" value="<% entity.write("delegatememberName"); %>">
...
//                }
                ...
                $("#selsend>em[myid]").each(function () {
                    ...
                    arry_delegate.push($(this).attr("realname")) 

                })
                var str = arry.join(",");
                $("#rid").val(str);
                var str_delegate = arry_delegate.join(",");
                $("#delegatememberName").val( str_delegate );
                ...
                $("#committeememberName").val( str1_name );
                ...
                var arry3 = [];
                var arry3_name = [];
                $("#selothersend>em[other]").each(function () {
                    arry3.push($(this).attr("other"))  
                    arry3_name.push($(this).attr("realname"))
                })
                var str3 = arry3.join(",");
                var str3_name = arry3_name.join(",");
                $("#parttimememberid").val( str3 );
                $("#parttimememberName").val( str3_name );
...
//                                            t.append("<em myid='" + v.myid + "' sellzstate='" + v.sellzstate + "'>" + v.realname + "<i>×</i></em>")
            ...
            if (coo == "22") {
                RssWin.open("/activities/selectuser_2.jsp?mission=<%=cookie.Get("myid")%>", 580, 600);
            } else {
                RssWin.open("/activities/selectuser_2.jsp?mission=<%=user.get("mission")%>", 580, 600);
            }
        });
...
//                        t.append("<em committeemyid='" + v.myid + "'>" + v.realname + "<i>×</i></em>")
          ...
          $('[selectparttimecommitteeuser]').click(function () {
            ...
            RssWin.onwinreceivemsg = function (dict) {
                $.each(dict, function (k, v) {
                    if ($("em[committeemyid1='" + v.myid + "']").length == "0") {
//                        t.append("<em committeemyid1='" + v.myid + "'>" + v.realname + "<i>×</i></em>")
                        t.append("<em parttimemember='" + v.myid + "' + realname='" + v.realname + "'>" + v.realname + "<i>×</i></em>")
             ...
             RssWin.open("/supervision/selectuserroles.jsp", 580, 600);
        });
        
        //其他
         $('[selectothertuser]').click(function () {
            var t = $(this).parent();
            RssWin.onwinreceivemsg = function (dict) {
                $.each(dict, function (k, v) {
                    if ($("em[other='" + v.myid + "']").length == "0") {
//                        t.append("<em committeemyid1='" + v.myid + "'>" + v.realname + "<i>×</i></em>")
                        t.append("<em other='" + v.myid + "' + realname='" + v.realname + "'>" + v.realname + "<i>×</i></em>")
                    
                    }
                })
                $("#selothersend i").off("click").click(function () {
                    $(this).parent().remove();
                })
            }
             RssWin.open("/supervision/selectexpert.jsp", 580, 600);
        });
