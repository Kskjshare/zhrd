transadapter["append"] = function (t)
{
    ...
    //popuplayer.display("/supervision/topic/editInvestigatioN.jsp?typeid="+typeid+"&TB_iframe=true", '特定问题调查', {width: 830, height: 550});
     popuplayer.display("/supervision/specialReport/editSpecialreport.jsp?typeid="+typeid+"&TB_iframe=true", '听取和审议专项工作报告', {width: 830, height: 430});
...
transadapter["delete"] = function (t)
{
    ...
    popuplayer.display("/supervision/specialReport/delete.jsp?relationid=" + rid + "&account=" +account2 + "&rolelist=" +rolelist2 + "&typeid="+typeid+"&TB_iframe=true", '删除', {width: 300, height: 80});
}
function ck_dbAbTlclick() {

    $('tbody tr').dblclick(function () {
        popuplayer.display("/supervision/specialReport/specialworkview.jsp?id=" + $(this).attr('idd') + "&TB_iframe=true", '查看', {width: 830, height: 560});
    })

}
transadapter["quicksearch"] = function (t)
{
    popuplayer.display("/supervision/specialReport/quicksearch.jsp?typeid="+typeid, '快速查询', {width: 500, height: 100});
}
﻿transadapter["butview"] = function (t)
{
    ...
    popuplayer.display("/supervision/specialReport/receipt/specialworkview.jsp?relationid=" + transadapter.id + "&TB_iframe=true", '查看', {width: 830, height: 560});
}