                ...
                <table class="wp100 cellbor">
                   <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">听取和审议专项工作报告</td></tr>
                    ...
                    <tr>
                        ...
                        <td class="dce w100" style="font-size:15px;font-family: 微软雅黑">报告类别</td>           
                        <td colspan="5" selradio>
                            <select style="width:206px;font-size:15px" value="<% entity.write("name"); %>" name="reviewclass" dict-select="companytypeeclassify" def="<% entity.write("reviewclass"); %>">
                    ...
                    <tr>
                        ...
                        <td  colspan="5" style="font-size:15px;font-family: 微软雅黑"> <% user.write("realname"); %></td>   
...
<!--                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">听取审议地点<em class="red">*</em></td>
                    ...
                    <tr>
                        <td class="dce w100" style="font-size:15px;font-family: 微软雅黑">实施方案<em class="red">*</em></td>
                        <td colspan="5">
                            <div>
                     ...
                     <tr>                     
                      <td class="dce w100" style="font-size:15px;font-family: 微软雅黑" >上会时间<em class="red">*</em>
                      </td>
                      ...
                      <td class="dce w100" style="font-size:15px;font-family: 微软雅黑">上会届次<em class="red">*</em></td>
...
<!--                      <td class="dce w100" style="font-size:16px;font-family: 微软雅黑" >审定时间<em class="red">*</em>
                ...
                <!--  
                  <tr>
                    ...
                    <tr class="canyu" >
                        <td class="dce" style="width:110px;">参与人<em class="red">*</em></td>
            ...
            <div class="footer">
                ...
                <input type="hidden" id="participant" name="participant" value="<% entity.write("participant"); %>">                
            </div>
        </form>
...
//                                    console.log(dict);
            ...
            if (coo == "22") {
                RssWin.open("/activities/selectuser_2.jsp?mission=<%=cookie.Get("myid")%>", 580, 650);
            } else {
                RssWin.open("/activities/selectuser_2.jsp?mission=<%=user1.get("mission")%>", 580, 650);
            }
        });
