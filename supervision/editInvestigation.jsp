    ...
    <body>
        ...
        <form method="post" class="popupwrap"> 
            ...
            <div>
                ...
                <h1 style="font-size:22px;font-family: 微软雅黑">质询和特定问题调查</h1>
...
<!--                    <tr>
                    ...
                    <tr>
                       ...
                       <select style="font-size:16px;font-family: 微软雅黑" name="lwstate">
                        ...
                        <td class="dce" style="font-size:16px;font-family: 微软雅黑">调查类别 <em class="red">*</em></td>           
...
<!--                        <td style="font-size:16px;font-family: 微软雅黑">代表团</td>
                    ...
                    <tr>
                     <td class="dce" style="font-size:16px;font-family: 微软雅黑" >调查时间<em class="red">*</em>
                        </td>
