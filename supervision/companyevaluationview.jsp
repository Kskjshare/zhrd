...
<%
    ...
    RssList evaluationEntity = new RssList(pageContext, "supervision_company_evaluation");
    keywhere = "typeid="+req.get("typeid")  + " and myid=" +  UserList.MyID(request) + " and evaluationId="+ req.get("id") ;  
  ...
  listuser.request();
  listuser.select().where("myid=" +  req.get("companyid") ).get_first_rows( );
  titleStr = listuser.get("company");
