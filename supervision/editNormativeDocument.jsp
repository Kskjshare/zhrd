    ...
    <body>
        ...
        <form method="post" class="popupwrap"> 
            ...
            <div>
                ...
                <h1 style="font-size:22px;font-family: 微软雅黑">规范性文件的备案和审查</h1>
                <table class="wp100 cellbor">
                    ...
                    %>
<!--                    <tr>
                        <td style="font-size:16px;font-family: 微软雅黑" >届次<em class="red">*</em></td>
                    ...
                    <tr>
                        ...
                        <td class="dce" style="font-size:16px;font-family: 微软雅黑">备案审查类别<em class="red">*</em></td>           
...
<!--                        <td style="font-size:16px;font-family: 微软雅黑">代表团</td>
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <div><span id="fjfile1" rid="1" style="color:blue ;font-size:16px;font-family: 微软雅黑;font-weight: bold;">点击选择文件</span><input type="hidden" id="enclosure1" ></div>
                    ...
                    <tr>
                     <td class="dce" style="font-size:16px;font-family: 微软雅黑" >备案审查时间<em class="red">*</em>
                        </td>
                    ...
                    <tr>
                        <td class="dce"><b class="selectuser" style="color:blue;font-size:16px;font-family: 微软雅黑">添加参与人<em class="red">*</em></b></td>
                        <td colspan="5"><ul style="font-size:16px;font-family: 微软雅黑" id="blfyr" class="lianmingren">
                                <li>
                                    <em  style='display: inline;font-size:16px;width: 65.2%;height: 100%;border: 1px #dce6f5 dashed;float: left;border-top: 0px;border-right: 0px;border-left: 0px;font-family: 微软雅黑'>参与人姓名                                    </em>
...
//                                            }
  //                                      }
                    ...
                    <tr class="">
                        <td colspan="6" class="marginauto uetd dce">
...
<!--                    <tr>
                        <td style="font-size:16px">审查分类<em class="red">*</em></td>
                        <td colspan="5" selradio>
