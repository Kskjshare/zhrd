                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String progress =  "<b style='color:DarkOrange;font-size:14px;' >办理中</b>" ;
                           ...
                           if ( list.get("state").equals("1") ) {
                               ...
                               progress =  "<b style='color:DarkOrange;font-size:14px;' >专题询问会中</b>" ;
                               //cmd_str = "提交主任会议审议";
                                isShowcmd = false;
                           }
                            else if ( list.get("state").equals("9") ) {
                               progress =  "<b style='color:DarkOrange;font-size:14px;' >满意度测评中</b>" ;
                               //cmd_str = "提交主任会议审议";
                                isShowcmd = false;
                           }
                           else if ( list.get("state").equals("10") ) {
                               
                                progress = "<b style='color:DarkOrange;font-size:14px;' >常委会审议意见待办理中</b>";   
                                class_str = "assign";
                                cmd_str = "提交办理情况报告";
                                isShowEdit = false ;
                                isShowcmd = true;
