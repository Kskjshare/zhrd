...
<!--                    <tr>
                     ...
                     <tr class="directormeeting">                     
                      ...
                      <td class="dce" style="font-size:15px;font-family: 微软雅黑">专题询问会届次</td>
                      <td colspan="5"><input  style="font-size:15px;font-family: 微软雅黑;width:99%;" type="text" maxlength="100" class="w98" name="inquerymeetingnum" value="<% entity.write("inquerymeetingnum"); %>" /><label class="labtitle"></label></td>
                    </tr>
...
<!--           <tr class="co-committee-member" >
           ...
           <tr class="canyu" >
            ...
            <tr>
                ...
                <td id="selparttimecommitteesend" colspan="5"><em selectparttimecommitteeuser>点击选择其他人员</em>                
                </td>                 
            </tr>    
...
//                                            t.append("<em myid='" + v.myid + "' sellzstate='" + v.sellzstate + "'>" + v.realname + "<i>×</i></em>")
            ...
            if (coo == "22") {
                RssWin.open("/activities/selectuser_2.jsp?mission=<%=cookie.Get("myid")%>", 600, 650);
            } else {
                RssWin.open("/activities/selectuser_2.jsp?mission=<%=user.get("mission")%>", 600, 650);
            }
        });
