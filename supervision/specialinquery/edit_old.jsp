...
<html>
    ...
    <body>
        ...
        <form method="post" class="popupwrap">           
            <div>
                <!--<h1 style="margin-top:3px;margin-bottom:10px;font-size:22px;font-family: 微软雅黑;text-align: center; ">听取和审议专题报告</h1>-->
...
<!--                    <tr>
                    ...
                    <tr>
                        <td class="dce" style="width:140px;font-size:15px;font-family: 微软雅黑">专题询问<em class="red">*</em></td>
                        <td colspan="5">
                            <div>
...
//               
                if ($("[name='directormeetingnum']").val() != undefined && $("[name='directormeetingnum']").val() != "") {
                    var timestamp = new Date($("[name='directormeetingnum']").val());
                    $("[name='directormeetingnum']").val(timestamp / 1000);
                }
                else {
                    alert("请添加主任会议届次");
