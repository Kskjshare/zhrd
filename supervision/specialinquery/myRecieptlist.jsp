                    ...
                    <tbody>
                        <%
                           ...
                           if ( list.get("state").equals("1") ) {
                               ...
                               progress =  "<b style='color:CadetBlue;font-size:14px;' >同意提交主任会议</b>" ;
                               //cmd_str = "提交主任会议审议";
                                isShowcmd = false;
                           }
                           else if ( list.get("state").equals("3") ) {
                               progress =  "<b style='color:CadetBlue;font-size:14px;' >专题询问方案主任会议审议通过</b>" ;
                               //cmd_str = "提交主任会议审议";
                                isShowcmd = false;
                           }
                           else if ( list.get("state").equals("4") ) {
                               progress =  "<b style='color:CadetBlue;font-size:14px;' >专题询问方案主任会议审议不通过</b>" ;
                               //cmd_str = "提交主任会议审议";
                                isShowcmd = false;
                           }
                               ...
                               if ( list.get("needsubmitmeeting").equals("2") ) { //需要审批
                                    progress =  "<b style='color:CadetBlue;font-size:14px;' >不需提交主任会议审议</b>" ;
                                    //cmd_str = "审阅";
                                    //class_str = "preview";
                                    isShowcmd = false;
                               }
                               ...
                               progress =  "<b style='color:CadetBlue;font-size:14px;' >专题询问会中</b>" ;
                               //cmd_str = "提交主任会议审议";
                                isShowcmd = false;
                           }
                               ...
                               //cmd_str = "提交主任会议审议";
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >主任会审议意见待办理中</b>";   
                                class_str = "assign";
                                cmd_str = "提交办理情况报告";
                                isShowEdit = false ;
                                isShowcmd = true;
                                ...
                                progress = "<b style='color:CadetBlue;font-size:14px;' >待办理</b>";                            
                                isShowEdit = false ;
                                isShowcmd = true;
                                class_str = "assign";
                                cmd_str = "提交办理情况报告";
        ...
        <script>
               $(function(){
                ﻿$(".viewDetail").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/specialinquery/detailview.jsp?id=" + id , '查看详情', {width: 830, height: 280});
                })
            });
            $(function(){
            ...
            $(function(){
                ﻿$(".assign").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/specialinquery/assignHandleReport.jsp?id=" + id , '提交办理情况报告', {width: 820, height: 160});
                })
            });
              $(function(){
             ...
             $(function(){
                ﻿$(".preview").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/specialinquery/preview.jsp?id=" + id , '审阅', {width: 830, height: 300});
                })
            });
        </script>
    </body>
