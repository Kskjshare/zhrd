...
<html>
    ...
    <body>
        <form method="post" id="mainwrap">
            ...
            <!--zyx end-->  
                <input type="button" style="margin-left:5%;background-color:#82bee9;color:#ffffff;border: 0px;cursor: pointer" id="committeeMember" value="添加其他人员" >
            </div>
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "parttime_committee_member");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
    ...
    <script type="text/javascript">
        ...
        $("#committeeMember").click(function(){
             RssWin.open("/supervision/addCommitteeMember.jsp", 700, 650);
        })
// zyx                    
            $(".res").click(function () {
                history.go(-1);
