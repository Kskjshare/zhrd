...
<%
    ...
    RssList evaluationEntity = new RssList(pageContext, "supervision_dismissal");
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String class_str = "";
                            String cmd_str = "";
                            RssList list = new RssList(pageContext, "supervision_dismissal");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td><% 
                                ...
                                else if ( list.get("initiator").equals("4") ) {
                                    out.print( "法院");
                                }
                                else if ( list.get("initiator").equals("5") ) {
                                    out.print( "主任会议" );
                                }
                                 else if ( list.get("initiator").equals("6") ) {
                                    out.print( "常委会成员联名" );
                                }
                                %></td>
                            ...
                            <td><% 
                                if ( list.get("state").equals("1") ) {                                  
                                    if (  list.get("initiator").equals("6") ) {
                                 ...
                                 out.print( "<b style='color:DarkOrange;font-size:14px;' >常委会组成人员投票中</b>" );    
...
<!--                            <td>
        ...
        <script>
            $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/disimissalview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 830, height: 240});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
             ...
             popuplayer.display("/supervision/disimissal/delete_1.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/editDismissal.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 1024, height: 620});
                })
            });
            ...
            $(function(){
                ...
                //popuplayer.display("/supervision/topic/inspectReport.jsp?id=" + id + "&TB_iframe=true", '提交主任会议', {width: 830, height: 260});
                 popuplayer.display("/supervision/disimissal/submit.jsp?id=" + id, '主任会议审议', {width: 830, height:320});
                })
            });
            ...
            $(function(){
                ﻿$(".auditpass").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/committeeaudit.jsp?id=" + id , '常委会审议', {width: 830, height: 340});
                })
            });
            ...
            $(function(){
                ﻿$(".inquery").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/submit.jsp?id=" + id , '征求意见', {width: 830, height: 420});
                })
            });
             ...
             $(function(){
                ﻿$(".feedback").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/submit.jsp?id=" + id , '反馈意见', {width: 830, height: 420});
                })
            });
            $(function(){
                ﻿$(".committeeAudit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/submit.jsp?id=" + id , '提交常委会审议', {width: 860, height: 480});
                })
            });
            ...
            $(function(){
                ﻿$(".committeeAuditFinish").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/submit.jsp?id=" + id , '提交常委会审议意见', {width: 860, height: 500});
                })
            });
            $(function(){
                ﻿$(".committefeedback").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/submit.jsp?id=" + id , '征求意见', {width: 880, height: 520});
                })
            });
             $(function(){
                ﻿$(".sendReporttoCommittee").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/disimissal/submit.jsp?id=" + id , '向常委会出报告', {width: 880, height: 640});
                })
            });
             ...
             $(function(){
                ﻿$(".evaluate").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/evaluation.jsp?id=" + id , '满意度测评', {width: 830, height: 280});
                })
            });
