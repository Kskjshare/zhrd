                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String progress =  "<b style='color:DarkOrange;font-size:14px;' >调研中</b>" ;
                            ...
                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and state like '%" + URLDecoder.decode(list.get("state"), "utf-8") + "%'" + " and typeid=9 and myid="+UserList.MyID(request)).get_page_desc("id");
                            ...
                            if ( list.get("state").equals("1") ) {
                               ...
                               progress =  "<b style='color:DarkOrange;font-size:14px;' >调研方案主任会议审议中</b>" ;
                               cmd_str = "审议完成";
                               ...
                               class_str = "solutionsubmit";
                                ...
                                if ( list.get("leaderpreview").equals("1") ) {//需要预审
                                progress = "<b style='color:DarkOrange;font-size:14px;' >审议调研方案中</b>";
//                                cmd_str = "交办";
//                                class_str = "assign";
//                                isShowEdit = false ;
//                                isShowFinishBtn = true ;
                               ...
                               // if ( list.get("leaderpreview").equals("1") ) {//需要预审
                                 ...
                                 progress = "<b style='color:DarkOrange;font-size:14px;' >调研报告和交办意见主任会审议中</b>";
                                 isShowcmd  = true ;                             
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            if ( isShowFinishBtn ){
                            %>      
                            <span class="ys finish"  id="<% out.print(list.get("id")); %>" style="color:blue;font-weight: bold" >调研完成</span>   |       
                            <%
                            }
                            %>   
        ...
        <script>
            ...
            $(function(){
                ﻿$(".assign").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/assignview.jsp?id=" + id , '调研报告和交办意见提交主任会议审议', {width: 830, height: 220});
                })
            });
            ...
            $(function(){
                ﻿$(".auditFinish").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/solutionAuditview.jsp?id=" + id , '调研方案审议完成', {width: 830, height: 260});
                })
            });
            $(function(){
                ﻿$(".auditFinish2").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/solutionAuditview1.jsp?id=" + id , '调研报告和交办意见审议完成', {width: 830, height: 360});
                })
            });
            ...
            $(function(){
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/edit.jsp?id=" + id , '编辑', {width: 830, height: 360});
                })
            });
             $(function(){
                ﻿$(".delete").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/delete_1.jsp?id=" + id , '删除', {width: 330, height: 80});
                })
            });
            ...
            $(function(){
                ﻿$(".finish").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/finishview.jsp?id=" + id , '调研完成', {width: 830, height: 380});
                })
            });
             ...
             $(function(){
                ﻿$(".solutionsubmit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/solutionsubmit.jsp?id=" + id , '调研方案提交主任会议审议', {width: 830, height: 380});
                })
            });
            ...
            $(function(){
                ﻿$(".jiaoban").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/jiaoban.jsp?id=" + id , '交办', {width: 830, height: 140});
                })
            });
              ...
              $(function(){
                ﻿$(".evaluate").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/evaluation.jsp?id=" + id   + "&typeid=9", '满意度测评', {width: 830, height: 260});
                })
            });
             ...
             $(function(){
                ﻿$(".viewEvaluation").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/evaluationview.jsp?id=" + id  + "&typeid=9" , '查看满意度测评', {width: 830, height: 220});
                })
            });
