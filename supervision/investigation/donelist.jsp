                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            String progress =  "<b style='color:CadetBlue;font-size:14px;' >调研已完成</b>" ;
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td>
                            <span class="ys viewEvaluation" id="<% out.print(list.get("id")); %>" style="color:blue;font-weight: bold" >查看满意度测评</span>  
        ...
        <script>
               $(function(){
                ﻿$(".viewDetail").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/supervision/investigation/inspectbutview.jsp?id=" + id + "&TB_iframe=true", '查看详情', {width: 830, height: 480});
                })
            });
               $(function(){
