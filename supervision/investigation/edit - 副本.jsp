...
<!--                        <td class="dce w120" style="font-size:16px;font-family: 微软雅黑">听取审议地点<em class="red">*</em></td>
                ...
                <!--  
                  <tr>
                    ...
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">调研组成员</td></tr>
                    ...
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">参加单位</td></tr>
                       <tr>
                        <td class="dce w100 " style="color:blue;font-size:16px;font-family: 微软雅黑;cursor:pointer;font-weight: bold;" >单位名称<em class="red">*</em></td>
                    ...
                    <tr><td style="font-size:20px;font-family: 微软雅黑" colspan="7" id="tabheader">参加单位</td></tr>
                    <tr class="inspectmember" >
                        <td class="dce" style="width:110px;">单位名称<em class="red">*</em></td>
                        <td id="selcompanysend" colspan="5"><em selectcompany>点击选择单位</em>                
                        </td>                         
                    </tr>
