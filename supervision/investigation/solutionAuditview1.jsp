...
<!--                    <tr>
                    ...
                    <tr>
                        ...
                        out.print( "<b style='color:DarkOrange;font-size:14px;' >调研报告和交办意见审议中</b>" );
                        else
                ...
                <tr>
                    <td class="dce w120" style="font-size:14px;font-family: 微软雅黑">调研方案</td>
            ...
            if (!entity.get("Reportenclosure").isEmpty()) {
             ...
             %>
            <tr>
                <td class="dce w120" style="font-size:14px;font-family: 微软雅黑">调研报告</td>
                 <td colspan="5" style="font-weight:bold;">
                 <%
                     String[] arry1 = {"", "", ""};
                     if (!entity.get("Reportenclosure").isEmpty()) {
