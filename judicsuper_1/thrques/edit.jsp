...
<%
    ...
    RssList entity = new RssList(pageContext, "thques");
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                        <td class="dce w100 ">接收单位：<em class="red">*</em></td>
                        <td><select class="w250 classify" name="recunit" dict-select="recunitclassify" def="<% entity.write("recunit"); %>"></select></td>
                    </tr>
                    <tr>
