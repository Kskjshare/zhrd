...
public class NormalRemindJob implements Job {
	/**
	 * 日志
	 */
	private  final Log logger = LogFactory.getLog(NormalRemindJob.class);
	@Override
	public void execute(JobExecutionContext jobExec) throws JobExecutionException {
		...
		NormalRemindTask normalTask= new NormalRemindTask();
		
		try {
			normalTask.start(entity);
		} catch (Exception e) {
