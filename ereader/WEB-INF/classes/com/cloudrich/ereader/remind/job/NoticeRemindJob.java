...
public class NoticeRemindJob implements Job {
	/**
	 * 日志
	 */
	private  final Log logger = LogFactory.getLog(NoticeRemindJob.class);
	@Override
	public void execute(JobExecutionContext jobExec) throws JobExecutionException {
		...
		NoticeRemindTask noticeTask= new NoticeRemindTask();
		
		try {
			noticeTask.start(entity);
		} catch (Exception e) {
