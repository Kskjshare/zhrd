		...
		window.onload = function() {
			upload1 = new SWFUpload({
				...
				upload_url: "FileUploadServlet?saveDataId=saveDataId1;jsessionId"  + "=" + window["sessionId"],
...
//				button_text_left_padding: 65,
			...
			upload2 = new SWFUpload({
				// Backend Settings
                                //梁小竹修改                                            加入不同源仍然携带sessionid
				upload_url: "FileUploadServlet?saveDataId=saveDataId2;jsessionId"  + "=" + window["sessionId"],
				//post_params: {"PHPSESSID" : "<?php echo session_id(); ?>"},
