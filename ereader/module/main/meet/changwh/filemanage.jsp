...
<body>
 ...
 --> &nbsp;&nbsp;关联状态： <select name="bindtype" id="bindtype"
		...
		<table id="poptable" cellpadding="0" cellspacing="0"
			...
			<tbody>
				<s:iterator value="sortlist" id="rodo" status="L">
                                    <tr id=<s:property value="fileid" />  onclick = "sel(this);" style="border:4px solid red ;">
	...
	<div id="logicWindow1" class="easyui-window" title="添加文件"
		iconCls="icon-save"
		style="width: 632px; height: 450px; padding: 5px;top:100px;"
		closed="true">
		<form id="fff" action="index.htm" method="post"
			...
			<table>
				<tr valign="top">
					<td colspan="3">
						<div style="width: 560px">
							...
							<input type="radio" name="filetypeSel" value="2">延伸阅读</input>
                                                        <input	type="radio" name="filetypeSel" value="3">参阅文件</input> <input
				...
				<tr>
					<td colspan="3">
						<div>
							<div class="fieldset flash" id="fsUploadProgress1" style="width: 560px"></div>
							<input type="hidden" id="saveDataId1" />
							<div style="padding-left: 5px;">
                                                            <span id="spanButtonPlaceholder1"></span>  如文件上传显示异常，请点击获得<a id="clickflash" onclick="clickflash()">Adobe Flash Player</a><input id="btnCancel1"
	...
	window.onload = function() {
		upload1 = new SWFUpload({
			// Backend Settings   上传文件访问的后台地址
                        //梁小竹修改                                            加入不同源仍然携带sessionid
			upload_url : "<%=basePath%>meet_meetingfileadd.action;jsessionid=${pageContext.session.id }",
...
//			flash_url : "<%=basePath%>third/swfupload/swfupload.png",
