$(function () {
   ...
   RssApi.Table.List("ztimges").condition({"collectiontype":2,"type":1}).keyvalue({ "pagesize": 12 }).getJson(function (data) {
    ...
    RssApi.Table.List("ztimges").condition({"collectiontype":2 ,"type":2}).keyvalue({ "pagesize": 12 }).getJson(function (data) {	
    ...
    RssApi.Table.List("ztimges").condition({"collectiontype":2,"type":3}).keyvalue({ "pagesize": 12 }).getJson(function (data) {
     ...
     RssApi.Table.List("ztimges").condition({"collectiontype":2,"type":4}).keyvalue({ "pagesize": 12 }).getJson(function (data) {
