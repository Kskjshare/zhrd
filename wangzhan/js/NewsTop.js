...
$(function () {
    ...
    var rendayaowenDataLength = localStorage.getItem("rendayaowenDataLength");
    console.log(rendayaowenDataLength);
    $("#contentListul").empty();
    
//    var liStr = "";
//    for (var i = 0; i < rendayaowenDataLength; i++) {
//        liStr = liStr + "<li class='rdyw'>";
//        liStr = liStr + "<h4>";
//        liStr = liStr + "<span class='idSpan' style='display:none;'></span>";
//        liStr = liStr + "<a class='rdywTitle'  target='_blank'>汝州市人大常委会第八调研组到市信访局、财政局调研述职述法评议工作</a>";
//        liStr = liStr + "<span  class='time'>2021-07-08</span>";
//        liStr = liStr + "</h4>";
//        liStr = liStr + "</li>";
//    }
//    $("#contentListul").append(liStr);
  
    console.log(" ____________ contype=", contype ) ;
    
    
    
    RssApi.Table.List("releasum").condition( { "classifyid": 1 ,"newsid":1} ).keyvalue({ "pagesize": 1000 }).getJson(function (data) {
