        ...
        <form method="post" id="mainwrap">
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            RssList list = new RssList(pageContext, "ztimges");
                            list.request();
                            int a = 1;
                            list.pagesize = 30;
//                            list.select().where("title like '%" + URLDecoder.decode(list.get("title"), "utf-8") + "%' and classifyid=1").get_page_desc("id");
...
//                                list.keyvalue("userrolecompany", user_delegation.get("company"));
                        ...
                        <tr ondblclick="ck_dbAbTlclick();" idd="<% out.print(list.get("id")); %>" style="cursor:pointer;">
                            ...
                            <td releasumclassify="<% out.print(list.get("ico")); %>"></td>
        ...
        <script>
            $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/wangzhan/add/butview.jsp?id=" + id + "&TB_iframe=true", '查看内容', {width: 830, height: 240});
                })
            });
             $(function(){
            ﻿$(".delete").click(function(){
             ...
             popuplayer.display("/wangzhan/add/delete_1.jsp?id=" + id + "&TB_iframe=true", '删除', {width: 300, height: 80});
             ...
             $(function(){
                ﻿$(".edit").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/wangzhan/add/addjijin.jsp?id=" + id + "&TB_iframe=true", '编辑', {width: 830, height: 380});
                })
            });
