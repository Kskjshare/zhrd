...
<%
    ...
    RssList substation = new RssList(pageContext, "station_sub_id");
    substation.select().where("reserved=1 and myid=" + entity.get("divisionid") ).get_first_rows() ;
//    substation.select().where("reserved=1 and divisionid=" + entity.get("divisionid") ).get_page_desc("id") ;
        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    ...
                    <tr>
                    <td rowspan="4"><img src="/upfile/<% entity.write("avatar"); %>"></td>
                    <!--<td class="w100 dce">编号</td><td><% entity.write("code"); %></td>-->
                    <td class="w100 dce">姓名</td><td><% entity.write("realname"); %></td>
                    <td class="w160 dce">代表团</td><td><% out.print(entity.get("delegationname"));%></td>
                    <td class="w240 dce">联络站</td><td><% out.print(substation.get("name"));%></td>

                    
                    </tr>
                    <tr>
                        <td class="w100 dce">性别</td><td sex="<% entity.write("sex"); %>"></td>
                        <td class="w100 dce">民族</td><td id="nationid"></td>
                        <td class="w100 dce">党派</td>
                        <td clan="<% entity.write("clan"); %>"></td>
                    ...
                    <tr><td class="w100 dce">层次</td><td><%
                        ...
                        //String[] circleslist = {"乡镇人大代表", "汝州市人大代表", "平顶山市人大代表", "河南省人大代表", "全国人大代表"};
                        String[] circleslist = {"全国人大代表", "河南省人大代表", "平顶山市人大代表", "汝州市人大代表", "乡镇人大代表"};
