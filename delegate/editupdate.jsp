...
<!--                    <tr>
                    ...
                    <tr>
                        <td class="tr w100 ">联络站</td>
                        
                        <td><select name="divisionid" class="w260">
                                <%
                                    RssList substation = new RssList(pageContext, "station_sub_id");
                                    substation.select().where("reserved=1 and mission=" + entity2.get("mission") ).get_page_desc("id") ;
                                    while (substation.for_in_rows()) {
                                %>
                                <option selected="select" value="<% substation.write("myid"); %>"><% substation.write("name"); %></option>
                                <%
                                } 
                                %>
                            </select></td>                                       
