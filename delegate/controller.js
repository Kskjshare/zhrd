...
//    }
    popuplayer.display("/delegate/edit.jsp?TB_iframe=true", '新增代表', {width: 830, height: 550});
}
transadapter["edit"] = function (t)
{
    ...
    popuplayer.display("/delegate/editupdate.jsp?relationid=" + transadapter.id + "&TB_iframe=true", '编辑', {width: 830, height: 500});
}
