            ...
            <div>
                <table class="wp100 formor">
                    ...
                    <tr>
                        ...
                        <td><input type="text" maxlength="80" class="w254" name="realname" value="<% entity2.write("realname"); %>" readonly="readonly" /></td>
                    </tr>
                    <tr>
                        ...
                        <td class="tr w100 ">代表团：</td>
                        <td><select name="mission">
                                <option></option>
                                <%
                                    RssListView company = new RssListView(pageContext, "userrole");
                                    company.select().where("state like '%4%' and level in (0,1)").query();
                    ...
                    <tr>
                        ...
                        <td><select class="w260" name="clan" dict-select="clan" def="<% entity2.write("clan"); %>"></select></td>
                        <td class="tr w100 ">层次：</td>
                        <td><div class="checksel" id="circleslist"><p class="w254"></p><ul class="w258"></ul><input type="hidden" class="in" value="1"/></div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tr w100 ">登陆账号：</td>
                        <%--<td><input <% out.print(entity2.get("myid").isEmpty() ? "" : "readonly='readonly'");%> class="w254" type="text" name="account" value="<% out.print(entity2.get("account")); %>" ></td>--%>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" maxlength="80" class="w656" name="homeaddress" value="<% entity2.write("homeaddress"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="tr w100 ">家庭电话：</td>
                        <td><input class="w254" type="text" maxlength="80" class="" name="hometel" value="<% entity2.write("hometel"); %>" /></td>
                        <td class="tr w100 ">家庭邮编：</td>
                        <td><input class="jynum w254" maxlength="80" name="homecode" value="<% entity2.write("homecode"); %>" /></td>
                    </tr>
                    <tr>
                        <td class="tr w100 ">状态：</td>
                        <td><select class="w260" name="enabled" dict-select="enabled" def="<% entity2.write("enabled"); %>"></select></td>
                        <td class="tr w100 ">有效届次：</td>
