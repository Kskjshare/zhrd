...
<!--            <div class="toolbar">
               ...
               <div class="newStylebodywrap">
                    <td class="tr w100 ">姓名</td>
                    <td class="tr w180 "><input type="text" maxlength="80" class="w180" name="realname" value="" /></td>
                    <td class="tr w180 ">aaa</td>
                    <td><input type="text" maxlength="80" class="w180" name="realname" value="" /></td>
<!--                <button type="button" transadapter="quicksearch" select="false" class="quicksearch">快速查询</button>
                <button type="button" transadapter="append" select="false" class="butadd">增加</button>
                <button type="button" transadapter="edit" class="butedit">编辑</button>
                <button type="button" transadapter="delete" class="butdelect">删除</button>
                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("realname like '%" + URLDecoder.decode(list.get("realname"), "utf-8") + "%' and membertype=0").get_page_desc("id");
        ...
        <script>
              ...
              $(function(){
                ﻿$(".view").click(function(){
                    let id = $(this).attr("id");
                popuplayer.display("/partybuilding/partymember/butview.jsp?id=" + id + "&TB_iframe=true", '查看', {width: 830, height: 640});
                })
            });
             $(function(){
