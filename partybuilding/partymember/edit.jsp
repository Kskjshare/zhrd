...
<!--                         <td colspan="3" style="font-size:15px">
                        <input type="text" class="w200 Wdate" name="birthday"  rssdate="<% out.print(entity.get("birthday")); %>,yyyy-MM-dd"   onFocus="WdatePicker({lang: 'zh-cn'})" readonly="readonly">
                        </td>-->
                    ...
                    <tr>
                        ...
                        <td><select class="w260" name="membertype" dict-select="partymember" def="<% entity.write("membertype"); %>"></select></td>
                    </tr>                  
...
<!--                     <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" maxlength="80" class="w254" name="address" value="<% entity.write("address"); %>" /></td>
                    </tr>

                    
                    
                    <tr>
                        <td class="tr w100 ">入党时间<em class="red">*</em></td>
