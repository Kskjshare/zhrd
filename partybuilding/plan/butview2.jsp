        ...
        <form method="post" class="popupwrap">           
            <div>
                <table class="wp100 cellbor">
                    <!--<tr><td colspan="7" id="tabheader">党员信息</td></tr>-->
                    ...
                    <tr><td class="w100 dce">民族</td><td id="nationid"></td ><td colspan="2"  class="w100 dce">政治面貌</td><td clan="<% entity.write("clan"); %>"></td><td class="w100 dce">学历</td><td clan="<% entity.write("eduid"); %>"></td></tr>
                    
                    <tr><td class="w100 dce">电子邮箱</td><td><% entity.write("email"); %></td> <td class="w100 dce">手机</td><td colspan="2" class="liuchengyingxiang"><% entity.write("telphone"); %></td><td class="w100 dce">所属选区</td><td clan="<% entity.write("constituency"); %>"></td></tr>
