            ...
            <div>
                <table class="wp100 cellbor">
                    <tr>
                        ...
                        <td><input type="text" class="w500" name="title" value="<% entity.write("title"); %>" /><input type="hidden" class="type" name="type" value="1"></td>
                    </tr>
                    <tr>
                        <td class="tr w120">类型：</td>
                        <td><select class="goodstype" name="classify" dict-select="coaltype" def="<% entity.write("classify"); %>"></select><input type="hidden" class="goodskey" name="goodskey" value=""></td>
                    </tr>
                    <tr>
                        <td class="tr w120">标题图</td>
                        <td>
                            <div>
                    ...
                    <tr>
                        ...
                        <td><div selectcascade="area" data-val="<% entity.write("shengid"); %>,<% entity.write("shiid"); %>,<% entity.write("xianid"); %>" dict-name="shengid,shiid,xianid"></div></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="price" placeholder="请填写价格" value="<% entity.write("price"); %>"></td>
                    </tr>
                    <tr>
