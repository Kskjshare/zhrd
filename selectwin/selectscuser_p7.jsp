                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            list.request();
                            int a = 1;
                            list.pagesize=30;//选择所有选工委或代表联络科
                            list.select().where("powergroupid=7 and (realname like '%"+list.get("searchkey")+"%' or code like '%"+list.get("searchkey")+"%')").get_page_desc("myid");
