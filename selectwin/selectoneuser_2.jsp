                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="id" value="<% out.print(list.get("myid")); %>" delegationname="<% out.print(list.get("delegationname")); %>" code="<% out.print(list.get("code")); %>" postcode="<% out.print(list.get("postcode")); %>" daibiaoDWaddress="<% out.print(list.get("daibiaoDWaddress")); %>"  mission="<% out.print(list.get("mission")); %>"/></td>
