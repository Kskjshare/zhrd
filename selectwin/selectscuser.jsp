                ...
                <table class="wp100 tc cellbor" id="section">
                    ...
                    <tbody>
                        <%
                            ...
                            list.request();
                            int a = 1;
                            list.pagesize=30;//查看所有代表团
                            list.select().where("state=4 and (linkman like '%"+list.get("searchkey")+"%' or daibiaotuanCode like '%"+list.get("searchkey")+"%')").get_page_desc("myid");
    ...
    <script type="text/javascript">
        $('.footer>button').click(function () {
            ...
            $("input[name='id']:checked").each(function () {
                e.push({"myid": $(this).attr("value"), "linkman": $(this).parents("tr").find("td").eq(3).text()})
            })
            if (e.length == 0) {
                alert("请选择代表团");
                return false;
