...
<%-- 
		       ...
		       $("#apk").click(function() {
					$.messager.alert("扫码二维码下载APK","<img src="+"themes/default/images/ereader.png"+" alt="+"apk二维码下载"+" />");
				});
			});
			function download(){
...
<!-- 				<div><img src="themes/default/images/ereader.png" alt="apk二维码下载" /></div>
 -->				<div class="login_box">
					<div class="input_box">
						<ul>
...
<!--						<a onclick="doForm()">denglu</a>-->
					...
					<div class="apk">
					<a style="font-size:11pt;cursor:pointer;" id="apk">人大阅文APK二维码</a>
