...
//            list.keyvalue("xzscID", UserList.MyID(request));
            ...
            //out.print("<script>alert('111111')</script>");
...
<!--                            zyx修改，解决议案建议审查分类默认为空的bug -->
                    ...
                    <td class="w120 dce">审查意见</td><td colspan="3" class="scyj">
                        <input id="tongyi" name="reviewopinion" checked="checked" type="radio" value="1">同意<em></em>
                        <input name="reviewopinion" type="radio" value="2">不同意</td>
                    </tr>
                        ...
                        <td colspan="3" class="vertop">
                            <table id="smalltab" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>单位类别</td>
                                    --->
                                    <td style="font-weight:bold;">单位名称</td>
                                    <td></td>
                                </tr>
                                        <%
                                ...
                                <tr class="sellist" allname="<% out.print(companylist.get("allname"));%>" realid="<% out.print(companylist.get("companyid"));%>">
                                    ...
                                    <td align="center" companytypeclassify="<% out.print(companylist.get("comtype"));%>"></td>
                                     -->
                                    <td align="center"><% out.print(companylist.get("allname"));%></td>
...
//                             $("#smalltab tbody").append('<tr class="sellist" allname="' + v.realname + '" realid="' + v.myid + '"><td><input type="checkbox" class="checksel"></td><td>' + v.code + '</td><td class="tdleft">' + v.realname + '</td><td class="tdleft">' + v.comtype + '</td><td></td></tr>')
                            $("#smalltab tbody").append('<tr class="sellist" allname="' + v.realname + '" realid="' + v.myid + '"><td><input type="checkbox" class="checksel"></td><td style="text-align:center;" class="tdleft">' + v.realname + '</td><td></td></tr>')
                        }
                    })
                }
