    ...
    <body>
        ...
        <ul id="right">
            <li id="top">
                ...
                <label><input type="radio" name="state" memutype="3">批评统计</label>
                <label><input type="radio" name="state" memutype="4">意见统计</label>
                <label><input type="radio" name="state" memutype="5">质询统计</label>
            </li>
        </ul>
    </body>
</html>
        ...
        new Ajax("lvzhistatistics").keyvalue({"state": memutype}).getJson(function (json) {
            switch (memutype) {
                case "1":
                    ...
                    var table = "<thead><tr><th>代表姓名</th><th >代表团</th><th>领衔提交</th><th >联名提交</th><th >总计</th></tr></thead><tdody>";
                    $.each(json[0], function (k, v) {
                        table += "<tr sid='" + v.myid + "'><td>" + v.realname + "</td>"  + "<td>" + v.delegationname + "</td><td class='lx'>0</td><td class='lm'>0</td><td class='suball'></td>"
                    })
                ...
                case "3":
                    ...
                    var table = "<thead><tr><th>代表姓名</th><th >代表团</th><th>报名次数</th><th >考勤次数</th><th >缺席次数</th></tr></thead><tdody>";
                    $.each(json[0], function (k, v) {
                        table += "<tr sid='" + v.myid + "'><td>" + v.realname + "</td>"  + "<td>" + v.delegationname + "</td><td class='bm'>0</td><td class='kq'>0</td><td class='qx'>0</td>"
                    })
                    table += "</tbody>"
                    $("#tablelist").append(table);
                    $.each(json[1], function (k, v) {
