    ...
    <body>
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    <thead>
                     ...
                     <tbody>
                        <%
                            RssList list = new RssList(pageContext, "mingancitype_classify");
                            HttpRequestHelper req = new HttpRequestHelper(pageContext).request();
                            int a = 1;
                            list.pagesize = 30;
                            list.select().where("name like '%" + URLDecoder.decode(req.get("name"), "utf-8") + "%' and state=0").get_page_desc("id");
                            list.request();
        ...
        <script>
            $("span[tid]").click(function () {
                ...
                popuplayer.display("/setup_1/mingancitype/edit.jsp?relationid=" + tid + "&TB_iframe=true", '编辑', {width: 400, height: 200});
            })
        </script>
    </body>
</html>