    ...
    <body>
            ...
            <div class="bodywrap">
                <table class="wp100 tc cellbor" id="section">
                    <thead>
                     ...
                     <tbody>
                        <%
                            RssList list = new RssList(pageContext, "partytype_classify");
        ...
        <script>
            $("span[tid]").click(function () {
                ...
                popuplayer.display("/setup_1/partytype/edit.jsp?relationid=" + tid + "&TB_iframe=true", '编辑', {width: 400, height: 200});
            })
        </script>
    </body>
</html>